...
// A moving circle! This produces very similar results to early code
// but using custom functions.

float yPos = 0; //position of the circle
float vel = 2;  //the speed of the circle
