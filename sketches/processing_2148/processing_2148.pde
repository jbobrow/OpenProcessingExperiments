...
String input = "circle";  // der eingegebene text
float spacing = 60;
...
if (mousePressed == true)
    ...
    for(int i = 0; i < 20; i++)
      ...
      float xx = map(i, 0,20, x1, x2);
      float yy = map(i, 0,20, y1, y2);
      ellipse( xx, yy, random(5), random(5) );
    }
    }
else
    {    
    ...
    for(int i = 0; i < 20; i++)
      ...
      float xx = map(i, 0,20, x1, x2);
      float yy = map(i, 0,20, y1, y2);
      ellipse( xx, yy, random(10,50), random(10,50) );
