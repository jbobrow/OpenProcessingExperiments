...
String robotUrl = "http://i589.photobucket.com/albums/ss335/rumblefighter87/bd2bf82a-eb1e-45ba-b9ee-e31f25985149.png";
...
void setup() {
  ...
  robotWally = new dodgePlayer(60, 50, 3, loadImage(robotUrl), 0);
...
void resetMatch() {
  ...
  if ( roundOver ) {
    if ( numRound != 0 ) {
      if ( URF ) {
        robotWally = new dodgePlayer(width/2, 50, 0, loadImage(robotUrl), 0);
      }
