...
void newPath() {
  ...
  path.addPoint(470, 145);  //Chaos
  path.addPoint(570, 110);  //Dynamic
  path.addPoint(580, 190);  //Linearität
  path.addPoint(380, 330);  //Schwarmverhalten
  path.addPoint(470, 145);  //Chaos
  path.addPoint(580, 190);  //Linearität
  path.addPoint(780, 60);  //Das individuum
  path.addPoint(800, 320);  //Der Antischwarm
  path.addPoint(380, 330);  //Schwarmverhalten
  path.addPoint(850, 500);  //Schwarmverhalten
  path.addPoint(200, 480);
  path.addPoint(offset, offset);
  path.addPoint(780, 60);  //Das individuum
}
