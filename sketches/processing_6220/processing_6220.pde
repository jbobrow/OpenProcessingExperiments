...
class Robot {
  ...
  void update(float x, float y){
    ...
    drawMotor1(bodyX,bodyY); // ellipse motor1
    drawMotor2(bodyX,bodyY); // ellipse motor2
    drawMotor3(bodyX,bodyY); // ellipse motor2
  ...
  void drawMotor1(float bodyX, float bodyY){ // motor1
    frameRate(40);
  ...
  void drawMotor2(float bodyX, float bodyY){ // motor2
    frameRate(40);
    fill(0);
    strokeWeight(2);
  ...
  void drawMotor3(float bodyX, float bodyY){ // motor3
    frameRate(40);
    ...
    if(vector == true) {
      ...
      image(fireshoot ,bodyX , bodyY, bodyWidth -25, bodyHeight - 98);
      image(lazer ,bodyX -41 , bodyY, bodyWidth -30, bodyHeight - 108);
