...
// All code below is background informtation for the horizontal transparent rectangles.
...
// Code below is for the  smaller squares located within the white squares of the border.
