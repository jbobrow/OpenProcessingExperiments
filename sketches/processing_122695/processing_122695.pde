...
public float v = random(1,120);
public float t = random(1,19);
public float r = random(1,199);
public float c = random(1,199);
public float vcc = random(1,199);
   
  
public float te = random(-12,12);
public float re = random(-12,12);
public float ce = random(-12,12);
public float vcce = random(-12,12);
...
/* -----Controladores con su id----- */
  ...
  controlP5.addSlider("Voltaje",0,120,v,85,110,10,100).setNumberOfTickMarks(121).setId(1);
  controlP5.addKnob("Tiempo",0,19,t,170,5,50).setNumberOfTickMarks(20).setId(2);
  controlP5.addSlider("Recistencia",0,199,r,125,255,100,10).setNumberOfTickMarks(200).setId(3);
  controlP5.addSlider("Capacitancia",0,199,c,290,120,100,10).setNumberOfTickMarks(200).setId(4);
  controlP5.addSlider("Voltaje C",0,199,vcc,290,208,100,10).setNumberOfTickMarks(200).setId(5);
...
//---------------Botones---------------//
  ...
  controlP5.addButton("Siguiente",siguiente,850,10,90,30).setId(17);
...
//-------Intencidad--------//
  ...
  textSize(30);
  text("i",200,180);
  text("Calcula lo siguiente:",440,35);
  textSize(20);
//---------ayuda--------//  
  ...
  if(mouseX>10&mouseX<70&mouseY>560&mouseY<580){
    textSize(15);
   text("°Los valores iniciales son aleatorios para que tu calcules los resultados",100,545);
   text("°Si das clic en los botones, puedes ver cual era el resultado",100,560); 
   text("°Puedes variar los valores del circuito manualmente con los sliders",100,575);
   text("°El segundo slider es el exponencial. Ejemplo: Tiempo=10, TE=-12 --> 10 Pico segundos ",100,590); 
  }
  if(siguiente<3){
  noStroke();
  fill(20,20,20);
   ...
   fill(250,250,250);
   textSize(10);
  // text("Calcula: Voltaje en capacitor si r="+rf,640,50);
  }
