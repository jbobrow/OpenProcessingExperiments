...
//  fill(lerp(255, 0, circleAge), lerp(255, 0, circleAge),lerp(255, 0, circleAge));
fill(lerp(255, 0, circleAge),lerp(0, 250, circleAge),56);
...
void mousePressed() {
  ...
  if (mouseX <(displayWidth/2) && frame_rate_value < 30) {
    frame_rate_value++;
  }
