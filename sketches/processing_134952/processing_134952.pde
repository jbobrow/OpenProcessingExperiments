...
ellipseDia = map(mouseX, 0, 400, 0, 550);
...
//Top Area Dark//
  ...
  if (key==ENTER) { x = random(-100,200);}
  if (key==ENTER) {y = random (-400,100);}
  else if (keyPressed) {
  if (key=="s") { x=0; y=0;}
  }
...
noStroke();
fill(255);
//Extra Ellipse Shapes Top
ellipse(x+20,y+250,8,8);
ellipse(x+60,y+300,10,10);
ellipse(x+120,y+200,15,15);
ellipse(x+160,y+225,5,5);
ellipse(x+190,y+260,12,12);
ellipse(x+230,y+300,20,20);
ellipse(x+280,y+310,4,4);
ellipse(x+300,y+350,10,10);
ellipse(x+310,y+370,3,3);
ellipse(x+340,y+400,14,14);
ellipse(x+200,y+100,15,15);
ellipse(x+130,y+20,6,6);
ellipse(x+260,y+40,10,10);
ellipse(x+300,y+150,12,12);
ellipse(x+350,y+180,5,5);
ellipse(x+250,y+120,9,9);
ellipse(x+200,y+180,3,3);
ellipse(x+10,y+70,7,7);
ellipse(x+80,y+200,10,10);
ellipse(x+380,y+210,17,17);
ellipse(x+50,y+230,8,8);
ellipse(x+40,y+40,10,10);
ellipse(x+300,y+240,5,5);
ellipse(x+270,y+290,9,9);
ellipse(x+290,y+200,4,4);
ellipse(x+320,y+100,10,10);
ellipse(x+380,y+100,8,8);
ellipse(x+50,y+80,3,3);
ellipse(x+70,y+120,10,10);
ellipse(x+130,y+130,15,15);
ellipse(x+240,y+210,10,10);
ellipse(x+390,y+10,5,5);
ellipse(x+360,y+50,10,10);


ellipse(x+105,y+350,6,6);
ellipse(x+200,y+360,10,10);
ellipse(x+270,y+340,16,16);
ellipse(x+350,y+320,10,10);
ellipse(x+370,y+370,15,15);
ellipse(x+290,y+380,5,5);
ellipse(x+150,y+350,12,12);
ellipse(x+390,y+310,4,4);

//Blue Area 2//
ellipse(x+40,y+400,20,20);
ellipse(x+90,y+440,10,10);
ellipse(x+10,y+460,5,5);
ellipse(x+50,y+470,7,7);
ellipse(x+200,y+420,16,16);
ellipse(x+145,y+400,4,4);
ellipse(x+320,y+420,5,5);
ellipse(x+260,y+428,10,10);
ellipse(x+125,y+425,13,13);
ellipse(x+150,y+460,4,4);

//White Area 2//
ellipse(x+90,y+495,17,17);
ellipse(x+150,y+490,10,10);
ellipse(x+210,y+465,10,10);
ellipse(x+250,y+480,8,8);
ellipse(x+275,y+530,4,4);
ellipse(x+320,y+500,12,12);
ellipse(x+390,y+530,9,9);
ellipse(x+380,y+450,15,15);
ellipse(x+360,y+480,5,5);
ellipse(x+300,y+450,12,12);

//Dark Area 3//

ellipse(x+20,y+610,8,8);
ellipse(x+40,y+560,20,20);
ellipse(x+80,y+530,10,10);
ellipse(x+10,y+520,4,4);
ellipse(x+60,y+630,5,5);
ellipse(x+105,y+610,14,14);
ellipse(x+120,y+570,11,11);
ellipse(x+175,y+560,6,6);
ellipse(x+300,y+580,10,10);
ellipse(x+250,y+567,3,3);
ellipse(x+240,y+589,6,6);
ellipse(x+160,y+600,10,10);

//White Area 3//
ellipse(x+370,y+610,15,15);
ellipse(x+390,y+670,5,5);
ellipse(x+310,y+660,10,10);
ellipse(x+290,y+620,12,12);
ellipse(x+210,y+650,9,9);
ellipse(x+110,y+640,10,10);

//Dark Area 4//
ellipse(x+55,y+680,12,12);
ellipse(x+20,y+700,5,5);
ellipse(x+80,y+720,15,15);
ellipse(x+120,y+690,9,9);
ellipse(x+165,y+710,7,7);
ellipse(x+210,y+690,10,10);
ellipse(x+270,y+701,12,12);
ellipse(x+320,y+700,5,5);

//White Area 4//
ellipse(x+370,y+720,10,10);
ellipse(x+390,y+360,5,5);
ellipse(x+280,y+760,10,10);
ellipse(x+220,y+740,12,12);
ellipse(x+170,y+750,8,8);
ellipse(x+340,y+755,10,10);

//Dark Area 5//
ellipse(x+30,y+770,8,8);
ellipse(x+68,y+785,11,11);
ellipse(x+100,y+780,7,7);
ellipse(x+160,y+790,5,5);
ellipse(x+220,y+789,9,9);
}
