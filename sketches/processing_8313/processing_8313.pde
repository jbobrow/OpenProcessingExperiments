...
//startgame 
 if(!gameOver){ 
   ...
   if((squareW<newSquare && squareW > 0) || (squareH <newSquare && squareH>0)){ 
     if(square){ 
      ...
      square=false; 
      squareSpeedT +=0.1; 
      if(newSquare>50)newSquare-=2;
     } 
   } 
   if(move){ 
     if(!rectCircleIntersect(squareX, squareY, squareW, squareH,mouseX, mouseY, -sizeCircle/2)&& rectCircleIntersect(squareXT, squareYT, squareWT, squareHT,mouseX, mouseY, -sizeCircle/2)){ 
         squareW=0; 
         squareH=0; 
         squareTwo=true; 
         move=false; 
  ...
  if((squareWT<newSquare && squareWT>0) || (squareHT <newSquare && squareHT>0 )){ 
       if(squareTwo){ 
     ...
     if(moveT){ 
       if(!rectCircleIntersect(squareXT, squareYT, squareWT, squareHT,mouseX, mouseY, -sizeCircle/2) && rectCircleIntersect(squareX, squareY, squareW, squareH,mouseX, mouseY, -sizeCircle/2)){ 
         squareWT=0; 
         squareHT=0; 
         square=true; 
         move=true; 
   ...
   if(startGame){ 
     ...
     text("STAY INSIDE THE SQUARE.",width/2,40); 
