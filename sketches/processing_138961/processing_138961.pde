...
void setup() {
  try {
    js_mathvision_init_table_5746bec15932fc08bffead52497a2e1f314760e0(FRAMES);
  }
  catch(err) {}
  ...
  if("" != "") {
    // save thumbnail
    try {
      js_mathvision_done_5746bec15932fc08bffead52497a2e1f314760e0("", 48);
    }
    catch(err) {}
  }
}
...
void makeFrames_5746bec15932fc08bffead52497a2e1f314760e0(adder) {
  var tt = t;
  t = 0;
