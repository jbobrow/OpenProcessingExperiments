...
pushMatrix();
//float th = PI*2*hour()/60;
translate(random(h/12),random(h/12));
...
void drawBlackShape(float x, float y){
  //center(140,160);
 noStroke();//black with moon
  fill(0);
  beginShape();
  float cX=x;
  float cY=y;
  vertex(cX+13, cY-30);
  bezierVertex(cX+13, cY-30, cX+10, cY+20, cX+26, cY+29);
  bezierVertex(cX+26, cY+29, cX+16, cY+38, cX-27, cY+15);
  bezierVertex(cX-27, cY+15, cX-14, cY-10, cX+13, cY-30);
  endShape(); 
}
