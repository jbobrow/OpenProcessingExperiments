...
/*@pjs preload = "Fons_rellotge.jpg";*/
/*@pja preload = "Pixitu_rellotge.png";*/
/*@pja preload = "Peixet_rellotge.png";*/
/*@pja preload = "bomb.png";*/
/*@pja preload = "Explosio_rellotge.png";*/
/*@pja preload = "fishbone_rellotge.png";*/
...
void espines () {
  ...
  // ESPINES MARCA HORES
  //rect (width, 300, 0, 500, 0)


  //bombollaY [i] = bombollaY [i] - velocitatb [i];}
  // float pujabombolla = map (second (), 0, 59, height, 0);
