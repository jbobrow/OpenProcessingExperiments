...
void define(){
    xPos=random(-800,2400);
  yPos=random(-400,1200);
  size=3;
  speed=6;
  }
...
//thanks to open resource. In this program I recited the text input code from this website:
...
void draw() {
 ...
 int indent = 25;
  ...
  // Display everything
  text("Directly input the number of citizens you want. Press Enter to finish.\nYou can create or kill them as you want. Shake Kim Jong Un near the crowd to dispel the people.", indent, 40);
  text(typing,indent,110);
  popularity=int(saved);
  kim = new Kim();
