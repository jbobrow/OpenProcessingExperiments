...
void draw() {
   ...
   textFont(myFont);
   String clocktype = hours + ":" + minutes + ":" + seconds + " " +  ampm;;
   ...
   // HOURS
     ...
     int hMarker = ((70 * hours) + hXpos - 70);      //hour marker start point
   ...
   // MINUTES
     ...
     // Minute bars
     fill(off);
     for (float i = mXpos; i <= 870; i += 14.5) {       // 60 * 14.5 = 870
       rect(i, 350, 10, 90);
     }
     ...
     float sMarker = ((14.5 * seconds) + sXpos);      //seconds marker start point
