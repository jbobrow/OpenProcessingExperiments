...
int y=mouseY;
  ...
  strokeWeight(0.5);
  // (1)
  line(x+78, y+145, x+174, y+140);
  line(x+125, y+103, x+117, y+183);
  line(x+101, y+114, x+138, y+170);
  line(x+156, y+106, x+88, y+181);
  //(2)
  ...
  fill(mouseX/2,mouseY/2,mouseX/3,120);
  noStroke();
  beginShape();
  curveVertex(x-59, y-67);
  curveVertex(x-59, y-67);
  curveVertex(x-73, y-64);
  curveVertex(x-83, y-59);
  curveVertex(x-94, y-43);
  curveVertex(x-103, y-45);
  curveVertex(x-111, y-36);
  curveVertex(x-119, y-29);
  curveVertex(x-127, y-22);
  curveVertex(x-137, y-15);
  curveVertex(x-146, y-11);
  curveVertex(x-153, y-8);
  curveVertex(x-156, y-5);
  curveVertex(x-158, y-1);
  curveVertex(x-155, y+5);
  curveVertex(x-147, y+9);
  curveVertex(x-132, y+10);
  curveVertex(x-117, y+14);
  curveVertex(x-107, y+19);
  curveVertex(x-97, y+29);
  curveVertex(x-89, y+28);
  curveVertex(x-78, y+46);
  curveVertex(x-68, y+48);
  curveVertex(x-57, y+50);
  curveVertex(x-42, y+48);
  curveVertex(x-27, y+42);
  curveVertex(x-17, y+36);
  curveVertex(x-7, y+23);
  curveVertex(x-2, y+11);
  curveVertex(x, y);
  curveVertex(x, y-13);
  curveVertex(x-1, y-23);
  curveVertex(x-7, y-37);
  curveVertex(x-14, y-48);
  curveVertex(x-22, y-55);
  curveVertex(x-32, y-61);
  curveVertex(x-43, y-65);
  curveVertex(x-53, y-67);
  curveVertex(x-59, y-67);
  curveVertex(x-59, y-67);
  endShape();
  ...
  noStroke();
  beginShape();
  curveVertex(x-84, y-32);
  curveVertex(x-84, y-32);
  curveVertex(x-87, y-27);
  curveVertex(x-91, y-20);
  curveVertex(x-93, y-12);
  curveVertex(x-94, y);
  curveVertex(x-93, y+0);
  curveVertex(x-88, y+17);
  curveVertex(x-78, y+25);
  curveVertex(x-67, y+29);
  curveVertex(x-52, y+28);
  curveVertex(x-38, y+22);
  curveVertex(x-31, y+16);
  curveVertex(x-25, y+4);
  curveVertex(x-22, y-5);
  curveVertex(x-21, y-15);
  curveVertex(x-21, y-28);
  curveVertex(x-22, y-34);
  curveVertex(x-25, y-38);
  curveVertex(x-31, y-41);
  curveVertex(x-43, y-48);
  curveVertex(x-59, y-47);
  ...
  curveVertex(x-59, y-28);
  curveVertex(x-69, y-25);
  curveVertex(x-77, y-18);
  curveVertex(x-81, y-8);
  curveVertex(x-77, y+2);
  curveVertex(x-72, y+9);
  curveVertex(x-63, y+13);
  curveVertex(x-52, y+12);
  curveVertex(x-46, y+8);
  curveVertex(x-41, y+1);
  curveVertex(x-38, y-6);
  curveVertex(x-39, y-15);
  curveVertex(x-42, y-22);
  curveVertex(x-45, y-25);
  curveVertex(x-51, y-28);
  curveVertex(x-59, y-28);
  curveVertex(x-59, y-28);
  endShape();
