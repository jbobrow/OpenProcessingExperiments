...
fill(color1,color2,color3,opacity4);
ellipse(mouseY,mouseX,size1,size1);

fill(color4,color5,color6,opacity3);
ellipse(mouseY,mouseX,size2,size2);

fill(color7,color8,color9,opacity2);
ellipse(mouseY,mouseX,size3,size3);

fill(color10,color11,color12,opacity1);
ellipse(mouseY,mouseX,size4,size4);

noFill();
stroke(color1,color5,color9,opacity5);
strokeWeight(3);
ellipse(mouseY,mouseX,size1b,size1b);

stroke(color2,color6,color10,opacity6);
strokeWeight(5);
ellipse(mouseY,mouseX,size1c,size1c);


fill(color1,color2,color3,opacity4);
ellipse(map(mouseX,0,600,600,0),map(mouseY,0,600,600,0),size1,size1);


fill(color4,color5,color6,opacity3);
ellipse(map(mouseX,0,600,600,0),map(mouseY,0,600,600,0),size2,size2);

fill(color7,color8,color9,opacity2);
ellipse(map(mouseX,0,600,600,0),map(mouseY,0,600,600,0),size3,size3);

fill(color10,color11,color12,opacity1);
ellipse(map(mouseX,0,600,600,0),map(mouseY,0,600,600,0),size4,size4);

noFill();
stroke(color1,color5,color9,opacity5);
strokeWeight(3);
ellipse(map(mouseX,0,600,600,0),map(mouseY,0,600,600,0),size1b,size1b);

stroke(color2,color6,color10,opacity6);
strokeWeight(5);
ellipse(map(mouseX,0,600,600,0),map(mouseY,0,600,600,0),size1c,size1c);


fill(color1,color2,color3,opacity4);
ellipse(map(mouseY,0,600,600,0),map(mouseX,0,600,600,0),size1,size1);


fill(color4,color5,color6,opacity3);
ellipse(map(mouseY,0,600,600,0),map(mouseX,0,600,600,0),size2,size2);

fill(color7,color8,color9,opacity2);
ellipse(map(mouseY,0,600,600,0),map(mouseX,0,600,600,0),size3,size3);

fill(color10,color11,color12,opacity1);
ellipse(map(mouseY,0,600,600,0),map(mouseX,0,600,600,0),size4,size4);

noFill();
stroke(color1,color5,color9,opacity5);
strokeWeight(3);
ellipse(map(mouseY,0,600,600,0),map(mouseX,0,600,600,0),size1b,size1b);

stroke(color2,color6,color10,opacity6);
strokeWeight(5);
ellipse(map(mouseY,0,600,600,0),map(mouseX,0,600,600,0),size1c,size1c);
