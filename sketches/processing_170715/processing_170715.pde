...
int colorUll = color (160,82,45);
int movimentLlagrima = 328;
int movimentLlagrima2 = 329;
boolean llagrima = false;
...
void draw () {
  ...
  stroke(0);
  fill(255, 255, 255);
  ellipse(182, 309, 80, 36);
  
  stroke(160,82,45 );
  fill(colorUll);
  ellipse(182,309, random(20,25),random(20,25));
  ...
  if(llagrima == true){
  fill(127,255,212);  
  ellipse(173, movimentLlagrima, 30, 30);
  movimentLlagrima = movimentLlagrima +3;
  if(movimentLlagrima == 591){
    movimentLlagrima = 328;
  }
  }
  ...
  stroke(0);
  fill(255, 255, 255);
  ellipse(325, 311, 80, 36);
  
  stroke(160,82,45 );
  fill(colorUll );
  ellipse(325, 311, random(20,25),random(20,25));
  ...
  if (llagrima == true){
  fill(127,255,212);  
  ellipse(328, movimentLlagrima2, 30, 30);
  movimentLlagrima2 = movimentLlagrima2 +3;
  if (movimentLlagrima2 == 591){
      movimentLlagrima2 = 329;
  }
  }
