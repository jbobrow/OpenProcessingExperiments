    ...
    if(mouseX<=50){
      ...
      if(mouseX>50 &&mouseX<=100){
        ...
        option6();}
         ...
         if(mouseX>=301 &&mousePressed==true){
           
       fill(0,128,0,130);
    rectMode(CENTER);
    rect(25,175,30,(abs(175-mouseY)*second()/2));
    rectMode(CORNER);
       pushMatrix();
      fill(159,0,255,150);
      translate(75,175);
...
pushMatrix();
  translate((mouseX+pmouseX)/2-175,pmouseY);
...
popMatrix();
  ...
  void option1(){
   ...
   pushMatrix();
  translate((250-mouseX+pmouseX-pmouseY+pmouseY)/2,pmouseY);
  rotate(radians(millis()/3));
  noStroke();
 fill(0,0,255,mouseX);
 ellipse((mouseY+35)%49,(mouseX+53)%8,15,15);
popMatrix();
   ...
   void option4(){
     if(mouseY<=175){
       fill(255,0,0);
        triangle(150,0,200,0,175,mouseY-20);}
        else{fill(255,0,0);
        triangle(150,350,200,350,175,mouseY+20);}
