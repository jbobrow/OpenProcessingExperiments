...
int page, a, b, c;
String worst = "The piece SUCKS!";
String worst1 = "overflowing Suckishness";
String worst2 = "and profound ignorance.";
String a1 = "Stop doing art.";
String worse = "This fails to express anything other than kindergraten art,";
String worse2 = "it fails to imply the overall";
String worse3 = "sense of art.";
String a2 = "Please get better at art.";
String bad = "My eyes hurt!";
String bad2 = "I guess ive seen worse....";
String good = "Not bad..";
String good1 = "The style is um.. original";
String good2 = "Good job overall.";
String a3 = "Draw better, though.";
String better = "Wow!  You pretty good!";
String better1 = "You have a future as an artist!";
String better2 = "Its pretty Awesome!";
String a4 = "This is good.";
String best = "I bow to your awesomeness";
String best1 = "A mona lisa!";
