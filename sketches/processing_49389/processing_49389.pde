...
kafli = loadStrings("LaurTreblasarar.txt");
...
//int ill12 = Integer.parseInt(gildi12[0]);
 ...
 fill(255);
textFont(font1);
text("Flute", dia, 82, 140);
text("B. Cl.", dia, 265, 140);
text("Bassoon", dia, 458, 140);
...
//vinstri
 ...
 pushMatrix(); 
   translate(0, 4);
   kc1.draw(2, 0, 0, 106, 105, 0, 101, 102, 103, 0, 104, 0, 0, 1010, 1020, gerdur1, notur1, almennur1, langur1);
   translate(kb1.l, 0);
   kc2.draw(180, 0, 0, 106, 105, 0, 101, 102, 103, 0, 104, 0, 0, 1010, 1020, gerdur2,  notur2, almennur2, langur2);
   translate(kb2.l, 0);
   kc3.draw(150, 0, 0, 106, 105, 0, 101, 102, 103, 0, 104, 0, 0, 1010, 1020, gerdur3,  notur3, almennur3, langur3);
   translate(kb3.l, 0);
   kc4.draw(120, 0, 0, 106, 105, 0, 101, 102, 103, 0, 104, 0, 0, 1010, 1020, gerdur4,   notur4, almennur4, langur4);
   translate(kb4.l, 0);
   kc5.draw(90, 0, 0, 106, 105, 0, 101, 102, 103, 0, 104, 0, 0, 1010, 1020, gerdur5, notur5, almennur5, langur5);
   translate(kb5.l, 0);
   kc6.draw(50, 0, 0, 106, 105, 0, 101, 102, 103, 0, 104, 0, 0, 1010, 1020, gerdur6,  notur6, almennur6, langur6);
    translate(kb6.l, 0);
   kc7.draw(50, 0, 0, 106, 105, 0, 101, 102, 103, 0, 104, 0, 0, 1010, 1020, gerdur7,  notur7, almennur7, langur7);
    translate(kb7.l, 0);
   kc8.draw(50, 0, 0, 106, 105, 0, 101, 102, 103, 0, 104, 0, 0, 1010, 1020, gerdur8,  notur8, almennur8, langur8);
   popMatrix();
...
// Bassaklarinett
   ...
   pushMatrix(); 
   translate(0, 188);
   kb1.draw(2, 96, 0, 0, 0, 93, 0, 0, 0, 99, 0, 0, 92, 990, 930, gerdur1, notur1, almennur1, langur1);
   translate(kb1.l, 0);
   kb2.draw(180, 96, 0, 0, 0, 93, 0, 0, 0, 99, 0, 0, 92, 990, 930, gerdur2,  notur2, almennur2, langur2);
   translate(kb2.l, 0);
   kb3.draw(150, 96, 0, 0, 0, 93, 0, 0, 0, 99, 0, 0, 92, 990, 930, gerdur3,   notur3, almennur3, langur3);
   translate(kb3.l, 0);
   kb4.draw(120, 96, 0, 0, 0, 93, 0, 0, 0, 99, 0, 0, 92, 990, 930, gerdur4,   notur4, almennur4, langur4);
   translate(kb4.l, 0);
   kb5.draw(90, 96, 0, 0, 0, 93, 0, 0, 0, 99, 0, 0, 92, 990, 930, gerdur5,   notur5, almennur5, langur5);
   translate(kb5.l, 0);
   kb6.draw(50, 96, 0, 0, 0, 93, 0, 0, 0, 99, 0, 0, 92, 990, 930, gerdur6,   notur6, almennur6, langur6);
   translate(kb6.l, 0);
   kb7.draw(50, 96, 0, 0, 0, 93, 0, 0, 0, 99, 0, 0, 92, 990, 930, gerdur7,  notur7, almennur7, langur7);
    translate(kb7.l, 0);
   kb8.draw(50, 96, 0, 0, 0, 93, 0, 0, 0, 99, 0, 0, 92, 990, 930, gerdur8,  notur8, almennur8, langur8);
   popMatrix();
...
// Fagott
   ...
   pushMatrix(); 
   translate(0, 264);
   kd1.draw(2, 87, 86, 0, 0, 0, 91, 0, 0, 0, 0, 90, 0, 900, 0, gerdur1, notur1, almennur1, langur1);
   translate(kd1.l, 0);
   kd2.draw(180, 87, 86, 0, 0, 0, 91, 0, 0, 0, 0, 90, 0, 900, 0, gerdur2,  notur2, almennur2, langur2);
   translate(kd2.l, 0);
   kd3.draw(150, 87, 86, 0, 0, 0, 91, 0, 0, 0, 0, 90, 0, 900, 0, gerdur3,  notur3, almennur3, langur3);
   translate(kd3.l, 0);
   kd4.draw(120, 87, 86, 0, 0, 0, 91, 0, 0, 0, 0, 90, 0, 900, 0, gerdur4,  notur4, almennur4, langur4);
   translate(kd4.l, 0);
   kd5.draw(90, 87, 86, 0, 0, 0, 91, 0, 0, 0, 0, 90, 0, 900, 0, gerdur5,  notur5, almennur5, langur5);
   translate(kd5.l, 0);
   kd6.draw(50, 87, 86, 0, 0, 0, 91, 0, 0, 0, 0, 90, 0, 900, 0, gerdur6,  notur6, almennur6, langur6);
   translate(kd6.l, 0);
   kd7.draw(50, 87, 86, 0, 0, 0, 91, 0, 0, 0, 0, 90, 0, 900, 0, gerdur7,  notur7, almennur7, langur7);
   translate(kd7.l, 0);
   kd8.draw(50, 87, 86, 0, 0, 0, 91, 0, 0, 0, 0, 90, 0, 900, 0, gerdur8,  notur8, almennur8, langur8);
   popMatrix(); 
