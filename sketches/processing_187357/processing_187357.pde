 ...
 /* @pjs
    ...
    */   
    ...
    StringBuffer = mainText; mStringHandler=new StringHandler("S-T-A-L-K-E-R...");//.setDest(/*w/2,-100*/mAnimation.x,mAnimation.y).randomize(02);//create the StringHandler, animate and randomize letter positions
    ...
    Animation pickAnimation() {//textFont(mStringHandler.mFont);
      ...
      case 1:    mStringHandler=new StringHandler("✈__✈ █ █ ▄...\n");  return new ShiftJumpIntroAnimation();
      case 2: mStringHandler=new StringHandler("i can't sing d(^o^)b¸¸♬·¯·♩¸¸♪·¯·♫¸¸ Anyways...\n")/*.randomize(50)*/;     return new HorizontalAnimation();
      case 3:   mStringHandler=new StringHandler("... ¸¸♬·¯·♩¸¸♪·¯·♫¸¸Happy Birthday To You¸¸♬·¯·♩¸¸♪·¯·♫¸¸ ...\n")/*.randomize(50)*/; return new LaOlaAnimation();
      ...
      case 8:   mStringHandler=new StringHandler("HAPPY BIRTHDAY TO YOUR GRANDMA AS WELL :) ...\n"); return new LaOlaJumpAnimation();
      case 9:    mStringHandler=new StringHandler("T(づ ￣ ³￣)づ...\n");   return new FlyByAnimation();
    ...
    String messages_text="LIVE LONG AND PROSPER " +
            "!!!!!\n \n\,,/.<(*_*)>  \nHAVE FUN!.\n \n♪┏(°.°)┛┗(°.°)┓┗(°.°)┛┏(°.°)┓ ♪ " +
            "♪ヽ( ⌒o⌒)人(⌒-⌒ )v ♪\n";
...
//   boolean isJava=true;
    ...
    float letterSize=28;// yes the letterÃ�Â´s size
