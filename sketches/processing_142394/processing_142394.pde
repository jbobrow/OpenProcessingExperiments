...
Stars planets = new Stars();
Space espilon = new Space();
Hubbel telescpoe = new Hubbel();
PImage[] universes = new PImage[5];
PImage nebula;
PImage one = loadImage("carina2Nebula.jpg"); 
PImage two = loadImage("carinaNebula.jpg"); 
PImage three = loadImage("foxFurNebula.jpg");
PImage four = loadImage("rosetteNebula.jpg"); 
PImage five = loadImage("horseshoeNebula.jpg"); 
PFont f;
...
class Hubbel {
  ...
  void vid() {
    Movie orion; 
    orion = new Movie(this, "orion1.mov");
    orion.loop();
    orion.play();
  }
...
class Stars { //creates distant background planets
  Stars() {
  } //constructor
