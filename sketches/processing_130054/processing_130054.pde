...
void setup() {
  ...
  bg=loadImage("bidschrim.png");
  spriteSheet = loadImage("Menschen_fk.png");
...
void newPath() {
  ...
  path = new Path();
  float offset = 30;
   path.addPoint(500, 119);   //Utopie Komune
  path.addPoint(835, 412);   //Utopie Komune2
  path.addPoint(1173, 165);  //Ich frage mich also
  path.addPoint(1672, 327);  //Resüme
  path.addPoint(1670, 55);   //Charles
  path.addPoint(2010, 155);  //Unterbewusstsein
  path.addPoint(1672, 327);  //Resüme
  path.addPoint(1675, 558);  //Winy  
  path.addPoint(672, 843);   //Schwarm
  path.addPoint(1174, 775);  //Projekt 1
  path.addPoint(1500, 825);  //Kybernetik
  path.addPoint(1340, 1038); //Raster
  path.addPoint(340, 960);   //Schwarmintelligenz
  path.addPoint(175, 735);   //Chaos Vs. Ordnung
   path.addPoint(500, 119);   //Utopie Komune  
/* 
  path.addPoint(500, 119);   //Utopie Komune
  path.addPoint(672, 55);    //Utopie, die  
  path.addPoint(835, 412);   //Utopie Komune2
  path.addPoint(1173, 165);  //Ich frage mich also
  path.addPoint(1675, 558);  //Winy
  path.addPoint(1672, 327);  //Resüme
  path.addPoint(1840, 65);   //Zu räumen steht
  path.addPoint(1672, 327);  //Resüme
  path.addPoint(1500, 110);  //Constant
  path.addPoint(672, 843);   //Schwarm
  path.addPoint(1500, 825);  //Kybernetik
  path.addPoint(1340, 1038); //Raster
  path.addPoint(670, 1130);  //Processing
  path.addPoint(170, 1010);  //Prozesse sind
  path.addPoint(672, 843);   //Schwarm
  path.addPoint(670, 1130);  //Processing
  path.addPoint(1174, 775);  //Projekt 1
  path.addPoint(1340, 1038); //Raster
  ...
  path.addPoint(672, 843);   //Schwarm
  path.addPoint(1675, 558);  //Winy  
  path.addPoint(839, 55);    //Kommune, die
  path.addPoint(1500, 480);  //Magarete
  path.addPoint(1170, 1175); //Linearität
  path.addPoint(1500, 280);  //Mark
  path.addPoint(1339, 482);  //Shoshana
*/
}
...
class Vehicle {
  ...
  PVector follow(Path p) {
    ...
    if (debug) {
      ...
      ellipse(predictLoc.x, predictLoc.y, 8, 8);

      // Draw normal location
      stroke(0);
      noFill();
      ellipse(normal.x, normal.y, 1, 1);
  ...
  void render() {
    ...
    //ellipse(0, 0, r, r);
    rotate(atan2(velocity.y, velocity.x) - HALF_PI);
