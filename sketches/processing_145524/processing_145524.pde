...
color [] shapeColors = new color[shapeQty];
...
void setup() {
  ...
  //colors
  colors[0] = color(240, 240, 240, 255); //white
  colors[1] = color(240, 10, 10, 255); //red
  colors[2] = color(10, 240, 10, 255); //green
  colors[3] = color(10, 10, 240, 255); //blue
  ...
  for (int i=0; i < shapeQty; i++) {
     ...
     */
     shapeColors[i] = colors[(int)random(0, 3)];
