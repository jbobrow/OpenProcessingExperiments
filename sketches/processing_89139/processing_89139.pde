...
void draw() { //run draw
  ...
  //cloud 1
  fill(nightCloud);
  ellipse(mouseX, cloudY, 150, 50);
  ellipse(mouseX+50, cloud1Y, 150, 50);
  ...
  /*FUTURE CHANGE, have the background fade to deep purple,
   the sun strink, then have the moon "grow" in it's place (greyish),
   have the clouds keep scrolling across and maybe add rain when mousePressed
   */
   
   //When I added Calli's star code, the flashing lights on the Antenna stopped flashing
}
