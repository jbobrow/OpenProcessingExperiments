...
// Miro in Processing II
// try if mousepressed moon move else sun move and circule change color and move
// lin wenyu  N76014118
...
void draw() {
  ...
  if (mousePressed) {
    ...
    strokeWeight(0);
    line(x, y, x+105, y+132);//star
    line(x-18, y+60, x+96, y+52);
    line(x-18, y+114, x+92, y+10);
    line(x+45, y+7, x+49, y+119);
    angle = angle + speed;
  }
