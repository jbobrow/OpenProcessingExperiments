...
//Every time you click, you can feel it.
...
text ("Click left mouse button to start; Press 'Delete' to clear canvas, 's' or 'S' to save a screenshot.",10,20);
//noLoop();
}
