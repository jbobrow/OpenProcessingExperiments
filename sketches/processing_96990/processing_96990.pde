...
//Queue + pointe de queue interactive
//pushMatrix au popMatrix c'est la queue la pointe et rotation de la queue
...
translate( width*0.330, height*0.690);
rotate(rectRadians);
translate( -120, -210.5 );
