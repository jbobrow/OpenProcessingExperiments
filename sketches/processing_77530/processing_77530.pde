...
int myColorBackground = color(100, 100, 100);
...
void setup() {
  ...
  controlP5.addMatrix("someMatrix", 10, 10, 700, 50, 400, 200);
  ...
  beep0 = minim.loadSample("beep.wav", 2048);
  beep1 = minim.loadSample("beep1.mp3", 2048);
  beep2 = minim.loadSample("beep2.mp3", 2048);
  beep3 = minim.loadSample("beep3.mp3", 2048);
  beep4 = minim.loadSample("beep4.mp3", 2048);
}
...
public void controlEvent(ControlEvent theEvent) {
  ...
  println("## controlEvent / id:"+theEvent.controller().id()+"\n"+
    ...
    if(Matrix.getY(theEvent.controller().value()) <= 4)
      {
         beep3.trigger();
       }
       if(Matrix.getY(theEvent.controller().value()) <= 7 && Matrix.getY(theEvent.controller().value()) > 4)
         {
          beep0.trigger();
       }
       if(Matrix.getY(theEvent.controller().value()) <= 13 && Matrix.getY(theEvent.controller().value()) > 7)
         {
         beep2.trigger();
       }
       if(Matrix.getY(theEvent.controller().value()) <= 20 && Matrix.getY(theEvent.controller().value()) > 13)
         {
         beep1.trigger();
       }
}
