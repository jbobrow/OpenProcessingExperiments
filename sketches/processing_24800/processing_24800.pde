...
fill(186,79,245,80);
 ...
 fill(46,64,242,80);
  ...
  strokeWeight(3);
  ellipse(side1,side2,10*a,10*b);
  ellipse(side1,side2,9*a,9*b);
  strokeWeight(2);
  ellipse(side1,side2,8*a,8*b);
  ellipse(side1,side2,7*a,7*b);
 ...
 fill(65,237,71,80);
  ...
  strokeWeight(2);
  ellipse(side1,0,8*a,8*b);
  ellipse(side1,0,7*a,7*b);
  ellipse(side1,0,6*a,6*b);
  ellipse(side1,0,5*a,5*b);
  strokeWeight(1);
  ...
  strokeWeight(2);
  ellipse(0,side2,8*a,8*b);
  ellipse(0,side2,7*a,7*b);
  ellipse(0,side2,6*a,6*b);
  ellipse(0,side2,5*a,5*b);
  strokeWeight(1);
