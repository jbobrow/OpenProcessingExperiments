...
void setup()
{
  ...
  urlFlickr = "http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=378d5a1775fa8761d4711276b1e1d5c1&tags=rio+de+janeiro%2C+city&tag_mode=all&format=rest";
