...
if (currenttime > leadin){
 ...
 smooth();
   ...
   pushMatrix();
   translate(0, -05);
   k1.draw(2, 36,37,38,39,40,41,42,43, gerdur1, notur1, almennur1, langur1);
   translate(k1.l, 0);
   k2.draw(180, 36,37,38,39,40,41,42,43, gerdur2,  notur2, almennur2, langur2);
   translate(k2.l, 0);
   k3.draw(150, 36,37,38,39,40,41,42,43, gerdur3,  notur3, almennur3, langur3);
   translate(k3.l, 0);
   k4.draw(120, 36,37,38,39,40,41,42,43, gerdur4,  notur4, almennur4, langur4);
   translate(k4.l, 0);
   k5.draw(90, 36,37,38,39,40,41,42,43, gerdur5,  notur5, almennur5, langur5);
   translate(k5.l, 0);
   k6.draw(50, 36,37,38,39,40,41,42,43, gerdur6,  notur6, almennur6, langur6);
   popMatrix();
   ...
   pushMatrix(); 
   translate(0, 427);
   kb1.draw(2, 96,97,98,99,100,101,102,103, gerdur1, notur1, almennur1, langur1);
   translate(kb1.l, 0);
   kb2.draw(180, 96,97,98,99,100,101,102,103, gerdur2,  notur2, almennur2, langur2);
   translate(kb2.l, 0);
   kb3.draw(150, 96,97,98,99,100,101,102,103, gerdur3,   notur3, almennur3, langur3);
   translate(kb3.l, 0);
   kb4.draw(120, 96,97,98,99,100,101,102,103, gerdur4,   notur4, almennur4, langur4);
   translate(kb4.l, 0);
   kb5.draw(90, 96,97,98,99,100,101,102,103, gerdur5,   notur5, almennur5, langur5);
   translate(kb5.l, 0);
   kb6.draw(50, 96,97,98,99,100,101,102,103, gerdur6,   notur6, almennur6, langur6);
   popMatrix();
...
if(key == '4'){
kafli = loadStrings("dartibetur-pt1.txt");
index=0;
}

if(key == '5'){
kafli = loadStrings("dartibetur-pt2.txt");
index=0;
}

if(key == '6'){
kafli = loadStrings("dartibetur-pt3.txt");
index=0;
}

 if(key == '7'){
kafli = loadStrings("kvartett9-pt1.txt");
index=0;

}
if(key == '8'){
kafli = loadStrings("kvartett9-pt2.txt");
index=0;

}
if(key == '9'){
kafli = loadStrings("kvartett9-pt3.txt");
index=0;
}
