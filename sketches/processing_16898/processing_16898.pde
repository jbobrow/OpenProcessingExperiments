...
void setup()
{
  ...
  // Load the table 
  String lines[]=loadStrings("https://spreadsheets.google.com/pub?key=0AovDPxTmQGH7dDFoNG00RkJfVWx6MkVwQ1V3X21oVEE&hl=en&output=txt");
...
void image_display(){
  ...
  String url = "https://dl.dropbox.com/u/2614917/CCA14/CCA_"+ scene_no_str +".jpg";
