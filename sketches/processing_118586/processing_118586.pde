...
background(#9FEFA7);
  ...
  //mosca roja
  fill(#948181);
 ellipse(mouseX,mouseY,25,8); 
   fill(#FE2020);
ellipse(mouseX,mouseY,12,12); 
noStroke();
//textomosca
fill(0);
text("TTTZZZZ", mouseX,mouseY);
  ...
  //izq
   ...
   ellipse (220,200,30,30);
                       ...
                       fill (0);
                         ...
                         //ojo izq
                      float ojolX = map(mouseX, 0, width, 156, 175);
                      //mov arriba izq
                float ojolY = map(mouseY, 0, height, 194, 210);
                //ojo der
                float ojolA = map(mouseX, 0, width,210, 230);
                //cambio de color
                if(mousePressed)                
                fill(#FE2020);
            
              //punto izq
            ellipse(ojolX,ojolY,10,10);
            //punto der
              ellipse(ojolA,ojolY,10,10);
           ...
           //laser ojos   
              if(mousePressed)                
               ...
               triangle(ojolA,ojolY,mouseX,mouseY,mouseX,mouseY);  
               triangle(ojolX,ojolY,mouseX,mouseY,mouseX,mouseY);  
            cursor(HAND);
          } else {
            noCursor();
          }
