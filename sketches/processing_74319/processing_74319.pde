...
Bird_bug[] the_bird_bug = new Bird_bug[2];
...
void setup() {
  ...
  {
    the_bird_bug[i] = new Bird_bug(50,50); // Can have a default value or something significant
  }
}
...
class Bird_bug {
  ...
  void tail() {
    ...
    xpos[xpos.length-1] = birdx; // Update the last spot in the array with the mouse location.
