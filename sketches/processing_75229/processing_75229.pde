...
//    if(x<=0 || x>=gameFrameWidth-width-10){
//     
//      x = constrain(x, 0, gameFrameWidth-width-10);
//    }
//    if(y<=0 || y>=gameFrameHeight-height-10){
//      velY = -velY;
//      y = constrain(y, 0, gameFrameHeight-height-10);
//    }
