...
// }
 ...
 for(int i= 0; i<participants.length; i++) {
  participants[i] = new Participant(random(((width/4)-yesRadius), ((width/4)+yesRadius)), random(((height/2)-yesRadius), ((height/2)+yesRadius)), ages[i], categories[i], genders[i], answers[i]);
 ...
 for(int i= 0; i<participants2.length; i++) {
  participants2[i] = new Participant(random(((width-width/4)-yesRadius), ((width-width/4)+yesRadius)), random(((height/2)-yesRadius), ((height/2)+yesRadius)), ages2[i], categories2[i], genders2[i], answers2[i]);
