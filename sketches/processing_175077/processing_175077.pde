...
/* @pjs font="ArcherPro-Medium_0.otf"; font="ITC_Avant_Garde_Gothic_LT_Condensed-Bold.ttf" ; preload="teeth.png" ;
 brushTimeTitle.png ; clock.png ; info.png ; win.png ; restart.png ;  arrow.png ; plaque.png ; brush.png ; homescreen.png ; start.png ; instructions.png ;
 */
