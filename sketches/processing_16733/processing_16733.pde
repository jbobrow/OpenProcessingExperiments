...
int landarea = 768228/scale; //  - 1
int primaryarea = 5039/scale;    // - 2
int deforestarea = 4895/scale;  //3
int otherfrstarea = 135367/scale; //4
...
int gridsize = 195;//4* int(sqrt(landarea));
...
if (growforest == true){
  ...
  if (savepdf) beginRecord(PDF,millis()+ "australia.pdf" );
