...
//  Title: Moire Pattern - Simple II
//  Description: Two symettric shapes rotating in same direction at different speeds to create moire-like interference patterns.
...
void setup()
{
  ...
  size(400,400);
  //load the images
  img=loadImage("simple1.png");
  img2=loadImage("simple1.png");
