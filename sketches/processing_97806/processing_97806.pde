...
PImage img;//Picture image is given name 'img'
void setup()

{
  ...
  img = loadImage ("balloonImage.jpg");//image added to sketch "data" folder 
}
...
void draw()
{
  ...
  image(img,130,130,180,140);// 
     
  noFill();// no fill colour so that the border of innet tv screen can show
