...
//xmas card with snowy point and line
//by chen-hsin chang
...
void draw() {
  ...
  if (mousePressed) {
    ...
    textSize(32);
    fill(255, 0, 0, 150);
    text("m e r r y  x m a s", 240, height/2); 
    
  }
  else {
    textSize(32);
    fill(255, 0, 0, 150);
    text("m", mouseY/2+random(300), height/2); 
    text("e", mouseY/2+random(300), height/2);
    text("r", mouseY/2+random(300), height/2);
    text("r", mouseY/2+random(300), height/2);
    text("y", mouseY/2+random(300), height/2);
    text("x", mouseY/2+random(300), height/2);
    text("m", mouseY/2+random(300), height/2);
    text("a", mouseY/2+random(300), height/2);
    text("s", mouseY/2+random(300), height/2);
  }
}
...
class Branch {
  ...
  //change the line composition to make differnt graphic
  void drawMe() {
    ...
    for (int i=0; i<outerPoints.length; i++) {
      ...
      fill(200);
      ellipse(outerPoints[i].x, outerPoints[i].y, 2, 2);
    }
