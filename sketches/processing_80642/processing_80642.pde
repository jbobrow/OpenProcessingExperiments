...
{    
  ...
  particles = new ParticleSystem(0,new PVector(650,400,0),img);
  particles2 = new ParticleSystem(0,new PVector(300,250,0),img);
   particles3 = new ParticleSystem(0,new PVector(540,300,0),img);
