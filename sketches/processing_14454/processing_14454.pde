...
kafli = loadStrings("glettingur.txt");
...
int ill6 = Integer.parseInt(gildi6[0]);
 ...
 fill(255);
textFont(font1);
text("Alto Flute", 50, 70, 140);
text("Bass Clarinet", 50, 213, 140);
text("Harp", 50, 356, 140);
text("Piano", 50, 501, 140);
text("Percussion", 50, 645, 140);
...
// println(gerdur1);
 ...
 smooth();
   ...
   pushMatrix();
   translate(0, -05);
   k1.draw(2, 48, 49, 50, 51, 52, 53, 54, 55, gerdur1, notur1, almennur1, langur1);
   translate(k1.l, 0);
   k2.draw(180, 48, 49, 50, 51, 52, 53, 54, 55, gerdur2,  notur2, almennur2, langur2);
   translate(k2.l, 0);
   k3.draw(150, 48, 49, 50, 51, 52, 53, 54, 55, gerdur3,  notur3, almennur3, langur3);
   translate(k3.l, 0);
   k4.draw(120, 48, 49, 50, 51, 52, 53, 54, 55, gerdur4,  notur4, almennur4, langur4);
   translate(k4.l, 0);
   k5.draw(90, 48, 49, 50, 51, 52, 53, 54, 55, gerdur5,  notur5, almennur5, langur5);
   translate(k5.l, 0);
   k6.draw(50, 48, 49, 50, 51, 52, 53, 54, 55, gerdur6,  notur6, almennur6, langur6);
   popMatrix();
  
   pushMatrix(); 
   translate(0, 139);
   ka1.draw(2, 24, 25, 26, 27, 28, 29, 30, 31, gerdur1, notur1, almennur1, langur1);
   translate(ka1.l, 0);
   ka2.draw(180, 24, 25, 26, 27, 28, 29, 30, 31, gerdur2,  notur2, almennur2, langur2);
   translate(ka2.l, 0);
   ka3.draw(150, 24, 25, 26, 27, 28, 29, 30, 31, gerdur3,  notur3, almennur3, langur3);
   translate(ka3.l, 0);
   ka4.draw(120, 24, 25, 26, 27, 28, 29, 30, 31, gerdur4,  notur4, almennur4, langur4);
   translate(ka4.l, 0);
   ka5.draw(90, 24, 25, 26, 27, 28, 29, 30, 31, gerdur5,  notur5, almennur5, langur5);
   translate(ka5.l, 0);
   ka6.draw(50, 24, 25, 26, 27, 28, 29, 30, 31, gerdur6,  notur6, almennur6, langur6);
   popMatrix();
 
   pushMatrix(); 
   translate(0, 283);
   kb1.draw(2, 60, 61, 62, 63, 64, 65, 67, 68, gerdur1, notur1, almennur1, langur1);
   translate(kb1.l, 0);
   kb2.draw(180, 60, 61, 62, 63, 64, 65, 67, 68, gerdur2,  notur2, almennur2, langur2);
   translate(kb2.l, 0);
   kb3.draw(150, 60, 61, 62, 63, 64, 65, 67, 68, gerdur3,   notur3, almennur3, langur3);
   translate(kb3.l, 0);
   kb4.draw(120, 60, 61, 62, 63, 64, 65, 67, 68, gerdur4,   notur4, almennur4, langur4);
   translate(kb4.l, 0);
   kb5.draw(90, 60, 61, 62, 63, 64, 65, 67, 68, gerdur5,   notur5, almennur5, langur5);
   translate(kb5.l, 0);
   kb6.draw(50, 60, 61, 62, 63, 64, 65, 67, 68, gerdur6,   notur6, almennur6, langur6);
   popMatrix();
   ...
   pushMatrix(); 
   translate(0, 571);
   kd1.draw(2, 36, 37, 38, 39, 40, 41, 42, 43, gerdur1, notur1, almennur1, langur1);
   translate(kb1.l, 0);
   kd2.draw(180, 36, 37, 38, 39, 40, 41, 42, 43, gerdur2,  notur2, almennur2, langur2);
   translate(kb2.l, 0);
   kd3.draw(150, 36, 37, 38, 39, 40, 41, 42, 43, gerdur3,  notur3, almennur3, langur3);
   translate(kb3.l, 0);
   kd4.draw(120, 36, 37, 38, 39, 40, 41, 42, 43, gerdur4,  notur4, almennur4, langur4);
   translate(kb4.l, 0);
   kd5.draw(90, 36, 37, 38, 39, 40, 41, 42, 43, gerdur5,  notur5, almennur5, langur5);
   translate(kb5.l, 0);
   kd6.draw(50, 36, 37, 38, 39, 40, 41, 42, 43, gerdur6,  notur6, almennur6, langur6);
   popMatrix();
...
if(key == '2'){
kafli = loadStrings("rammislagur.txt");
index=0;
}
if(key == '3'){
kafli = loadStrings("mjalli.txt");
index=0;
}
if(key == '4'){
kafli = loadStrings("draumbot1.txt");
index=0;
}
if(key == '5'){
kafli = loadStrings("lunra.txt");
index=0;
}
if(key == '6'){
kafli = loadStrings("maurull.txt");
index=0;
}
if(key == '7'){
kafli = loadStrings("draumbot2.txt");
index=0;
}
