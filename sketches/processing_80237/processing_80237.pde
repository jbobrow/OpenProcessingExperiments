...
//http://www.openprocessing.org/sketch/60992
...
PFont font;
String letters = "RUN!! RUNNNN!runNNNNNN!!!RUUUNNNNNN!!";
int fontSizeMin = 3;
...
void setup() {
  ...
  y = mouseY;
   ...
   textFont(createFont("MinionPro-Bold",32));

  font = createFont("MinionPro-Bold.otf",10);
...
void draw() {
  ...
  fill(random(50),random(15),random(110),190);
