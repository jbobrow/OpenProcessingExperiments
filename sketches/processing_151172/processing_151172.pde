 ...
 */
void mouseMoved (){
  frame_rate_value = (int) map((float)mouseX, 0.0, (float) width, 2.0, 120.0);
  num = (int) map((float)mouseY, 0.0, (float) height, 10.0, 30.0);

// print the current value on the screen
  println("Current frame Rate is: " + frame_rate_value + " num is : " + num);
//void mousePressed (){


//void mousePressed (){  
  //simple mose click increase and decrease depending which half of the screen the mouse is in
