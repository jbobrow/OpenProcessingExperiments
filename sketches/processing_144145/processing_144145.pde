...
void draw(){
  ...
  stroke(2);
  fill(0,0,255);
//  ellipse(width/2,650,1900,400);
//  noStroke();
  fill(50,50,250,255);
  ellipse(width/2,800,800,600);
  triangle(width,height,width,height-50,width-100,height);
  fill(0,255);
  ellipse(260,570,20,20);
  ellipse(width/2,height*6/7+3,20,5);

  if(k<num){
    fountain[k] = new Ball(width/2,height*6/7,10+random(10),random(3)-1.5,-random(7)-2,random(10)/100+.03,color(0,0,random(200)+55),random(150)+95);
    k++;
  }
  else{  //inf fountain
    k=0;
