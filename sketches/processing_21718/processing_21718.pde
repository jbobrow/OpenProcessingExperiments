 ...
 *  
 * 
 * Move mouse around and left click to choose the area you want to multiply.
 *
 * 
 * 
 * Press keys
 * 1-5                 to change the area size,
 *  "R" to randomize the multiples,
 * & "S" to capture and                save png
 */
...
//changed the tiles to various sizes and added some more options.
