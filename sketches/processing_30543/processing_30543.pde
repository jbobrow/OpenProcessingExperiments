...
//int ill12 = Integer.parseInt(gildi12[0]);
 ...
 fill(255);
textFont(font1);
text("Flauta 1", dia, 82, 140);
text("Flauta 2", dia, 225, 140);
text("Alt 1", dia, 378, 140);
...
//vinstri
 ...
 pushMatrix(); 
   translate(0, 4);
   kc1.draw(2, 78, 3, 79, 3, 3, 82, 3, 83, 3, 81, 780, gerdur1, notur1, almennur1, langur1);
   translate(kb1.l, 0);
   kc2.draw(180, 78, 3, 79, 3, 3, 82, 3, 83, 3, 81, 780, gerdur2,  notur2, almennur2, langur2);
   translate(kb2.l, 0);
   kc3.draw(150, 78, 3, 79, 3, 3, 82, 3, 83, 3, 81, 780, gerdur3,  notur3, almennur3, langur3);
   translate(kb3.l, 0);
   kc4.draw(120, 78, 3, 79, 3, 3, 82, 3, 83, 3, 81, 780, gerdur4,   notur4, almennur4, langur4);
   translate(kb4.l, 0);
   kc5.draw(90, 78, 3, 79, 3, 3, 82, 3, 83, 3, 81, 780, gerdur5, notur5, almennur5, langur5);
   translate(kb5.l, 0);
   kc6.draw(50,78, 3, 79, 3, 3, 82, 3, 83, 3, 81, 780, gerdur6,  notur6, almennur6, langur6);
    translate(kb6.l, 0);
   kc7.draw(50, 78, 3, 79, 3, 3, 82, 3, 83, 3, 81, 780, gerdur7,  notur7, almennur7, langur7);
    translate(kb7.l, 0);
   kc8.draw(50, 78, 3, 79, 3, 3, 82, 3, 83, 3, 81, 780, gerdur8,  notur8, almennur8, langur8);
   popMatrix();
...
// Flauta 2
   ...
   pushMatrix(); 
   translate(0, 148);
   kb1.draw(2, 72, 3, 3, 75, 3, 76, 77, 3, 3, 3, 720, gerdur1, notur1, almennur1, langur1);
   translate(kb1.l, 0);
   kb2.draw(180, 72, 3, 3, 75, 3, 76, 77, 3, 3, 3, 720, gerdur2,  notur2, almennur2, langur2);
   translate(kb2.l, 0);
   kb3.draw(150, 72, 3, 3, 75, 3, 76, 77, 3, 3, 3, 720, gerdur3,   notur3, almennur3, langur3);
   translate(kb3.l, 0);
   kb4.draw(120, 72, 3, 3, 75, 3, 76, 77, 3, 3, 3, 720, gerdur4,   notur4, almennur4, langur4);
   translate(kb4.l, 0);
   kb5.draw(90, 72, 3, 3, 75, 3, 76, 77, 3, 3, 3, 720, gerdur5,   notur5, almennur5, langur5);
   translate(kb5.l, 0);
   kb6.draw(50, 72, 3, 3, 75, 3, 76, 77, 3, 3, 3, 720, gerdur6,   notur6, almennur6, langur6);
   translate(kb6.l, 0);
   kb7.draw(50, 72, 3, 3, 75, 3, 76, 77, 3, 3, 3, 720, gerdur7,  notur7, almennur7, langur7);
    translate(kb7.l, 0);
   kb8.draw(50, 72, 3, 3, 75, 3, 76, 77, 3, 3, 3, 720, gerdur8,  notur8, almennur8, langur8);
   popMatrix();
...
// Altflauta 1
   ...
   pushMatrix(); 
   translate(0, 300);
   kd1.draw(2, 55, 3, 54, 3, 3, 3, 59, 3, 3, 3, 540, gerdur1, notur1, almennur1, langur1);
   translate(kd1.l, 0);
   kd2.draw(180, 55, 3, 54, 3, 3, 3, 59, 3, 3, 3, 540, gerdur2,  notur2, almennur2, langur2);
   translate(kd2.l, 0);
   kd3.draw(150, 55, 3, 54, 3, 3, 3, 59, 3, 3, 3, 540, gerdur3,  notur3, almennur3, langur3);
   translate(kd3.l, 0);
   kd4.draw(120, 55, 3, 54, 3, 3, 3, 59, 3, 3, 3, 540, gerdur4,  notur4, almennur4, langur4);
   translate(kd4.l, 0);
   kd5.draw(90, 55, 3, 54, 3, 3, 3, 59, 3, 3, 3, 540, gerdur5,  notur5, almennur5, langur5);
   translate(kd5.l, 0);
   kd6.draw(50, 55, 3, 54, 3, 3, 3, 59, 3, 3, 3, 540, gerdur6,  notur6, almennur6, langur6);
   translate(kd6.l, 0);
   kd7.draw(50, 55, 3, 54, 3, 3, 3, 59, 3, 3, 3, 540, gerdur7,  notur7, almennur7, langur7);
   translate(kd7.l, 0);
   kd8.draw(50, 55, 3, 54, 3, 3, 3, 59, 3, 3, 3, 540, gerdur8,  notur8, almennur8, langur8);
   popMatrix(); 
