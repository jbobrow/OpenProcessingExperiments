...
// 定数
static final int FLD_WIDTH = 16;   // フィールド縦サイズ8 16
static final int FLD_HEIGHT = 16;  // フィールド横サイズ8 16
static final int STONE_SIZE = 15; // 石サイズ30 15
static final int BLANK = 0;       // 空き0
static final int BLACK = 1;       // 黒石1
static final int WHITE = 2;       // 白石2
static final int AvailableB = 3; // 黒石の置ける場所3
static final int AvailableW = 4; // 黒石の置ける場所4
static final int Player1 = 0;     // Player1 (プレイヤー)0
static final int Player2 = 1;     // Player2 (CPU)1
static final int GAME_INIT = 0;   // ゲーム初期化0
static final int GAME_PLAY = 1;   // ゲームPlaying1
static final int GAME_PL1PASS = 2;// Player1パス2
static final int GAME_PL2PASS = 3;// Player2パス3
static final int GAME_WIN = 4;    // Player勝利4
static final int GAME_LOSE = 5;   // CPU勝利5
static final int GAME_DRAW = 6;   // 引き分け6
static final int GAME_MISS = 7;   // クリックミス7
...
void reset()
{
   ...
   // 初期状態の石を配置
   field[7][7] = BLACK; //33 77
   field[8][8] = BLACK; //44 88
   field[7][8] = WHITE; //34 78
   field[8][7] = WHITE; //43 87
