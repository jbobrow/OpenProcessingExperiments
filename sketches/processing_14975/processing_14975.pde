...
float complexity = 1000; // wind complexity
float maxMass = .8; // max pollen mass
float timeSpeed = .02; // wind variation speed
float phase = TWO_PI; // separate u-noise from v-noise
 
float windSpeed = 61000; // wind vector magnitude for debug
int step = 5; // spatial sampling rate for debug
