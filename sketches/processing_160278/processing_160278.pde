...
class Mover
{
  ...
  boolean doDie = true; // soll Ã�ï¿½Ã�Â¼berprÃ�ï¿½Ã�Â¼ft werden, ob der punkt sich auÃ�ï¿½Ã¯Â¿Â½erhalb der zeichenflÃ�ï¿½Ã�Â¤che befindet
  boolean isDead = false; // ist der punkt auÃ�ï¿½Ã¯Â¿Â½erhalb der zeichenflÃ�ï¿½Ã�Â¤che
  ...
  void update ()
  {
    addNoise (); // richtungsÃ�ï¿½Ã�Â¤nderung des punktes basierend auf einen (zufÃ�ï¿½Ã�Â¤lligen) noise feldes
    move();      // bewegung
    checkEdgesAndDie ();     // kantenÃ�ï¿½Ã�Â¼berÃ�ï¿½Ã�Â¼berprÃ�ï¿½Ã�Â¼fung
    display();        // zeichnen
  }
