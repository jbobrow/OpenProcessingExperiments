...
endShape(CLOSE);
avgX = totalX/x.length;
avgY = totalY/y.length;
line(avgX-10, avgY, avgX+10, avgY);
line(avgX, avgY-10, avgX, avgY+10);

//Kitten traced from http://2.bp.blogspot.com/_i2c_9pu-z7U/TRuZmhddnCI/AAAAAAAAAbU/l_PJB04fLU8/s1600/Sidebox-Kitten-Thinks-R.jpg
