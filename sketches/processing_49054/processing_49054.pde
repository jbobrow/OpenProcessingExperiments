...
int size = 15; // Balldurchmesser
 float xpos, ypos; // Position des Balles 
float xspeed = random(5,6); // Geschwindigkeit des Balls in x-Richtung
 float yspeed = random(0,4); // Geschwindigkeit des Balls in y-Richtung
 int fehler1=0;
 int fehler2=0;
 int playerpos1;
 int playerpos2;
...
// Zurückprallen des Balles (oben, unten)
