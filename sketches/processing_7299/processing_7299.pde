...
if (litur == 1){
  ...
  if((att == uppi) || (att == uppuri) || (att == uppari)) {
   //  line(x, 1.5 * dia, x + l, kassiHeight - (1.5 * dia));
     ...
     xxu = -10;
       g = 150;
  }else if((att == nidri) || (att == niduri) || (att == nidrari)){
 //    line(x, kassiHeight - 1.5 * dia, x + l, (1.5 * dia));
  ...
  translate(0, xxu);
   ...
   curveVertex(x+l*2.5, xxo/2);
   curveVertex(x+l*2.5+dia, xxo/2);
   endShape(); 
