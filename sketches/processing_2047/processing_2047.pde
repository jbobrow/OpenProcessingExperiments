...
String input = "move mouseX";  // der eingegebene text
float spacing = 60;
...
{
 int vers = round(random(mouseX/50));
 strokeWeight (vers/10);
 line (x1+vers,y1,x2+vers,y2);
 line (x1,y1+vers,x2,y2+vers);
 line (x1+vers,y1+vers,x2,y2);
 line (x1,y1,x2+vers,y2+vers);
