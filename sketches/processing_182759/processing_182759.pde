...
fill(0,0, 0, 50);
  ...
  //middle left craters//
  fill(#ac6111);
  ellipse(142, 470, 87, 90); 
  ellipse(25, 520, 117, 120);

  fill(#cb7110);
  ellipse(142, 472, 85, 85); 
  ellipse(25, 521, 115, 115);
  ...
  fill(#ac6111);
  ellipse(495, 468, 77, 77);
  ellipse(600, 520, 118, 118);

  fill(#cb7110);
  ellipse(495, 472, 76, 76);
  ellipse(600, 523, 115, 115);
