...
class Creature {
  ...
  //constructore gets called once in the beginning when a new creature is made
  Creature () {
  }
  ...
  void setEyePosition () {
   leftEyeX =  int(map(mouseX,0,300, x-65,x-20));
  }
...
/*
A function always looks like this
 response
 void functionName () {
