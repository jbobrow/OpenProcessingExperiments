...
//As a look into the group dynamic within the advertising industry, this is a map of the number of times each person spoke in an advertising brainstorming meeting, and for how long. 
//Each time someone spoke, a hexagon is placed in his or her seat. The larger the hexagon, the more seconds they spoke that specific time. 
//Mouse over each person's "seat" to see his or her title. Did the directors run the show? Did interns speak at all?
