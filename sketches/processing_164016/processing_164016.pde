...
// NO ES DE MI AUTORIA, SE MODIFICA CON FINES EDUCATIVOS PARA LA MAESTRÃ�A EN EDUCACIÃ�N
/* Tomado de: OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/99816*@* */
/* !do not delete the line above, required for linking your tweak if you upload again */

Node a1, a2, a3, a4, a5, a6, a7, a8;
...
void setup() {
  ...
  e12=new Edge(a2, a8, 4);
  e13=new Edge(a7, a8, 4);
  nodes.add(a1);
  nodes.add(a2);
  nodes.add(a3);
  nodes.add(a4);
