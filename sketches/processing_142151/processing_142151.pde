...
int xPos = (int)random(300-100)+100; // Person starting x pos.
...
class TV {
  Channel[] listOfChannels = new Channel[8];
  ...
  void createChannels() {
    ...
    for (int i = 1; i < listOfChannels.length-1; i++) {
    ...
    //Channel test = new Channel(255, 255, 255, 6);
    //listOfChannels[6] = test;
  }
