...
/*
 * Lorenz Attractor
 * Modified by Peter Scheyer, 15 Sep 2012 1957L, decreased sphere to .1 from 2 and changed 4th variable in pushmatrix fill to 800 to make output hang around longer.
