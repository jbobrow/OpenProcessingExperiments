...
void setup() {
  ...
  object13 = new Object(color(255,165,193),160,0,12);
  object14 = new Object(color(165,220,255),320,60,11);
  object15 = new Object(color(255,255,255),480,120,10);
  object16 = new Object(color(196,255,165),640,180,9);
  object17 = new Object(color(240,97,135),800,240,8);
  object18 = new Object(color(255,70,252),160,300,7);
  object19 = new Object(color(69,204,199),0,360,6); 
  object20 = new Object(color(69,201,160),160,420,5);
  object21 = new Object(color(68,180,126),320,480,4);
  object22 = new Object(color(174,131,232),480,540,3);
  object23 = new Object(color(245,239,173),640,600,2);
  object24 = new Object(color(255,205,255),800,660,1);
}
