...
class Emo {
  ...
  void twit() {
    ...
    text(label, 175, 20); // /8 replaces 75
    ...
    stroke(clr[i]);
      ...
      // textFont(font, 26);
      fill(58,217,222);
      //text(LABEL[i], 15,15); //  .13 replaces 78
      //textFont(font2, 22);
      String display =   y[i] + " tweets";
      text(display, 50, 20);  //.076 replaces 46
      fill(58,222,172);
      //textFont(font2, 20);
      text(gt[i] + 
        "               FROM: " + gf[i], 175, 30, width*.215, height*.5); //width*.14 use to be 150, .83 replaces 500, .215 replaces 280, .5 replaces 300  
      ...
      image(profile, 15, 30); //.094 replaces 100, .467 replaces 280
    }
