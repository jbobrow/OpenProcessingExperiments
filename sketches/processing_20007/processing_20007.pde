...
//Path Controls
float PRand = 10;      //changes the degree of randomness within the path
...
//scribble controls
float Xrand = 3;    //the level of randomness within the scribble (x)
float Yrand = 3;    //the level of randomness within the scriblle (y)
...
void draw () {
    ...
    /*Cyan Scribble*/
    fill (0 + SS*12, 170, 204, 50); //scribble size affects red hue
    scribble (CxPath += random (-PRand, PRand), CyPath += random (-PRand, PRand), SS, SS);
 
    /*Magenta Scribble*/
    fill (255, 0, 153 + SS*6, 50); //scribble size affects blue hue
    scribble (MxPath += random (-PRand, PRand), MyPath += random (-PRand, PRand), SS, SS);
 
 
    /*Yellow Scribble*/
    fill (255, 204, 0 + SS*6, 50); //scribble size affects blue hue
    ...
    scribble (KxPath += random (-PRand, PRand), KyPath += random (-PRand, PRand), SS, SS);
