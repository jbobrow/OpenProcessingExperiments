...
String inputText = "Processing is fun! Though slightly time consuming (who knew!)";
float fontSizeMax = mouseX;
float fontSizeMin = mouseY;
...
void keyReleased() {
  ...
  void mousePressed (){
    image(img,0,0);
fontSizeMax = mouseX/10;
fontSizeMin = mouseY/10;
  }
