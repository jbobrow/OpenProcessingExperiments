...
PFont font;
int range = 10;//amount of Lines
Line[] lines= new Line[range];
boolean[][] supervisor;
int count=2; //array index of the line

//the supervisor is a helping tool to find unsed x and y positions
int supercounter=0;
...
//DISPLAY LINE //////////////////////////////////////////////////
  void display() {
    //enable bounding rect?
    //rectangle();
    
    //which color? gradient or red?
    //c=color(255, 100);
    c=color(x1*255/width, y1*255/height, 0, 100);
    stroke(c);
    strokeWeight(5);
    
    //enable text with number of line?
    fill(255, 0, 0, 70);
...
//LINE IS CREATED in between 2 previous lines////////////////////
...
//LINE IS CREATED near one previos line/////////////////////////////
...
//LINE IS CREATED at random position///////////////////////////////////
...
//LINE IS CREATED by going down the width of the screen///////////////
