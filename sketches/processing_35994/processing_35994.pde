...
void draw() {
    ...
    for (int i = 0; i < no_particles; i++) {
     ...
     R = abs(sqrt(pow(particles[i].posX - mouseX, 2) + pow(particles[i].posY - mouseY, 2)));
     G = 255 - R;
...
void MouseGravity(Particle particle) {
