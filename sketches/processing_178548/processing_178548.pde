...
void setup()
{
 ...
 frameRate(60); 
   ...
   song = minim.loadFile("downroad.mp3", samples); 
       song.play(); 
...
count+=0.01;
monster(500+150*(noise(count)-0.5),875,-1250+150*(noise(0,count)-0.5));
