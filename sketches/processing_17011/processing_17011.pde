...
void draw() {
  ...
  if (card == 0) {
    ...
    background(250,244,227);
    text("keep going->",360, 231);
    text("filling up->",370, 280);
    fill(255, 0, 0);
    ellipse(x, y, 40, 40);
    fill(0, 255, 0);
    ellipse(x, 275, 40, 40);
    ...
    fill(0);
    text("Hmm......But..it has its own life. Bye~.", textX, textY);
  } 
  else if (card == 7) {  
    background(250,244,227);
    ...
    strokeWeight(5);
    line(190,370,190,420);
    line(190,370,300,370);

    fill(0);
    text("Oh...Low battery...", textX, textY);
    text("Fuel...Umm... Let's keep going!", textX, textZ);
  }
  else if (card == 8) {  
    background(250,244,227);
    fill(0);
...
void mousePressed() {  
  ...
  if (card == 0) {  
    ...
    if((mouseX > x-20) && (mouseX < 570) && (mouseY > y-20) && (mouseY < 240)) {
      card = 2;
    }
    if((mouseX > x-20) && (mouseX < 570) && (mouseY > 255) && (mouseY < y+295)) {
      card = 6;
    }
  }
  else if (card == 2) {
