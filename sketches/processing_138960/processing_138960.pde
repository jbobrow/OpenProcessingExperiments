...
void setup() {
  try {
    js_mathvision_init_table_5ed55069c175f45c6e750742ced553415a9f77a6(FRAMES);
  }
  catch(err) {}
  ...
  if("" != "") {
    // save thumbnail
    try {
      js_mathvision_done_5ed55069c175f45c6e750742ced553415a9f77a6("", 48);
    }
    catch(err) {}
  }
}
...
void makeFrames_5ed55069c175f45c6e750742ced553415a9f77a6(adder) {
  var tt = t;
  t = 0;
