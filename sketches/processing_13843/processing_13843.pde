...
void setup(){
  ...
  Door door3 = new Door(20, 40);
  Window window3 = new Window(100, 50, false, Window.DOUBLE);
  Roof roof3 = new Roof(Roof.CATHEDRAL);
  House house3 = new House(150, 70, door3, window3, roof3, House.MIDDLE_DOOR);
  house3.drawHouse(house2.x + house2.w, height-groundHeight-house3.h, true);

  Door door4 = new Door(60, 60);
  Window window4 = new Window(50, 62, false, Window.SINGLE);
  Roof roof4 = new Roof(Roof.GAMBREL);
  House house4 = new House(120, 100, door4, window4, roof4, House.RIGHT_DOOR);
  house4.drawHouse(house3.x + house3.w, height-groundHeight-house4.h, true);  
}
