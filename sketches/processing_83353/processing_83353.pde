...
int w_gB=1300/2;//GLOBAL WIDTH OF THE BAR
int h_gB=520/2;//GLOBAL HEIGHT OF THE BAR
int step_gB=260/2;//STEP BETWEEN ONE BUTTON AND THE NEXT
int w_Butt=250/2;//WIDTH OF SINGLE BUTTON
int h_Butt=250/2;//HEIGHT OF SINGLE BUTTON
