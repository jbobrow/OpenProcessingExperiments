...
//top of hair
fill(57, 39, 18);
arc(x, y+ht*-.15, x+wd*-.05, y+ht*-.25, PI, TWO_PI);
//hair sides
arc(x+wd*.4, y+ht*-.065, x+wd*-.825, y+ht*-.6, PI, TWO_PI);
arc(x+wd*-.4, y+ht*-.065, x+wd*-.825, y+ht*-.6, PI, TWO_PI);

//nude ellipses for curls //left to right
fill(245, 221, 190);
arc(x+wd*-.075, y+ht*-.1, x+wd*-.6, y+ht*-.75, PI, TWO_PI);
arc(x+wd*.1, y+ht*-.1, x+wd*-.75, y+ht*-.725, PI, TWO_PI);
arc(x+wd*.375, y+ht*-.05, x+wd*-.8, y+ht*-.7, PI, TWO_PI);
arc(x+wd*-.375, y+ht*-.065,x+wd*-.80, y+ht*-.75, PI, TWO_PI);
