...
dashboard
my portfoliolog out
browse classrooms collectionsbooksgo plus+jobs    PoerschDisk Point Picking  Recursive Tree  Digital Signature  Mapping Sin And Cos
fullscreen
sketch90192.pde
...
Download
Embed
Since everybody got one: Here is my version of a recursive Tree. The text you see at the bottom of the sketch is the seed value for the random generator. Change the seed and see what happens.

Controls:
- TYPE SOMETHING = create seed
- MOUSECLICK = create random seed and generate tree
- BACKSPACE/DEL = delete last letter
- RETURN/ENTER/CTRL = confirm your seed and generate tree
- ALT = save image

 Adam Lastowka  
9 May 2013 Probably the best tree sketch I've seen yet :D
 Xavier BERTHET
20 May 2013 Outstanding! thank you for sharing this extraordinary simulation !
 Poersch    
5 Jun 2013 :D
 Ekidna 
9 Jun 2013 Nice !
