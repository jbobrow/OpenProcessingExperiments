...
void setup(){
  ...
  cup = loadImage("small_gabany_m94.png");
...
void draw(){
  ...
  fill(255);
  text("Create Your Own Spiral Galaxy: drag is black hole, space is stars!", 20, 20);
  text("fps: " + int(frameRate), 20, H*D-20); 
}

void drawParticles(){
  stroke(random(219),random(180),random(73));
  ...
  for(int i=0; i<N; i++){
    ...
    noStroke();
    fill(random(242),random(209),random(142),30);
