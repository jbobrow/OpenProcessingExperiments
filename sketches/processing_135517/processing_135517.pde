...
/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/135510*@* */
...
void draw(){
  background (randomHue,seedSat-17,seedBright+6);
...
//low opacity background rectangles appear in between the lines

if (mouseX>0 && mouseX<45 && mouseY>0 && mouseY<=height){
  firstRect=true;
  fill(268,9,99,60);
  rectMode(CORNER);
  rect(0,0,45,800);
...
if (mouseX>45 && mouseX<90 && mouseY>0 && mouseY<=height){
  firstRect=true;
  fill(268,9,99,60);
  rectMode(CORNER);
  rect(45,0,45,800);
...
if (mouseX>90 && mouseX<125 && mouseY>0 && mouseY<=height){
  firstRect=true;
  fill(268,9,99,60);
  rectMode(CORNER);
  rect(90,0,45,800);
...
if (mouseX>135 && mouseX<180 && mouseY>0 && mouseY<=height){
  firstRect=true;
  fill(268,9,99,60);
  rectMode(CORNER);
  rect(135,0,45,800);
...
if (mouseX>180 && mouseX<225 && mouseY>0 && mouseY<=height){
  firstRect=true;
 fill(268,9,99,60);
  rectMode(CORNER);
  rect(180,0,45,800);
...
if (mouseX>225 && mouseX<270 && mouseY>0 && mouseY<=height){
  firstRect=true;
  fill(268,9,99,60);;
  rectMode(CORNER);
  rect(225,0,45,800);
...
if (mouseX>270 && mouseX<315 && mouseY>0 && mouseY<=height){
  firstRect=true;
  fill(268,9,99,60);
  rectMode(CORNER);
  rect(270,0,45,800);
...
if (mouseX>315 && mouseX<360 && mouseY>0 && mouseY<=height){
  firstRect=true;
  fill(268,9,99,60);
  rectMode(CORNER);
  rect(315,0,45,800);
...
if (mouseX>360 && mouseX<405 && mouseY>0 && mouseY<=height){
  firstRect=true;
  fill(268,9,99,60);
  rectMode(CORNER);
  rect(360,0,45,800);
...
if (mouseX>405 && mouseX<450 && mouseY>0 && mouseY<=height){
  firstRect=true;
  fill(268,9,99,60);
  rectMode(CORNER);
  rect(405,0,45,800);
...
if (mouseX>450 && mouseX<495 && mouseY>0 && mouseY<=height){
  firstRect=true;
  fill(268,9,99,60);
  rectMode(CORNER);
  rect(450,0,45,800);
...
if (mouseX>495 && mouseX<540 && mouseY>0 && mouseY<=height){
  firstRect=true;
  fill(268,9,99,60);
  rectMode(CORNER);
  rect(495,0,45,800);
...
fill (randomHue,seedSat,seedBright);//Purple
triangle(405, 300, 428, 282, 412, 310);//F4
...
fill (randomHue+1,seedSat-1,seedBright+13);//Lavender
triangle(380, 394, 400, 350, 410, 380);//N10
...
//make saturation of color increase as mouseY increases
seedSat=map(mouseY, 0, height, 45, 26);
