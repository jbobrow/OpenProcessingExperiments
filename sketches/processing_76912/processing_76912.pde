...
void setup (){
size (1200,600,P3D);//size of window//3D
background(0);//background colour
b=loadImage("Logo.jpg");//load logo
c=loadImage("instructions.jpg");//load instructions
}
void draw (){
imageMode (CORNER);//logo in corner
image(b,5,5,150,100);//position of logo
imageMode (CORNER);//instruction in corner
image(c,5,100,150,450); //position of instructions
