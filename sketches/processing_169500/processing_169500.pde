...
//
// Based on:
// http://thedotisblack.tumblr.com/image/101074867530
// http://thedotisblack.tumblr.com/image/96350538650
//
// Controls:
...
void draw() {  
  ...
  drawRectWheel(350, width * 1.5, 2, 350, 35, 0);
  popMatrix();
...
void paper(int in_val) {
  ...
  for (int i = 0; i<width-1; i+=2) {
    for (int j = 0; j<height-1; j+=2) {
      fill(random(85-25, 85+25), in_val);
      rect(i, j, 2, 2);
    }
  }
  for (int i = 0; i<20; i++) {
