...
/*Nicole Strang
  ...
  This script uses a new class called Odeer to create an Odeer clone.
  
  For now, the focus is on organization of the script. Odeer has an extra function which
  allows him to dance when the left mouse button is pressed.
  */
...
void draw(){
  background(255,255,204);
  clone1.displayStill(xpos, ypos, gr1, gr2, color1, color2);
  if(mousePressed==true && mouseButton==LEFT){
   clone1.dance(xpos, ypos, gr1, gr2, color1, color2); 
  }
}
