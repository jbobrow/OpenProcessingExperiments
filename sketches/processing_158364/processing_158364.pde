...
void setup(){
  ...
  test[2] = new Question(3, "Do you usually do \"To Do Lists\"?", "Doing lists will help you to set free working memory which could be used for problem solving rather that remembering a list. This is important because our warking memory is really small and we need to take leverage of it in the best possible way");  
  ...
  test[5] = new Question(6, "Do you usually take more handwritten notes than virtual notes?", "The experts demonstrate that if we take handwritten notes the will have a bigger impact on our memory than if we do it virtually.");
  ...
  test[7] = new Question(8, "Do you usually like to listen other people's ideas?", "Not all the ideas could pop of the top of our head, that's why we should share and hear ideas, in that way you can mantain you brain learning all the time. Remember, your brain is a muscle that needs training as all the others muscles on your body do.");
