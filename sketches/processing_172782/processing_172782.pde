...
void setup() {
  ...
  // Logs!
  Logs[0]=new Log(480, 80 );
  Logs[1]=new Log(750, 80);
  Logs[2]=new Log(960, 80);
  Logs[3]=new Log(760, 120);
  Logs[4]=new Log(830, 120);
  Logs[5]=new Log(1000, 120);
  Logs[6]=new Log(1300, 160);
  Logs[7]=new Log(1450, 160);
  Logs[8]=new Log(2400, 160);
  Logs[9]=new Log(3300, 200);
  Logs[10]=new Log(3400, 200);
  Logs[11]=new Log(1100, 240);
