...
int formPoints = 24; //generates points for the shape
int pointVariation = 2; //generates the distance and variation between points
float shapeSize = 200; //initial shape size
