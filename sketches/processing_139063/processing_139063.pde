...
//////////////////////////////////////////////////////////////////// DRAW
void draw() {
  // per tracciare le scie evito di disegnare lo sfondo.
  // al suo posto disegno invece un rettangolo di colore nero 
  // con opacita'  parziale .
  //background(0);
  pushStyle();
  noStroke();
  fill(0, 20);
...
class Rectangle {
  ...
  // per assolvere a tutte le necessita'Ã�Â :
