...
//Miro's painting
//Test 008 [Date:20131015] Wayne Lin
//e-mail:ration.Lin@gmail.com
//N76014045 林瑞勛

//滑鼠點按，米字移動，色彩變化，隨著秒移動
//程式結構編排
...
void drawfloatmousePressed() {
  ...
  if (mousePressed == true) {
    ...
    background(mouseX, mouseY, mouseX+mouseY);//背景顏色變化

    //Line
    stroke(Xx-Yy, Xy+Yx, Yy);
    strokeWeight(3);

    line(Xx, Xy, Yx, Yy);
    line(Xx-50, Xy+45, Yx+38, Yy-51);
    line(Xx-35, Xy-4, Yx+43, Yy+10);
    line(Xx+37, Xy+4, Yx-51, Yy-2);
  }
  else {
...
void drawOneStar (int posx, int posy, int swidth, int sheight) {
