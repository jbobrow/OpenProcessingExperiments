...
for (int y = 0; y<height;y++) {
  ...
  i.beginShape();
  i.vertex(b, p);
  i. bezierVertex(120, p, q, 30, q, k);
  i.vertex(q, k);
  i.bezierVertex(q, 125, 140, r, b2, r);
  i.vertex(b2, r);
  i.bezierVertex(71, r, s, 115, s, k2);
  i.vertex(s, k2);
  i. bezierVertex(s, 37, 41, p, b, p);
  i.endShape();
  i.endDraw();
