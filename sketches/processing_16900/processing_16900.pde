...
void setup()
{
  ...
  // Load the table 
  String lines[]=loadStrings("https://spreadsheets.google.com/pub?key=0AovDPxTmQGH7dFJjUmticG80Q2ZYNzZpY05KWGJ6WkE&hl=en&output=txt");
...
void image_display(){
  ...
  String url = "https://dl.dropbox.com/u/2614917/CCA15/CCA_"+ scene_no_str +".jpg";
