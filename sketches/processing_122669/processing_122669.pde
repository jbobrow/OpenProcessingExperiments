...
int RIPPLES=3;
color to=color(172,5,245); // bg color cycling extreme colours
color from=color(129,255,199);
float CYCLEPERIOD=5.0; // bg color cycling speed
