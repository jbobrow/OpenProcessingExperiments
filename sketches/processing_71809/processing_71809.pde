...
//Creates a color variable that the circle will be. 
//The color will be based on the X position of the circle.
color objectFill;
...
void updateColor() {
    objectFill = color(objectX*255/400);
    }
