...
if(key=='1') { col1 = random(150,255);} else { col1=0;}  //if key 1 is pressed color turns red
if(key=='2') { col2 = random(150,255);} else { col2=0;} //if key 2 is pressed color turns green
if(key=='3') { col3 = random(150,255);} else { col3=0;}  //if key 3 is pressed color turns blue
