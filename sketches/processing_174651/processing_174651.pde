...
void draw() {
 ...
 randomSeed(100 * (mouseX+mouseY)/45);
 // design a patch
 PVector lBottom = new PVector(random(100), random(height)); // left bottom
 PVector mBottom = new PVector(random(width/2), random(height)); // middle bottom
 PVector rBottom = new PVector(random(width-100), random(height-100)); // right bottom
 PVector lMiddle = new PVector(random(width), random(height/2)); // left middle
 PVector mMiddle = new PVector(random(width/2), random(height/2)); // middle middle
 PVector rMiddle = new PVector(random(width), random(height/2)); // right middle
 PVector lTop = new PVector(random(100), random(100)); // left top
 PVector mTop = new PVector(random(width/2), random(0)); // middle top
 PVector rTop = new PVector(random(width), random(height)); // right top
