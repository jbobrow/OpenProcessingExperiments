...
void draw()
{
  ...
  */
  int numberOfBoxesPerRowX = 140;
  int numberOfBoxesPerRowZ = 14;
  for (int x = -(numberOfBoxesPerRowX/2); x < (numberOfBoxesPerRowX/2); x++) {
   for (int z = -(numberOfBoxesPerRowZ/2); z < (numberOfBoxesPerRowZ/2); z++) {
    /*
    ...
    */
    ...
    float xm = x*pixelSpacing -(pixelSpacing/2);
    float xt = x*pixelSpacing +(pixelSpacing/2);
    float zm = z*pixelSpacing -(pixelSpacing/2);
    float zt = z*pixelSpacing +(pixelSpacing/2);
