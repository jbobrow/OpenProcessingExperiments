    ...
    int n=0;
    float bigSqHue[] = {0,0,0,0,0};
    float smallSqHue[] = {0,0,0,0,0};
    float bigSqBright[] = {0,0,0,0,0};
    float smallSqBright[] = {0,0,0,0,0};
    //END
    ...
    void draw() {
      ...
      //MYCODE
      //These squares will store the colors
      noStroke();
      for (int count=1; count<5; count++){
        fill(bigSqHue[count-1],100,bigSqBright[count-1]);
        rect(count*width/5, height-100,80,80);
        fill(smallSqHue[count-1], 100, smallSqBright[count-1]);
        rect(count*width/5, height-100,40,40);
      }
      //END
    }
    ...
    void mouseReleased() {
      ...
      //MYCODE
      bigSqHue[n] = hueValue;
      smallSqHue[n] = complementryHue;
      bigSqBright[n] = brightValue;
      smallSqBright[n] = brightValue;
      n++;
      if(n==5){n=0;}
      //END
    }
