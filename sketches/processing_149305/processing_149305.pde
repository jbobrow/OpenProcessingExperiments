...
void loadTracks(String url){
    $.ajax({
        ...
        success: function(json) {
            ...
            musicName = " That Kid in Fourth Grade Who Really Liked the Denver Broncos";
            artistName = tracks[nb].artist_name;
            artistName = "Chris Zabriskie";
            info = musicName + " - " + artistName;
            musicUrl = tracks[nb].track_url;
            musicUrl = "http://freemusicarchive.org/music/Chris_Zabriskie/Undercover_Vampire_Policeman/06_-_That_Kid_in_Fourth_Grade_Who_Really_Liked_the_Denver_Broncos_1128"
