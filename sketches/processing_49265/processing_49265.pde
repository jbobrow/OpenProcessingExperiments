...
/* @pjs preload="https://dl.dropbox.com/u/55656142/elements_processingJs/bg001.png"; */
...
{
  size(400, 400);
  bg = loadImage("https://dl.dropbox.com/u/55656142/elements_processingJs/bg001.png");
  frameRate(25);
  smooth();
  colorMode(HSB, 1);
  noStroke();
