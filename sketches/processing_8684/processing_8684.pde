...
void draw () { 
  ...
  float subX = 100*noise(submin, submaxX);
  float subY = 400*noise(submin, submaxY);
  ...
  rect(820, 0, 20 , 840);
  fill(255, 255, 255);
  text ("move cursor to explore pattern :    X-axis currently  1 / " + submaxX +"    -    Y-axis  1 / "+ submaxY, 15 , 16);
