...
void setup()
{
  img = loadImage ("bodacious.jpg");
  currentTop = loadImage("forte.png");
  currentBottom = loadImage("coraggioso.png");
  
  outer[0] = "forte.png";      //Assign
  outer[1] = "iksujaw.png";
  outer[2] = "mtz.png";
  outer[3] = "otvaga.png";
  
  inner[0] = "coraggioso.png";
  inner[1] = "ichahleh.png";
  inner[2] = "otchaiyany.png";
  inner[3] = "tvzh.png";
