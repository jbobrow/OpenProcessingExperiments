...
void draw() {
  ...
  fill(255,0,0);
  text("Click and drag your mouse across!",150,500);
  fill(0,0,255);
  text("Click and drag your mouse down!", 450,500);
  fill(255,0,255);
  text("Here's your product!",750,500);
  ...
  for (int i = 0; i < grid1number; i++) {
    if (i < 11) {
        fill(255,0,0);
        noStroke();
        text(grid1number,150,450);
        ellipse((i*25)+25,25,10,10);
    }
    for (int j = 0; j < grid2number; j++) {
      if ((i < 11) && (j < 16)) {
        ...
        fill(255,0,255);
        text((grid1number*grid2number),750,450);
        ellipse((i*25)+625,(j*25)+25,10,10);
      }
    }
  }
