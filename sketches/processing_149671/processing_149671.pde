...
/* @pjs font="HelveticaNeueLTPro-Bd.otf,HelveticaNeueLTPro-MdCnO.otf,HelveticaNeueLTPro-MdEx.otf,HelveticaNeueLTPro-MdExO.otf,HelveticaNeueLTPro-ThEx.otf"; 
preload="ican-22.png,ican-23.png,ican-24.png,ican-25.png,ican-26.png,ican-27.png,ican-28.png,ican-29.png,ican-30.png,ican-31.png,ican-32.png,ican-33.png,ican-34.png,ican-35.png,ican-36.png,ican-37.png,ican-38.png,ican-39.png,ican-40.png,ican-41.png,ican-42.png,ican-43.png,ican-44.png,ican-45.png,ican-46.png,ican-47.png,ican-48.png,ican-49.png,ican-50.png,ican-50b.png,ican-51.png,ican-52.png,ican-53.png,logo_udi.png,textura-fondo.jpg"; 
 */
...
void mousePressed() {
  if(sobre(500,12,262) == true && estado == 6){
    estado = 8;
  }
  if(sobre(50,12,273) == true && estado >= 8 && estado <= 16){
    estado++;
  }
...
void setup(){
  ...
  hlogo = logo.height;
  smooth();
  fuente01 = loadFont("HelveticaNeueLTPro-Bd-19.vlw");
  fuente02 = loadFont("HelveticaNeueLTPro-ThEx-15.vlw");
  fuente03 = loadFont("HelveticaNeueLTPro-MdEx-15.vlw");
}
