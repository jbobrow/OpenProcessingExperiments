...
String input = "hallo";  // der eingegebene text
float spacing = 60;
...
void draw ()
{
    ...
    drawGenerativeText( input, 55, height/2 );
}
...
{
    triangle( random(-28,17)+x1, random(-1,10)+y1, random(-80,10)+x2, random(-10,10)+y2, random(-10,10)+x1, random(-10,10)+y2 );
}
