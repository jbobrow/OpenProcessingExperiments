...
final int SWITCH_CENTER_X = 25;
final int SWITCH_CENTER_Y = 450;
...
void draw() {
  ...
  drawLamp();  
  drawTriggerRegion();
  text("Modified by Cody Philips,",10,30); 
  text("Supreme Ruler of Westeros",10,50);
}
...
void drawLamp() {
  drawLight();
  fill(0, 255, 0, 50);
  triangle(250, 50, 350, 250, 150, 250);
  fill(175, 127, 67);
  rect(240, 250, 20, 250);
}
