...
void setup() {
  size(255, 173);
  frameRate(24);
  img = loadImage("mcField.png");
  animation1 = new Animation("upWalk", 13);
  animation2 = new Animation("rightWalk", 11);
  animation3 = new Animation("leftWalk", 12);
  animation4 = new Animation("downWalk", 11);
  animation5 = new Animation("restPose", 1);
}
