...
/* @pjs preload= "images/maze.png", "images/mazeclear.png", "images/wtf.png", "images/smileguy1.png", "images/meowicorn.jpg";*/
/* @pjs font=snap.ttf";*/
PImage smiley;
...
void setup(){
  ...
  smSpd = 8;
  halfS = 15;
  clearbackground = loadImage("images/mazeclear.png");
  smiley = loadImage("images/smileguy1.png");
  PImage mazebackground = loadImage("images/maze.png");
...
void loser() {
  background(0);
  stroke(255);
  text("YOU RAN OUT OF TIME!", 50, (height)/2);
  exit();
}
void winner() {
  background(0);
...
void maze() {
  ...
  wtf = loadImage("images/wtf.png");
  background(255);
  meowicorn = loadImage("images/meowicorn.jpg");
