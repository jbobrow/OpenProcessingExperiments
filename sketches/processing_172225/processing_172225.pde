...
void draw(){
  background(gray);
  if(phase){
    DrawSpot(x2,y2,maskRad,100,color(128,maskGreen,128));
    DrawSpot(x2-x1+500,y2-y1+500,maskRad,100,color(128,maskGreen,128));
    noStroke();
    fill(255);
    ellipse(500,500,3,3);
  }else{
    DrawSpot(x1,y1,targRad,100,color(128,lGreen,128));
    DrawSpot(x2,y2,targRad,100,color(128,rGreen,128));
  }
}
