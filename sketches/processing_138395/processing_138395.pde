...
void setup()
{
  ...
  mybackground = requestImage("Space.png");
  ...
  mybackground = loadImage("Space.png");
}
...
class Tank 
{
  ...
  Tank()
  {
    ...
    this.sprite = new AnimatedSprite("Eagle_Walk.png", 94,161);
  }
...
class Bullet
{
  ...
  Bullet()
  {
    this.img = requestImage("UltimateFireball3.png");
  }
