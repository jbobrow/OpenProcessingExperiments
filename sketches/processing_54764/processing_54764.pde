...
String message = "love causes friction / friction causes heat / heat causes pain / pain causes tenderness / tenderness causes love /";
PFont f;
...
void setup() {
  size(430,430);
  f = createFont("Georgia",13.49,true);
  textFont(f);
