...
arc(360,r, 50,50, 0, QUARTER_PI-.08);
arc(360,r, 50,50, QUARTER_PI,HALF_PI-.08);
arc(360,r, 50,50, HALF_PI,PI-.08);
arc(360,r, 50,50, PI,HALF_PI-.5);
arc(360,r, 140,140, PI+HALF_PI, 0);
 
fill(0);
stroke(0);
ellipse(350,r+10,1,1);
ellipse(378,r+7,1,2);
}
