...
class Boid {
  ...
  // Main "run" function
  public void run(int _siz, char _hKey, int _rCol, int _gCol, int _bCol, int _opac) {
    int siz = _siz;
    char hKey = _hKey;
    int rCol = _rCol;
    int gCol = _gCol;
    ...
    update();
    borders();
    render(siz, hKey, rCol, gCol, bCol, opac);
  }
  ...
  void render(int _siz, char _sKey, int _rCol, int _gCol, int _bCol, int _opac) {
    int siz = _siz;
    char sKey = _sKey;
    int rCol = _rCol;
    int gCol = _gCol;
