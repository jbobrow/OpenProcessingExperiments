...
/* @pjs preload="sheep.png,fence.png,shepherd.png,first.png"; */
PImage sheep;
PImage fence;
PImage shepherd;
PImage first;
...
void setup() {
  ...
  x1 = random(0, width - radius * 2);                            
  x2 = random(0, width - radius * 2);                           
  x3 = random(0, width - radius * 2);                           
