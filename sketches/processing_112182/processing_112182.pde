...
void setup(){
  size(600, 600);
  background(#3EAAD3); // Sets the background to blue
  smooth();
}
...
void draw_grass(){
  fill(#5BC94B); // Sets the colour to green
...
void draw_ears(){
  fill(#F26B11); // Sets the colour to orange
...
void draw_mouth(){
  fill(#D82ACD); // Sets the colour to purple
