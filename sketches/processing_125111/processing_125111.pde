...
void drawNoisePoint( )
{
    a = noise( xNoise )  * width ;
    b = noise( yNoise )  * height;
    ellipse( a, b, 5, 5 );
...
fill(255); 
  ...
  // eye balls 
    ellipse (x, y, eyewidth/2-20, m/2-20);

//map180
  float eye1x = map (a, 0, 500, 180, 220);
  float eye1y = map (b, 0, height, 180, 220);
...
//  eye1x = constrain (eye1x, 150, 250);
  ...
  fill (94, 56);
    println(eye1x);
  ellipse (x+eye1x-200,y+eye1y-200, 100/s, 100/s);


  //pupils
  fill (0);
  ellipse (x+eye1x -200, y+eye1y-200, p1/s, p1/s);

//beginShape();
//vertex(x -100,y-80);
//vertex(x+100,y-80);
//vertex(x+100,blinkbottom+y+20);
//vertex(x+0,blinkbottom+y);
//vertex(x-100,blinkbottom+y+20);
//endShape();
