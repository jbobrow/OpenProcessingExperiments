...
void setup()
{
  ...
  bubblePNG = loadImage("lead1.png");    //  Load the bubble image into memory
...
void draw()
{
  ...
  // ttext("Bubbles popped: " + poppedBubbles, 20, 40);          //  Displays some text showing how many bubbles have been popped
