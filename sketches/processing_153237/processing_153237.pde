...
void mouseClicked() {
  ...
  // mouseX right from the middle of screen -- increase frame_rate_value
  if (mouseX> (400) && frame_rate_value < 120) {
    frame_rate_value++;
  }

  // mouseX left from the middle of screen -- decrease frame_rate_value
  if ( mouseX< (400) && frame_rate_value > 2) {
    frame_rate_value--;
  }
