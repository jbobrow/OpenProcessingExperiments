...
void setup(){
  ...
  // background
  color b1 = color(250, 190, 190);
  color b2 = color(60, 20, 20);
  setGradient(5, 20, width, height, b1, b2, Y_AXIS);
  //center squares
  color c1 = color(1, 158, 100);
  color c2 = color(100, 45, 255);
  color c3 = color(176, 250, 8);
  color c4 = color(245, 250, 8);
  color c5 = color(255, 255, 0);
  color c6 = color(250, 56, 8);
