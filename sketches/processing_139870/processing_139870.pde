...
void draw() {   
  ...
  text(d,80,10);
  text("Нажимайте +/- для изменения сложности",10,30);

      
  text("Мини-игра по взлому. Нажимайте и удерживайте кнопку мыши на тумблерах.",10,300);
  text("Отпускайте в тот момент, когда тумблеры начинают трястить.",10,320);
  text("Нажмите клавишу 'R', когда захотите сбросить тумблеры к изначальному положению.",10,340);
}
