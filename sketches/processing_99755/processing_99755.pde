...
void draw()
{
  background(120,random(210),random(150));
  ...
  if ((xpos < 133)&&(xpos > 0)){
    xspeed = 7 ; //velocidad de este segmento
    fill(random(120),130,280,random(100)); //color de la figura en este segmento
  }
  if ((xpos < 266)&&(xpos > 133)){
    xspeed = 2.5;
    fill(0,random(030),200,100);
  }
  if ((xpos > 266)&&(xpos < 400)){
    xspeed = xspeed + 2;
    fill(120,250,random(250),100);
  }
  rect(xpos,mouseY+50,60,60);
  if ((x1pos < 133)&&(x1pos > 0)){
    x1speed = 0.5;
    fill(250,100,150,random(100));
  }
