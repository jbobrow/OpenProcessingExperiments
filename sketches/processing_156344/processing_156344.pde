...
/* Creative Coding
 ...
 Work: http://openprocessing.org/visuals/?visualID= 156344  
 License: 
...
void writePostcard() {
  ...
  textSize(20);
  fill(oppositeColor(x, y), 100);
  greetingText="From Parc GÃ�ï¿½Ã¯Â¿Â½Ã�Â¯Ã�Â¿Ã�Â½Ã�ï¿½Ã�Â¯Ã�ï¿½Ã�Â¿Ã�ï¿½Ã�Â½Ã�ï¿½Ã¯Â¿Â½Ã�Â¯Ã�Â¿Ã�Â½Ã�ï¿½Ã¯Â¿Â½Ã�ï¿½Ã�Â¼ell in Barcelona for Creative Coding students. July 2014";
  text(greetingText, x, y);
