  ...
  void draw()
  {
    ...
    pushMatrix();
      ...
      pushMatrix();
        rotate(as);
        stroke(255,0,0);
        line(0,15,0,-sLen); // draw as if it's at noon, rotation takes care of the rest
        stroke(0);
      popMatrix();
      ...
      pushMatrix();
        ...
        stroke(0);
        strokeWeight(4);
        line(0,0,0,-mLen); // draw as if it's at noon, rotation takes care of the rest
        stroke(0);
        strokeWeight(1);
      popMatrix();
      ...
      pushMatrix();
        ...
        stroke(0);
        strokeWeight(8);
        line(0,0,0,-hLen); // draw as if it's at noon, rotation takes care of the rest
        stroke(0);
        strokeWeight(1);
      popMatrix();
