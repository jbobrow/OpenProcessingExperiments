...
Vector tendrils1;
ParticleSystem physics1;
Particle mouse1;
int greyer1;
boolean drawing1;
boolean nothingDrawn1;
PImage imagenAleatoria1;
...
void drawElastic( T3ndril t )
{
  ...
  for ( int i = 0; i < t.particles.size()-1; ++i )
  {
    ...
    if (i%10 == 0 )   image(dameImagen(2),firstAnchor.x(),firstAnchor.y(),20,20);	
    if (i== 0) 	 image(imagenAleatoria,firstAnchor.x(),firstAnchor.y(),20,20);
