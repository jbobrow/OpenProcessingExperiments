...
void setup() {
  ...
  for (int i = 0; i < cubies; i++){
    ...
    quadBG[i][0] = color(255, 0, 0);   //red
    quadBG[i][1] = color(0, 0, 255);   //blue
    quadBG[i][2] = color(255, 255, 0);   //yellow
    quadBG[i][3] = color(255);   //white
    quadBG[i][4] = color(0);   //black
    quadBG[i][5] = color(180);   //grey

    // Cubies are randomly sized
    float cubieSize = random(5, 25);
