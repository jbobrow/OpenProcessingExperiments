...
void setup(){ // função que prepara a área de trabalho do jogo
  ...
  fim = loadImage("fim.png"); //carrega o endgame
  ...
  if(ent){  //Botões - Voltar play
       
       stroke (64,64,64); // contorno
       font = loadFont ("SansSerif.plain-48.vlw");
       textFont (font,18);
       fill (64,64,64); // cor do botão
       rect (480,500,100,60); //tamanho do botão
       fill (127,127,127); // cor da letra
