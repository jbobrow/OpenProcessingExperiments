...
void setup()
{
    ...
    block = loadImage("http://fc02.deviantart.net/fs70/f/2013/008/9/f/super_mario_bros___brick_block_by_nerde_ndty-d5qv6fq.png")
    x = 80;
    y = 80;
    p1 = 240;
    q1 = 120;
...
var IsRightFree(Mariox, Marioy, x2, y2){
return !(Mariox == x2-40 && Marioy == y2);}
