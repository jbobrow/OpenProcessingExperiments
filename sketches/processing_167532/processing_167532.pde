...
//This definition creates a psychadelic tunnel of expanding triangles, circles, and lines
...
void draw(){
  ...
  line(0,a,500,a);
  line(0,b,500,b);
  //Creates the horizontal lines that expand outwards vertically
   
  line(a,0,a,500);
  line(b,0,b,500);
  //Creates the vertical lines that expand outwards horizontally
