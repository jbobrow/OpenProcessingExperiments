...
String adj1 = "Distraidos,Obligados,Censurados,Impulsados,Incitados,InstruÃ­dos,Agitados,Confundidos,AtraÃ­dos,Agotados,Perplejos,Conducidos,Retirados,Construidos,Alentados,Dirigidos,Manipulados,Deseosos,Alterados,Derretidos";
String prep = " a, ante, bajo, cabe, con, contra, de, desde, en, entre, hacia, hasta, para, por, segÃºn, sin, de, sobre, tras, en";
...
String sust1 = " inmortalidad, personalidad, versatilidad, durabilidad, realidad, posibilidad, libertad, casualidad, propiedad, sociedad, novedad, tempestad, antigÃ¼edad, nacionalidad, capacidad, brutalidad, fragilidad, maternidad, sexualidad, dualidad";
String vrb2 = "habÃ­amos dejado,hubimos pensado,habÃ­amos sentido,hubimos construÃ­do,habÃ­amos salpicado,hubimos intuido,habÃ­amos tomado,hubimos jurado,habÃ­amos desgarrado,hubimos tostado,habÃ­amos fracasado,hubimos declarado,habÃ­amos pausado,hubimos negociado,habÃ­amos follado,hubimos contraÃ­do,habÃ­amos metido,habÃ­amos escupido,hubimos sacudido,habÃ­amos querido";
...
String sustFs = " lÃ¡mpara, indiferencia, dulzura, voz, alma, muerte, navaja, pamplina, mÃ­stica, noche, uva, carne, fruta, sinceridad, calma, avaricia, pelona, naciÃ³n, uÃ±a, dueÃ±a, ";
String sn = " sÃ­, no, sÃ­, no, sÃ­, no, sÃ­, no, sÃ­, no, sÃ­, no, sÃ­, no, sÃ­, no, sÃ­, no, sÃ­, no,";
String vrb4 = " veÃ­amos, confiÃ¡bamos, entendÃ­amos, fusionÃ¡bamos, interpretÃ¡bamos, enfurecÃ­amos, enfriÃ¡bamos, reprimÃ­amos, concentrÃ¡bamos, vulcanizÃ¡bamos, diseÃ±Ã¡bamos, componÃ­amos, duchÃ¡bamos, doblÃ¡bamos, repetÃ­amos, caÃ­amos, imaginÃ¡bamos, pujÃ¡bamos, rentÃ¡bamos, ingeniÃ¡bamos";
String art2 = " las, unas, las, unas, las, unas, las, unas, las, unas, las, unas, las, unas, las, unas, las, unas, las, unas";
String sustFp = " caras, personas, nalgas, luchas, tubas, lanzas, estrellas, tierras, maÃ±anitas, drogas, frutas, jirafas, leyes, canastas, reglas, proteinas, fracciones, lÃ­neas, alas, nubes";
String adv1 = " mÃ¡s, muchas, todas, todo, mÃ¡s, muchas, todas, todo, mÃ¡s, muchas, todas, todo, mÃ¡s, muchas, todas, todo, mÃ¡s, muchas, todas, todo";
String adj2 = " convincentes, ardientes, despampanantes, incluyentes, ardientes, dudosas, corrientes, parlantes, simpÃ¡ticas, duraderas, escandalosas, chillantes, dolientes, graciosas, cotorras, comunes, glotonas, hermosas, pandrosas, gomosas";
String sustMs = " fervor, cuerpo, hecho, hombre, acordeÃ³n, estorbo, libro, calor, ordenador, embajador, sombrero, vaquero, embustero, gato, bicarbonato, agujero, pelado, caballo, baquetÃ³n, ensayo";
String nombre = " Macedonio, Agabio, Doroteo, SÃ©ptimo, Octavio, Pascual, Hugo, Ezra, JoaquÃ­n, ElÃ­as, Rogelio, IsaÃ­as, Carlos, Adolfo, Vicente, Oriol, Lucas, Bruno, Gianfranco, Abner";
String apellido = " FernÃ¡ndez, Ledesma, Vega, Ojeda, FarÃ­as, Escobar, Aguirre, Oliva, Ibarra, Paredes, Tapia, GaitÃ¡n, Benitez, Saucedo, Galindo, Talamantes, CastaÃ±eda, MÃ¡rquez, BuendÃ­a, Valenzuela";
String vrb5 = " repetÃ­a, aseguraba, jugaba, abrÃ­a, cerraba, despachaba, incluÃ­a, rompÃ­a, tropezaba, fumaba, tocaba, salpicaba, intuÃ­a, esculpÃ­a, ideaba, conceptualizaba, crecÃ­a, negaba, creaba, destruÃ­a";
String vrb6 = " es, tiene, puede, cambia, corre, salta, miente, corta, escribe, engaÃ±a, cubre, rola, rÃ­e, muerde, llora, prefiere, acata, coge, soba, hiere";
...
String adj4 = " nulo, sabroso, inÃºtil, despiadado, controlado, temeroso, gentil, alterado, vecino, burlÃ³n, agripado, encantado, ordenado, dudoso, fastidioso, ansioso, leproso, viscoso, rufiÃ¡n, pudoroso, chulo";
String vrb8 = " sucederle, caerle, sobarle, quitarle, comprarle, manifestarle, golpearle, chuparle, brotarle, presionarle, insistirle, seducirle, equiparle, levitarle, atraerle, convocarle, redactarle, engaÃ±arle, orientarle, aplastarle";
String proPs = " yo, Ã©l, ella, yo, Ã©l, ella, yo, Ã©l, ella, yo, Ã©l, ella, yo, Ã©l, ella, yo, Ã©l, ella, yo, ella";
...
String vrbC2 = " les mintieron, les sobaron, les ganaron, les impidieron, les inflaron, les demandaron, les destruyeron, les demandaron, les impermeabilizaron, les impidieron, les agarraron, les esculpieron, les cantaron, les escribieron, les sacaron, les redactaron, les diseÃ±aron, les raparon, les consultaron, les cobraron";
String adj6 = " vieja, plena, rota, hueca, sÃ³la, confundida, fundida, fÃ¡cil, tonta, buena, blanca, gÃ¼era, fea, aburrida, corta, compleja, sagrada, eclÃ©ctica, quebrada, planchada";
String vrbC3 = "Propuse,IgnorÃ©,PrestÃ©,Conduje,CarguÃ©,SoplÃ©,InhalÃ©,TeletransportÃ©,SonreÃ­,AgarrÃ©,ConceptualicÃ©,DesarrollÃ©,IluminÃ©,RealicÃ©,VaporicÃ©,DudÃ©,EscarbÃ©,DesarrollÃ©,CortÃ©,AcatÃ©";
String vrb9 = " suicidÃ¡ramos, comiÃ©ramos, fumÃ¡ramos, tomÃ¡ramos, seduciÃ©ramos, alivianÃ¡ramos, persiguiÃ©ramos, intuyÃ©ramos, cogiÃ©ramos, elevÃ¡ramos, danzÃ¡ramos, abrazÃ¡ramos, perdiÃ©ramos, redactÃ¡ramos, aleteÃ¡ramos, digiriÃ©ramos, empujÃ¡ramos, manejÃ¡ramos, apantallÃ¡ramos, sobresaliÃ©ramos";
...
String vrb11 = " resolvieron, condujeron, generaron, comieron, integraron, cometieron, impulsaron, chingaron, rompieron, quemaron, limpiaron, fregaron, sacaron, pasaron, invirtieron, enseÃ±aron, engaÃ±aron, sufrieron, recrearon, aniquilaron";
String vrb12 = " suicidamos, conocimos, cocinamos, freÃ­mos, desdoblamos, confundimos, atacamos, desnudamos, recortamos, enloquecÃ­mos, sorteamos, limpiamos, buscamos, tomamos, repetimos, tronamos, levantamos, reflexionamos, economizamos, rastreamos"; 
String SINO = "SÃ­,No,SÃ­,No,SÃ­,No,SÃ­,No,SÃ­,No,SÃ­,No,SÃ­,No,SÃ­,No,SÃ­,No,SÃ­,No,";
String prep1 = " ante, bajo, con, contra, de, desde, en, entre, hacia, hasta, para, por, sin, sobre, tras, en, con, sin, hasta";
String prep2 = " ante, bajo, con, contra, de, desde, en, entre, hacia, hasta, para, por, segÃºn, sin, so, sobre, tras, en, por, desde";
String prep3 = "A,Ante,Bajo,Cabe,Con,Contra,De,Desde,En,Entre,Hacia,Hasta,Para,Por,SegÃºn,Sin,Para,Sobre,Tras,En";
String prep4 = " a, ante, bajo, sin, con, contra, de, desde, en, entre, hacia, hasta, para, por, segÃºn, sin, so, sobre, tras, en";
String YOS = "Yo,Ã�l,Ella,Me,Yo,Ã�l,Ella,Me,Yo,Ã�l,Ella,Me,Yo,Ã�l,Ella,Me,Yo,Ã�l,Ella,Me";
...
String MAS = "mÃ¡s,menos,mÃ¡s,menos,mÃ¡s,menos,mÃ¡s,menos,mÃ¡s,menos,mÃ¡s,menos,mÃ¡s,menos,mÃ¡s,menos,mÃ¡s,menos,mÃ¡s,menos";
...
String uneltu = "Un,Ã�l,Tu,Un,Ã�l,Tu,Un,Ã�l,Tu,Un,Ã�l,Tu,Un,Ã�l,Tu,Un,Ã�l,Tu,Un,Tu";
...
x38 = int (random(19));
 ...
 fill(30);
 textSize(16);
 text("DIÃ�LOGO SOBRE UN DIÃ�LOGO SOBRE UN DIÃ�LOGO", 270, 60);
 ...
 fill(0);
 text(list15[x1]+list14[x2]+" que"+list9[x3]+" el"+list29[x4]+" mÃ¡s"+list4[x5],472, 340);
