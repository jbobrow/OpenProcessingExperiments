...
int landarea = 77088/scale; //  - 1
int primaryarea = 0/scale;    // - 2
int deforestarea = 237/scale;  //3
int otherfrstarea = 1455/scale; //4
...
if (growforest == true){
  ...
  if (savepdf) beginRecord(PDF, millis()+ "pakistan.pdf" );
