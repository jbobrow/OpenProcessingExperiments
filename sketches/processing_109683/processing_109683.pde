...
/**
 *Sketch 3 : Loops and Conditionals
 *Daniel Zhu 0412620
 *9/17/13
 */
...
void setup() {
  //800 by 800 pixels canvas, P3D for 3 dimensional for translation
  size(800,800,P3D);
...
void draw() {
  ...
  //Planet not working in javascript version, don't know why so went with multiple ships
