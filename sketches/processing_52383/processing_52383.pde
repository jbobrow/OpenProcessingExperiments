...
void draw() {
 ...
 for (int i = 0; i < 5; i++) //how many pictures on screen
  ...
  rx1 = 150*cos(radians(180+frameCount*2));
  ry1 = 150*sin(radians(180+frameCount*2));
  rx2 = 150*cos(radians(frameCount*2));
  ry2 = 150*sin(radians(frameCount*2));
  rx3 = rx1+80*cos(radians(180+4*frameCount*2));
  ry3 = ry1+80*sin(radians(180+4*frameCount*2))/3;
  rx4 = rx1+80*cos(radians(4*frameCount*2));
  ry4 = ry1+80*sin(radians(4*frameCount*2))/3;
  rx5 = rx2+80*cos(-radians(180+4*frameCount*2));
  ry5 = ry2+80*sin(-radians(180+4*frameCount*2))/3;
  rx6 = rx2+80*cos(-radians(4*frameCount*2));
  ry6 = ry2+80*sin(-radians(4*frameCount*2))/3;
  
  image(kont,300+rx1+random(-5,5),300+ry1,250,250);
  image(m,300+rx2+random(-5,5),300+ry2,250,250); 
  image(td,300+rx3,220+ry3,45,45);
  image(td,300+rx4,220+ry4,45,45);
  image(td,300+rx5,220+ry5,45,45);
  image(td,300+rx6,220+ry6,45,45);
  println(frameCount);
