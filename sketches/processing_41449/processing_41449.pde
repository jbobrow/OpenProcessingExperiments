...
void soundcheck(int rr){
    ...
    if (sy[rr] == 1){sounds0.loop(0);}
    if (sy[rr] == 2){sounds1.loop(0);}
    if (sy[rr] == 3){sounds2.loop(0);}
    if (sy[rr] == 4){sounds3.loop(0);}
    if (sy[rr] == 5){sounds4.loop(0);}
    if (sy[rr] == 6){sounds5.loop(0);}
    if (sy[rr] == 7){sounds6.loop(0);}
    if (sy[rr] == 8){sounds7.loop(0);}
    if (sy[rr] == 9){sounds8.loop(0);}
    if (sy[rr] == 10){sounds9.loop(0);}
    if (sy[rr] == 11){sounds10.loop(0);}
    if (sy[rr] == 12){sounds11.loop(0);}
    if (sy[rr] == 13){sounds12.loop(0);}
    if (sy[rr] == 14){sounds13.loop(0);}
    if (sy[rr] == 15){sounds14.loop(0);}
    if (sy[rr] == 16){sounds15.loop(0);}
    if (sy[rr] == 17){sounds16.loop(0);}
    if (sy[rr] == 18){sounds17.loop(0);}
    if (sy[rr] == 19){sounds18.loop(0);}
    if (sy[rr] == 20){sounds19.loop(0);}
    if (sy[rr] == 21){sounds20.loop(0);}
    if (sy[rr] == 22){sounds21.loop(0);}
    if (sy[rr] == 23){sounds22.loop(0);}
    if (sy[rr] == 24){sounds23.loop(0);}
    if (sy[rr] == 25){sounds24.loop(0);}
    if (sy[rr] == 26){sounds25.loop(0);}
    if (sy[rr] == 27){sounds26.loop(0);}
