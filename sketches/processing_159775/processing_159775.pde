...
class Quartz{
  ...
  void drawQuartz1() {
    image(quartz1, xPos+450, yPos+400);
  }
  
  void drawQuartz2() {
    image(quartz2, xPos+650, yPos+400);
  }
  
  void drawQuartz3() {
    image(quartz3, xPos+500 , yPos+375);
  }
  
  void drawQuartz4() {
    image(quartz4, xPos+600, yPos+300);
  }
  
  void drawQuartz5() {
    image(quartz5, xPos+600, yPos+300);
  }
  
  void drawQuartz6() {
    image(quartz6, xPos+600, yPos+300);
  }
}
