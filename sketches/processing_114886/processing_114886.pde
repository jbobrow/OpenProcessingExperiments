...
void draw(){
  ...
  zed = loadImage("league10.png");
  imageMode(CENTER);
 image(zed, width/2, height/2, 75,75);
...
PImage bork;
bork = loadImage("league11.png");
image(bork, 600, 200, 30, 30);
image(bork, 600, 305, 30, 30);
image(bork, 650, 250, 30, 30);
image(bork, 550, 250, 30, 30);
