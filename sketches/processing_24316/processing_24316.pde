...
fill(255,154,3); 
ellipse(width, height, 50*s, 50*s);

fill(255);
ellipse(width, height,(45.5)*s, (45.5)*s);

fill(255,154,3);
ellipse(width, height,(44.5)*s, (44.5)*s);

fill(255);
ellipse(width, height,40*s, 40*s);
...
ellipse(0, 0, 6*s, 38*s);
popMatrix();


fill(255); 
ellipse(width, height, 15*s, 15*s);
fill(255,154,3); 
ellipse(width, height, 10*s, 10*s);
