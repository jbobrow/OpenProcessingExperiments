...
void setup() {
  ...
  Audacity = minim.loadSample("Audacity.wav");
...
//Created title of each image as a string  
 ...
 if (mousePressed && (mouseButton == RIGHT)) {
   background(255);
String w = "To enter 'STEPS TO TAKE' click and HOLD the right mouse button on the image at any time.  Release to exit.";
String y = "Click and HOLD the left mouse key on the image to view titles.";
