...
/*
Homework #2 on Variables and Conditionals
Elliott Cost
*/

// Variables
int triangleYPosition = 800;
int triangleVelocity = 1;
boolean moving = true;
float colorValue;
...
void draw() {
  ...
  fill(223, 183, 79);
  noStroke();
  triangle(250, triangleYPosition, 200, 479, 300, 479);
  
  //move gold triangle
  if ( moving ) {
     triangleYPosition = triangleYPosition + triangleVelocity;
  }
  
  if ( triangleYPosition < 0 || triangleYPosition > 800 ) {
    triangleVelocity = triangleVelocity * -1;
  }
  ...
  if(dist(mouseX,mouseY,251,325) < 50){
     fill(0, 250, 240, 90);
   }
  noStroke();
  smooth();
  ellipse(251,325,100,100);
  }
