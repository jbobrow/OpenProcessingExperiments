...
r+=0.2;
 ...
 // design a patch
 PVector lBottom = new PVector(150, height-150); // left bottom
 PVector mBottom = new PVector(width/2, height); // middle bottom
 PVector rBottom = new PVector(width-150, height-150); // right bottom
 ...
 PVector lTop = new PVector(150, 150); // left top
 PVector mTop = new PVector(width/2, 0); // middle top
 PVector rTop = new PVector(width-150, 150); // right top
