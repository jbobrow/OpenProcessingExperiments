...
void draw(){
 // if you put a background () then camarera will move smoothly 
 // Change height of the camera with mouseY
camera(mouseX, mouseY,500, // eyeX, eyeY, eyeZ
         300.0, 300.0, 0.0, // centerX, centerY, centerZ
         0.0, 10.0, 0.0); // upX, upY, upZ
