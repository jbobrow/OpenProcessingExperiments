...
float conversionFactor = 4 * 3.14 / duration; // A full circle (2*pi) occurs every duration milliseconds
...
void draw() {
    ...
    Stars tempStars = manyStars.get(i);
 ...
 // }
  ...
  noStroke();
  fill(#006600);
  ellipse(addleftcenterx-28, 365, 40,25);
  fill(#003300);
  ellipse(addleftcenterx+38, 365, 40,25);
  fill(#009933);
  ellipse(addleftcenterx+5, 365, 40,25);
  
  //right shrubbery
  noStroke();
  fill(#006600);
  ellipse(addleftcenterx-28+242, 365, 40,25);
  fill(#003300);
  ellipse(addleftcenterx+38+242, 365, 40,25);
  fill(#009933);
  ellipse(addleftcenterx+5+242, 365, 40,25);
}
...
void sun(){
  ...
  float Rx = width/1.5 + sunRadius/2;
  float Ry = height/1.4 - sunRadius/2;
...
void moon(){
  ...
  fill(200);
  noStroke();
  ellipse(500-xSun, 800-ySun, 75, 75);
  //ellipse(xSun, ySun, sunRadius, sunRadius);
  hour++;
...
/*void stars(){
  if(nighta>=210){
  fill(random(100,255), nighta);
  ellipse(random(500), random(370), 5, 5);
  ellipse(random(500), random(370), 5, 5);
...
class Stars{
 float x,y,d;
 Sphere(float parameterX, float parameterY){
  x=parameterX;
  y=parameterY;
