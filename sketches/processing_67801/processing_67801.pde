...
/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/66855*@* */
/* !do not delete the line above, required for linking your tweak if you re-upload */
/* ======================================================
Aurthor: Xiaozhou ZHOU, Farbod Fathalipouri
Student ID: 347214 , 373457
...
int vertexNumMax = 4;
int strokeWidthMax = 5;
int oscillator = 5;         //stroke width
