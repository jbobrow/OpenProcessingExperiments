...
photo = loadImage("bck.jpg");
  ...
  buttons[0] = loadImage("B.gif");
  buttons[1] = loadImage("G.gif");
  buttons[2] = loadImage("O.gif");
  buttons[3] = loadImage("R.gif");
  buttons[4] = loadImage("Y.gif");
  buttons[5] = loadImage("eraser.gif");// This is just a white circle to use as an eraser
