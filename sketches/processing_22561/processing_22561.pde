...
float circleRadius = random(1,10);
 
// Color Scheme Used for Randomization
color Red = color(255,0,0,random(0,65));
color Green = color(0,255,0,random(0,65));
color Purple = color(208,3,255,random(0,65));
...
for(int curveNum = 0; curveNum < random(5,30); curveNum++){
...
//SKETCH by Sam Clagett "Drawing Machine" /?visualID=20018
