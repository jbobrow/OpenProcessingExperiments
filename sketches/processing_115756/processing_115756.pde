...
//Press mouse, and the star will explode
// I wanted to change the colors and movenment according to 
// changing time...
// Su Hsiu Pai
...
void drawstar() {
  ...
  if (mousePressed) {
    ...
    line(mouseX-104, mouseY, mouseX+80, mouseY);
    line(mouseX, mouseY-76, mouseX+3, mouseY+100);
    line(mouseX-80, mouseY-100, mouseX+92, mouseY+120);
    line(mouseX-100, mouseY+90, mouseX+90, mouseY-80);


    line(mouseX/2-50, mouseY+250, mouseX/2+50, mouseY+250);
    line(mouseX/2, mouseY/2-50, mouseX/2, mouseY/2+50);

    line(mouseX/3-80, mouseY+150, mouseX/5+50, mouseY+150);
    line(mouseX/3+220, mouseY+450, mouseX/3+250, mouseY+350);
    line(mouseX/2+220, mouseY+50, mouseX/2+250, mouseY+150);
    line(mouseX/2-320, mouseY+50, mouseX/2-450, mouseY+150);
    line(mouseY/2-320, mouseX+50, mouseY/2-450, mouseX+150);

    fill(70, 130, 180);
    noStroke();
    ellipse(mouseX, mouseY, mouseX/3+2, mouseY/3+3);
  }
  else {
    stroke(0);
    strokeWeight(3);
...
void drawshapes() {
  ...
  // middle drop_black
  noStroke();
  fill(mouseX-350, mouseY/3, mouseY-350);
  beginShape();
  vertex(536, 423);
  bezierVertex(542, 412, 550, 400, 559, 394);//
  bezierVertex(566, 387, 574, 382, 594, 372);//
