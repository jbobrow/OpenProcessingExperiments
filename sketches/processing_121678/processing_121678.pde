...
int NO_OF_ENDPOINTS = 543;
int NO_OF_CONES = 650;
int NO_OF_CURVES = 74;
int RANDOM_RANGE = 54;
 
float NO_OF_CIRCLES_PER_CURVE = 46;
 
color cEndPoint = color(255,105,40);
color cCircleStroke = color(50);
...
void setupEndpoints() {
  ...
  for (int i=0; i<NO_OF_ENDPOINTS; i++) {
    ...
    endx[i] = random(1020,width-100);
    endy[i] = random(1500,height-100);
