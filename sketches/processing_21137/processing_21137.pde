...
// Add some gravity and damping.. 
// Shows how Objects can still see global variables. 
...
//=======================================================================
// Lets "reset" everything on mousePressed
void mousePressed() {
  oneCircle.push();
  anotherCircle.push();
}
...
class Circle {
  ...
  //---------------------------------------------------
  // Resets the speed variables to new values 
  void push() {
    this.speedX = random(-2, 2);
    // always move up -- like we're giving it a push
