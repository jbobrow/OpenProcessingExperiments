...
void createBricks() {
  ...
  int yBricks = 0; 
  color[] rowsColors = {
    #ED4B00, #1A640F, #431A07, #FA9A74, #2F4D13, #392015, #1A640F, #4C8915, #96D30B, #431A07, #F59F14, #FA9A74, #1A640F, #ED4B00, #392015, #F59F14, #1A640F
  };
  //
  //
  // CREATE BRICKS --
...
public class Ball {
  ...
  void updatePosition() {
    ...
    if(y<=0 || y>=gameFrameHeight-height){
      velY = -velY;
      y = constrain(0, y, gameFrameHeight-height);
    }
    xcentre = x+width/2;
    ycentre = y+height/2;
