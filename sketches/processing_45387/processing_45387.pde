...
void setup()
{
  pythonDataDisplay = new dispData("python.txt", color(11, 116, 11));
  javaDataDisplay = new dispData("java.txt", color(252, 5, 5));
  htmlDataDisplay = new dispData("html.txt", color(19, 30, 137));
