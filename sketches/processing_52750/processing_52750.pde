...
image(grass, 0, 300, width, 400);
image(legob, 10, 450, 130, 70);
image(legor, 15, 430, 60, 50);
image(legoy, 40, 430, 100, 50);
image(barbie, 50, 280, 60, 170);
image(alf, 0, 470, 70, 100);
image(alf, 150, 420, 70, 100);
image(alf, 110, 500, 70, 100);
image(nutella, 350, 430, 150, 200);
image(nutella, 300, 460, 150, 200);
image(nutella, 240, 550, 150, 200);
image(lays, 350, 500, 180, 250);
image(luigi, 380, 360, 315, 385);
image(crayony, 650, 300, 50, 250);
image(greencrayon, 720, 290, 70, 310);
image(redcrayon, 800, 300, 50, 250);
image(pom, 750, 520, 120, 124);
image(mario, 710, 280, 75, 75);
image(mario, 50, 100, 20, 20);
image(mario, 250, 70, 25, 25);
image(mario, 200, 250, 20, 20);
image(mario, 650, 170, 25, 25);
image(mario, 800, 70, 20, 20);
