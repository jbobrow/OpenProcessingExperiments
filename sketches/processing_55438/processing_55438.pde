...
{
 pushMatrix();
  translate(width/2-200, height/2-170);
  shapeTween(leftline, mouseX,  randx[0],randy[0],  -7,45, 10.5); 
  shapeTween(leftline2, mouseX, randx[3],randy[3],  -7,85, 10);
  shapeTween(mvertex, mouseX, randx[2],randy[2],  44,37, 5);
  shapeTween(rightline, mouseX, randx[1],randy[1],  197, 59, 1);
  shapeTween(slantlineleft, mouseX, randx[4],randy[4],  21,13, 3);
  shapeTween(slantlineright, mouseX, randx[5],randy[5],  66,22, 0.5);
  shapeTween(slantlineright2, mouseX, randx[6],randy[6],  81, 2, 2);
  shapeTween(tophorzline1, mouseX, randx[7],randy[7],  141, -15, 4);
  shapeTween(topleftcorner, mouseX, randx[8],randy[8],  3,3, 6);
  shapeTween(toprightcorner, mouseX, randx[9],randy[9],  179, 7, 7);
  shapeTween(tophorzcorner, mouseX, randx[23], randy[23], 104, -11, 8);
  popMatrix();   
}
...
{
 pushMatrix();
 translate(width/2-70, height/2-165);
 shapeTween(otri1, mouseX, randx[10], randy[10], -5, 21, 0.5);
 shapeTween(otri2, mouseX, randx[11], randy[11], -5, 78, 1);
 shapeTween(otri3, mouseX, randx[12], randy[12], -5.5, 78.2, 1.5);
 shapeTween(otri4, mouseX, randx[13], randy[13], 40.1, 77.4, 2);
 popMatrix();
}
...
{
  pushMatrix();
  translate(width/2+50, height/2-164);
  shapeTween(ctri1, mouseX, randx[14], randy[14], 0, 63, 0.5);
  shapeTween(ctri2, mouseX, randx[15], randy[15], 0, 8, 1);
  shapeTween(ctri3, mouseX, randx[16], randy[16], -1, 6, 1.5);
  shapeTween(ctri4, mouseX, randx[17], randy[17], 44, 7.4, 2);
  popMatrix();
}
...
void drawA(float x, float y)
{
  ...
  shapeTween(atri1, mouseX, randx[18], randy[18], 179,-55, 1.5);
  shapeTween(atri2, mouseX, randx[19], randy[19], 183, 10, 0.5);
  popMatrix();
...
void drawCAline (float x, float y)
{
  ...
  pushMatrix();
  translate(width/2, height/2-100);
  shapeTween(bottomline1, mouseX, randx[20], randy[20], 50, 40, 1.5);
  shapeTween(bottomline2, mouseX, randx[21], randy[21], 102, 24, 0.5);
  shapeTween(bottomline3, mouseX, randx[22], randy[22], 141, -7, 5);
  popMatrix();
}
 


void shapeTween(PShape ps, float mx, float startx, float starty, float targetx, float targety, float offset)

{
  ...
  x += 0.00015;
  y += 0.0001;
  float nx = 50 + noise(x+offset) * (width-50);
  float ny = 50 + noise(y) * (height-50);
  
  mx = constrain(mx, 0,width-50);
  float x = map( mx, 0, width-50, startx+nx, targetx);
  float y = map( mx, 0, width-50, starty+ny, targety);
