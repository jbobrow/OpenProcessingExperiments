...
public float _lx=0.00;
public float _ly=0.00;
public int harukitmode= 1;
public int pNum =4;//16
public color [] pop = new color[pNum];
Particle[] p = new Particle[pNum];
public float rr=0.00;
public float gg=0.00;
public float bb=0.00;
public float dis=0.00;
public int gain = 9;
public int gmode = 3;
PImage ax;
...
void setup(){
  ...
  if (online)picf = createImage(w,h,ARGB);
