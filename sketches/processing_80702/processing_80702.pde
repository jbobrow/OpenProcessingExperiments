...
/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/60986*@* */
...
void setup() {
  ...
  // text to begin with
  textTyped += "Once when.. I was six?? years old \\I saw a magnificent,, picture in a book, called True Stories!! from Nature, about the.. primeval forest.";
  textTyped += "It was a picture of? a boa constrictor in the act of swallowing an animal.";
  textTyped += "Und subtrahiere, \n\n";
  textTyped += "Here is? a copy of \\the drawing.";


  centerX = width/2;
  centerY = height/2;  

  font = createFont("HaloHandletter.ttf",10);
