...
// noCursor();
  ...
  bigFont = loadFont("OCRAExtended-18.vlw");
...
//  ellipse(x,y, radius, radius);
 // rect(rect1X, rect1Y, rect1Width/2, rect1Height);
  rect(rect2X, rect2Y, rect2Width, rect2Height/3);
  rect(rect2X-100, rect2Y+100, rect2Width, rect2Height/2);
  rect(rect2X*3, rect2Y+100, rect2Width, rect2Height/2);
   rect(rect1X, rect1Y*2, rect1Width/2, rect1Height);
  ...
  if(gameMode == 0)
  {
    fill(255);
    textFont(bigFont,18);
    text("Click circle to start.", 300,200);
  }
  else if(gameMode == 1)
  {
      fill(255);
  ...
  else if(gameMode == 2)
  {
   ...
   // text("Game Over!", 258,250);
    textFont(font, 68);
    fill(247,255,26);
    text(" Your High Score:" + score, 60,260);
    fill(255);
    textFont(bigFont, 18);
    text("Click to restart", 320, 335);
