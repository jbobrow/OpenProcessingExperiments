...
boolean collision (float objectX, float objectY)
{
    if (Math.abs(objectX-XPos)<50 && y > 300){
        return(true);
    } else{
      return(false);
    }
...
boolean collision (float objectX1, float objectY1)
{
    if (Math.abs(objectX1-XPos)<50 && y1 > 300){
        return(true);
    } else{
      return(false);
    }
}
boolean collision (float objectX2, float objectY2)
{
    if (Math.abs(objectX2-XPos)<50 && y2 > 300){
        return(true);
    } else{
      return(false);
    }
}
boolean collision (float objectX3, float objectY3)
{
    if (Math.abs(objectX3-XPos)<50 && y3 > 300){
        return(true);
    } else{
      return(false);
    }
}
boolean collision (float objectX4, float objectY4)
{
    if (Math.abs(objectX4-XPos)<50 && y4 > 300){
        return(true);
    } else{
      return(false);
    }
