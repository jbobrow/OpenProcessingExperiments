...
/* @pjs preload="green.jpg,mouse.png,moth.png,squirrel.png,bird.png,catpounceU.png,catpounceD.png,catpounceR.png,catpounceL.png,cat2feetU.png,cat2feetD.png,cat2feetR.png,cat2feetL.png,splash.jpg,meow.jpg";
*/
...
void setup() {
  ...
  pic14 = loadImage("splash.jpg");
  pic15 = loadImage("meow.jpg");
...
void draw() {
  ...
  case 1:
    ...
    image(myCat, catPos.x - 10, catPos.y) ;
    if (myCars.size() == 0) {
      myState = 2;
    }
