...
{ 
  ...
  petalLength = max(displayWidth,displayHeight)/6 ;
...
void initFlyPath()  
{ 
  float flowerRadius = petalLength / 1 ; 
  float flyWidth = 3.5*petalLength ;
  
  flyPath[0][0] = new PVector(flowerRadius/2,0) ; 
  flyPath[0][1] = new PVector(-flyWidth/2,-flowerRadius) ; 
  flyPath[0][2] = new PVector(flyWidth/2,-flowerRadius) ; 
  flyPath[0][3] = new PVector(-flowerRadius/2,0) ; 
 
  flyPath[1][0] = new PVector(-flowerRadius/2,0) ; 
  flyPath[1][1] = new PVector(-flyWidth/2,flowerRadius) ; 
  flyPath[1][2] = new PVector(-flyWidth/2,-flowerRadius) ; 
  flyPath[1][3] = new PVector(-flowerRadius/2,0) ; 
 
  flyPath[2][0] = new PVector(-flowerRadius/2,0) ; 
  flyPath[2][1] = new PVector(flyWidth/2,flowerRadius) ; 
  flyPath[2][2] = new PVector(-flyWidth/2,flowerRadius) ; 
  flyPath[2][3] = new PVector(flowerRadius/2,0) ; 
 
 
  flyPath[3][0] = new PVector(flowerRadius/2,0) ; 
  flyPath[3][1] = new PVector(flyWidth/2,-flowerRadius) ; 
  flyPath[3][2] = new PVector(flyWidth/2,flowerRadius) ; 
