...
color badgebg;
color darkerbadgebg;
color coralred_alpha;
color offyellow_alpha;
color turquoise_alpha;
color redcircle;
color yellowcircle;
color bluecircle;
...
void setup( ) {
      ...
      // color setting
      bg = color(212, 212, 200);
      darkerbg = color(198, 199, 187);
      turquoise = color(129, 193, 184);
      coralred = color(222, 67, 61);
      offyellow = color(218, 187, 75);
      white = color(255, 255, 255);
      badgebg = color(51, 52, 53);
      darkerbadgebg = color(17, 17, 18);
      coralred_alpha = color(222, 67, 61, 70);
      offyellow_alpha = color(218, 187, 75, 70);
      turquoise_alpha = color(129, 193, 184, 70);
      redcircle = coralred_alpha;
      yellowcircle = offyellow_alpha;
      bluecircle = turquoise_alpha;
...
void keyPressed () {
      ...
      darkershadowx = shadowx+.01*wd;
        ...
        if (yellowcircle == offyellow_alpha) {
          yellowcircle = offyellow;
        }
        else {
          yellowcircle = offyellow_alpha;
        }
        ...
        if (bluecircle == turquoise_alpha) {
          bluecircle = turquoise;
        }
        else {
          bluecircle = turquoise_alpha;
        }
