  ...
  for (int x = -50; x < w+50; x = x+50)
{
  ...
  ellipse (x+14, y+14, r, r); //stars
    ...
    ellipse(550, 440, 125, 125); //planet
      ...
      noStroke();
    fill(250,205,40); 
    ellipse(350-frameCount*3, 850-frameCount*2, 7, 7); //shooting star going up
...
void robotBody()
{
  ...
  arc (mouseX+40,mouseY+100,50,20,radians(-30),radians(150));
}
  
void robotFace()
{
  fill(0);
  ellipse(mouseX-10, mouseY-10, 10, 6);
  ellipse(mouseX+10, mouseY-10, 10, 6);
  arc(mouseX, mouseY, 20, 20, radians(240), radians(300));
}
