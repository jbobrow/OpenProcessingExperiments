...
void draw() {
    ...
    //pushing the matrix and style to get rid of no stroke and color setup
   ...
   stroke(#FFFFFF);
    ...
    fill(ft1 [4], 120);
    ellipse(width*5/5, q1, d1, d1);
    q1+=3;

    fill(ft1 [0], 120);
    ellipse(width*6/5, q2, d1, d1);
    q2+=3;
    
    fill(ft1 [1], 120);
    ellipse(width*7/5, q3, d1, d1);
    q3+=3;
    
    fill(ft1 [2], 120);
    ellipse(width*8/5, q4, d1, d1);
    q4+=3;
    
    fill(ft1 [3], 120);
    ellipse(width*9/5, q4, d1, d1);
    q4+=3;
    
    fill(ft1 [4], 120);
    ellipse(width*10/5, q4, d1, d1);
    q4+=3;
    ...
    fill(c1, 120);
    ellipse(width*1/5, q1, d1/2, d1/2);
    q1+=1;
