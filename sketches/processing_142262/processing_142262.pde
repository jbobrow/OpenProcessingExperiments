...
//eyes
float eyeLeftX = constrain (mouseX,209,244);
float eyeLeftY = constrain (mouseY,270,305);
float m = map(value, 209,244,270,305);
float eyeRightX = map(mouseX,0,width,209,244);
float eyeRightY = map(mouseY,0,width,270,305);

fill(0);
strokeWeight(3);
ellipse(eyeLeftX,eyeLeftY+(random(-10,10)),20,30);
ellipse(eyeLeftX+70,eyeLeftY+(random(-10,10)),20,30);
