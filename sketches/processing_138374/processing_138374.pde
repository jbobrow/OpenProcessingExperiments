...
{
  size(800, 800);
  background = requestImage("backgroundtopdown.png");
  target = requestImage("target.png");
...
void keyPressed()
{
    ...
    if (keyCode == UP)
    {
      ...
      myTank.sprite.setAnimation(0, 27, true);
    }
    if (keyCode == DOWN)
    {
...
class Tank 
{
  ...
  Tank()
  {
    ...
    this.sprite = new AnimatedSprite("Walker.PNG", 77, 86);
  }
