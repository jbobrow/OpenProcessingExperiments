...
//Penrose Tile L-System by Geraldine Sarmiento (NYU ITP).
    ...
    for (int i = 0; i < steps; i++) {
      ...
      if (step == 'F') {
        ...
        for (int j = 0; j < repeats; j++) {
          stroke(255,0,255,60);
          ellipse(0, 0, random(drawLength/2), drawLength/2);
          stroke(255,255,0,120);
          ellipse(0, 0, random(drawLength/5), drawLength/5);
          //stroke(255,255,0,60);
      ...
      else if ( (step >= 100) && (step <= 300) ) {
        repeats = (int)step - 600;
      }
    }
