...
class Spring extends VerletConstrainedSpring2D {

  Spring(Particle a, Particle b, float len, float str, float limit) {
    super(a, b, len, str, limit);
  }

  // All we're doing really is adding a display() function to a VerletSpring
  void display() {
    noFill();
    //draw beginning pink
    stroke(255, 0, 255);
