...
/*
 ...
 which also triggers a syntethised sound.
 The colours are randomly selected and the stroke can be changed using the keyboard.
 It also allows to save the sketch ('s' key) and restore the canvas (DEL or Backspace keys).
 ...
 click / drag : draw and produce sound
...
// Import minim for audio
import ddf.minim.*;

// Declare and iImport audio file
Minim minim;
AudioSample sounds;
...
void setup(){
  ...
  sounds = minim.loadSample("sounds.wav");
}
