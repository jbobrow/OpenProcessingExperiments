...
void drawCurves() {
  ...
  pushMatrix();
  translate(136, 250); 
  rotate(radians(-m-60+mouseX+mouseY));
  beginShape();
  vertex(157-136, 157-250); // first point
  bezierVertex(147-136, 184-250, 131-136, 195-250, 119-136, 212-250);
  bezierVertex(107-136, 228-250, 97-136, 238-250, 102-136, 257-250);
  bezierVertex(107-136, 273-250, 121-136, 284-250, 134-136, 284-250);
  bezierVertex(150-136, 284-250, 165-136, 278-250, 167-136, 257-250);
  bezierVertex(168-136, 236-250, 160-136, 231-250, 152-136, 230-250);
  bezierVertex(143-136, 228-250, 136-136, 237-250, 136-136, 242-250);
  endShape();
  popMatrix();
...
void drawBlackBalls() {
  ...
  if (s>0 && 2>s) {
    ...
    line(269, 285, 269, 340);
    ellipse(269, 352, 28, 28);
  }
  else {
...
void drawGreenBalls() {
  int m = minute();
  //green balls
  fill(25, mouseX, mouseX, 60);
  noStroke();
  //green ball rotate in an hour
  pushMatrix();
  translate(325, 172);
  rotate(radians(-1.5*m));
  beginShape();
  vertex(71-325, 29-172); // first point
  bezierVertex(-24-325, 22-172, -22-325, -88-172, 67-325, -82-172);
  bezierVertex(183-325, -76-172, 128-325, 33-172, 71-325, 29-172);
  endShape();
  popMatrix();
...
void drawBlueBalls() {
  ...
  stroke(0);
  fill(0, 58, 140, 80);
  //blue balls color changes with minutes
...
void drawBlackBalls2() {
  ...
  //black ball rotate 360 degrees in a minute
  pushMatrix();
  translate(276, 215);
  rotate(radians(6*s));
  beginShape();
  vertex(198-276, 236-215); // first point
  bezierVertex(195-276, 220-215, 226-276, 215-215, 229-276, 231-215);
  bezierVertex(233-276, 245-215, 200-276, 253-215, 198-276, 236-215);
  endShape();
  popMatrix();
}
