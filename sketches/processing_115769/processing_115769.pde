...
// xiahuangjing  
// 541009408@qq.com
// color of background change with time.
// add a clock
// shake lines
// three stars rotating
...
void draw() {
  ...
  int y = year();
  String T=(y+" /"+h+" /"+m+" /"+s);
  background(s*50, s*10, s*15);
  textSize(27);
  fill(0, 102, 153,100);
  text(T, mouseX+s*2, mouseY+s*s/10,-30);



  stroke(mouseY, mouseY, mouseX, 150);
  strokeWeight(random(0, 3)); // mouseX=362 ,mouseY=358
  ...
  line(427-380, 418-358, 427-485, 418-490);
  ...
  line(227-180, 218-158, 227-285, 218-290);
  line(227-162, 218-218, 227-276, 218-210);
  line(227-162, 218-272, 227-272, 218-168);
  line(227-225, 218-165, 227-229, 218-277);
  popMatrix();
  ...
  line(127-80, 318-258, 127-185, 318-390);
  line(127-62, 318-318, 127-176, 318-310);
  line(127-62, 318-372, 127-172, 318-268);
  line(127-125, 318-265, 127-129, 318-377);
  popMatrix();
}
