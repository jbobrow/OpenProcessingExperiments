 ...
 */
 ...
 //MODIFIED BY RON BEILINSON
 //SEPTEMBER 12, 2014
 //CHANGED TRIGGER PROPERTIES AND MODDED APPEARANCE
...
final int SWITCH_CENTER_X = 15;
final int SWITCH_CENTER_Y = 500 - 30;
...
void draw() {
  ...
  textSize(18);
  fill(255, 0, 0);
  text("Modified by Ron Beilinson", 10, 20);
  drawLightSwitch();
  drawLamp();  
  drawTriggerRegion();
}
...
void drawLamp() {
  drawLight();
  fill(0, 255, 0, 50);
  quad(200, 100, 300, 100, 350, 450, 150, 450);
  fill(175, 127, 67);
  rect(240, 250, 20, 250);
}
