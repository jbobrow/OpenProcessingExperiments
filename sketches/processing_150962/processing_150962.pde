...
class Tablero {
  ...
  Tablero() // Constructor: Crea el pimball
  {
    ...
    Plano one = new Plano(50, 400, 150, 460);
    Plano two = new Plano(width-50, 400, width-150, 460);
    Plano three = new Plano(50, 160, 150, 100);
    Plano four = new Plano(width-50, 160, width-150, 100);
