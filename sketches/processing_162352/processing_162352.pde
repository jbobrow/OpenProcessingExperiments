...
void draw()
{
  ...
  {
    scaleselector = mouseX;
    size = map(mouseX, 40, 265, 10, 35);
  }

  rect(scaleselector, 480, 5, 20 );
 ...
 if (mouseX > 190 && mouseX < 210 && mouseY > 550 && mouseY < 570 && mousePressed)
  ...
  //brush command, must place at the bottom!!
