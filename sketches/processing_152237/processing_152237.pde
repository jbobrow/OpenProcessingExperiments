...
void mouseClicked() {
  float aux = map(mouseX, 0, displayWidth, 2, 120);
  frame_rate_value = (int)aux;
  println("The mouse button was clicked, and frame_rate_value is: " + frame_rate_value);
}
