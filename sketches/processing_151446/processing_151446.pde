...
void draw() {
 ...
 // translate(0,-200,-200);
  ...
  points[7]=interD(points[1],points[4],points[2],points[6]);//le point D2
...
void les3Plans() { 
  ...
  quad4(longueur/2, largeur/2, -2, color(125, 40, 40), color(145, 85, 40));

  popMatrix();
  pushMatrix();
  translate(0, (-1+0.5*cos(psi))*largeur, 0.5*sin(psi)*largeur);
  rotateX(psi);
  quad4( longueur*0.5, largeur*0.5, 2, color(100, 75,0), color(80, 50, 95));
