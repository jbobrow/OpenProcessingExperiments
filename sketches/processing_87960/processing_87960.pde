...
simple multicolor tweak by messengerboy Sat, 2 February 2013, 23:28 
...
void draw()  {
 ...
 if (tickdex == 0) {
    rcolorr = 255;
    if (rcolorg < 255) {rcolorg++;} else {rcolorg=255;}
    rcolorb = 0;
  } else {
    if (tickdex == 1) {
    if (rcolorr > 0) {rcolorr--;} else {rcolorr=0;}
    rcolorg = 255;
    rcolorb = 0;
  } else {
      if (tickdex == 2) {
    rcolorr = 0;
    rcolorg = 255;
    if (rcolorb < 255) {rcolorb++;} else {rcolorb=255;}
  } else {
      if (tickdex == 3) {
    rcolorr = 0;
    if (rcolorg > 0) {rcolorg--;} else {rcolorg=0;}
    rcolorb = 255;
  } else {
      if (tickdex == 4) {
    if (rcolorr > 255) {rcolorr++;} else {rcolorr=255;}
    rcolorg = 0;
    rcolorb = 255;
  } else {
      if (tickdex == 5) {
    rcolorr = 255;
    rcolorg = 0;
    if (rcolorb > 0) {rcolorb--;} else {rcolorb=0;}
  }}}}}}
  ...
  if (mousePressed == true)  { 
    ...
    line0.render(rcolorr,rcolorg,rcolorb, lineAlpha);
    line1.calcPoints(mouseX, mouseY);
    line1.render(rcolorr,rcolorg,rcolorb, lineAlpha);
    line2.calcPoints(mouseX, mouseY);
    line2.render(rcolorr,rcolorg,rcolorb, lineAlpha);
  } else {
      line0.calcPoints(mouseX, mouseY);
