...
/* @pjs preload="silver-diamond-plate.jpg" ; font = "Orbitron-Regular.ttf" */
...
void setup() {
  size(650, 650);
  steel = loadImage("silver-diamond-plate.jpg") ;
  orbit = createFont("Orbitron-Regular.ttf", 200);
}
...
void draw(){
  switch(myState){
    ...
    fill(0);
    textFont(orbit, 13);
    text("It's ok, just click the button there, you'll get it next time.", 125, 450);
    definition = (int)random(8);
    fill(255);
    rect(230, 320, 195, 60);
    textFont(orbit, 10);
...
class Play{
  ...
  String[] dictionary = {"POSITIVELY CHARGED PARTICLE IN AN ATOM", "NEGATIVELY CHARGED PARTICLE IN AN ATOM", 
      ...
      "A LIQUID OR GAS", "ATOM WITH AN UNBALANCED CHARGE CAUSED BY A CHANGE\n IN ELECTRONS", 
      "THE QUANTITY OF MATTER IN A BODY", "THE CENTRAL PART OF AN ATOM CONTAINING THE PROTONS \nAND NEUTRONS",
      "THE SUBSTANCES PRODUCED IN A CHEMICAL \nREACTION", "THE GRAVITATIONAL FORCE EXERTED ON A MASS",
      "A NEGATIVE ION", "A POSITIVE ION",
      "A CHEMICAL LINK BETWEEN ATOMS", "THE AMOUNT OF UNBALANCED ELECTRICITY \nIN A SYSTEM"};
