...
//Visualizing Perlin Noise	 by Nat Sarkissian, licensed under Creative Commons Attribution-Share Alike 3.0 and GNU GPL license.
//Work: http://openprocessing.org/visuals/?visualID=6707	
//License: 
...
void draw(){
  if(md){
    for(int f=0; f<800; f+=1){
      //for(int g=0; g<height; g+=height/11){
