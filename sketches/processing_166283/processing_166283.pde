...
void setup() {
  ...
  buttons[0] = loadImage("brush.png");
  buttons[1] = loadImage("pencil.png");
  buttons[2] = loadImage("eraser.png");
  buttons[3] = loadImage("filler.png");
  buttons[4] = loadImage("stamp.png");// This is just a white circle to use as an eraser
  background(255);
