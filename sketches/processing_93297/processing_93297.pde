...
// decalre a variable to contain whole numbers
int backsize;
// put a new int to make the worm shrink
int backgrowthrate;
// to control the speed of wormgrowthrate
int speed;
...
void setup() {
  ...
  //start the background rounds at 1
  backsize = 1; 
  //to change the speed, you only need to change this one
  speed = 1;
  //at the program start, the background begins growing
  backgrowthrate = speed;
}
...
void draw() {
  ...
  backsize = backsize + backgrowthrate;

  //background rounds
  fill(250, 223, 36);
  noStroke();  
  ellipse(400, 400, 750+backsize, 750+backsize);

  fill(255, 205, 18);
  noStroke();  
  ellipse(400, 400, 500+backsize, 500+backsize);

  fill(237, 169, 0);
  noStroke();  
  ellipse(400, 400, 350+backsize, 350+backsize);
