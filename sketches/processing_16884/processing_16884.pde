...
void setup()
{
  ...
  // Load the table 
  String lines[]=loadStrings("https://spreadsheets.google.com/pub?key=0AovDPxTmQGH7dDZ0aEJEY3QzUkVITXFacW42Y0dab3c&hl=en&output=txt");
...
void image_display(){
  ...
  String url = "https://dl.dropbox.com/u/2614917/CCA8/CCA_"+ scene_no_str +".jpg";
