...
/* @pjs preload="StJoFabre2011.jpg,StJoFabre2007.jpg,StJoFabre1937.jpg";*/
...
void setup() {
  size(768, 484);// pour le web, le setup doit ^çetre hard codé
  lengthPixels=768*484; //Résulution de l'image.
  //Initialisation du loading l'image.

  img[0] = loadImage("StJoFabre2011.jpg");
  img[1] = loadImage("StJoFabre2007.jpg");
  img[2] = loadImage("StJoFabre1937.jpg");
