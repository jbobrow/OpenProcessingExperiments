...
This is the way I say goodbye to Creative Coding course, and to the people participating in it. The image of the sketch is a picture of the ceiling of Gaudi’s ‘Parc Güell’ entrance in my city, Barcelona.

Along this course I have developed some kind of creatures, that I called Bubbles. They react to forces inspired in the physical world. They also are created with a random position, velocity, charge, size, and so on. What follows is amazingly unpredictable. They go around each other, get entangled, swallowed. They rebound and pass through another’s membrane to get trapped there until it suddenly hits the wall or another bubble frees it.

The forces are inspired in Nature. 

- There is a Strong force emanating from the centre of each bubble and as you get nearer the boundary, the force diminishes; ‘force zero’ being at the boundary. 

- There is a Chemical force which represents the electrical barrier of electrons in an atom, but needs to be reviewed. 
- An Electrical force with an adaptation of Coulomb’s formula; and gravity, affecting just the y axis of our screen.

There are also functions and methods that deal with collisions. 
In general it is assumed that the Bubbles are elastic for surface-tension, like a balloon, instead of body-tension, like liquids.  When bubbles collide, forces are calculated as the tangent of the engulfing bubble collides with the tangent of the engulfed one. So it is proportional to the sine of the first angle minus the second one.

This have a funny implication. When half of one bubble get inside another one, collision forces get inverted and itcan get trapped if it doesn’t have enough energy to escape.

It is possible to adjust the constants of the forces and properties of the bubbles such as the radius or the charge. Just take a look at the keyPressed function if you are interested.
