...
void draw(){
  ...
  if (a == 1){
    clock.fill(255);
    clock.ellipse(700/2,400/2,142,142);
    a = 0;}

  clock.smooth();

  clock.stroke(255,2);
  clock.strokeWeight(11);
  clock.fill(255,20);
  clock.ellipse(700/2,400/2,120,120);
...
//  secs = secs * sect;
 ...
 // hrs = hrs * hrst;
  ...
  clock.noFill();
  clock.ellipse(cos(radians((hrs/2)-180))*150,tan(radians((hrs/2)-180))*100,40,40);
