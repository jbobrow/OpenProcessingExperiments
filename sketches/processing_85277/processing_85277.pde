...
void draw() 
{
  ...
  for(int j = 0 ; j < 8 ; j ++) {
        ...
        dessinerTruc(i+3,(int)((mouseX-540/2)*cos((float)radcnt*(i+1)*(j+1)/1000)+20+i*60),(int)((mouseY-480/2)*cos((float)radcnt*(i+1)*(1+j)*5/1000+10)+20+j*60),angle,9+radius*j/19);
  }    
  }
