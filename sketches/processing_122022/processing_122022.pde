...
cameraArray[0] = new CameraPart( color(20,224,171), 242, 323, 50, 50, "The aperture setting affects depth of field.", xDef, yDef);

//Sets attributes for shutter speed 
cameraArray[1] = new CameraPart( color(20,224,171), 137, 325, 80, 50, "This controls shutter speed", xDef, yDef); 

//Sets attributes for menu
cameraArray[2] = new CameraPart( color(20,224,171), 74, 242, 50, 50, "Takes you to camera settings", xDef, yDef+100);

//Sets attributes for AV
cameraArray[3] = new CameraPart( color(20,224,171), 360, 277, 50, 50, "Allows you to pick aperture of photo. ", xDef+110, yDef+100);

//Sets attributes for Photo count
cameraArray[4] = new CameraPart( color(20,224,171), 247, 450, 55, 50, "Shows how many photos you are able to store", xDef+110, yDef);

//Sets attributes for Set button
cameraArray[5] = new CameraPart( color(20,224,171), 397, 405, 40, 40, "View on screen what is seen through lens", xDef+110,yDef+50);

//Sets attributes for Multiple shots
cameraArray[6] = new CameraPart( color(20,224,171), 356, 405, 30, 70, "Allows you to select continuous shooting ", xDef+60, yDef+150);
...
//Function to create the button allowing changes between challenge and teach
...
//the values of startTeaching and testingchallenge change to opposite
...
//Sets the camera as the background image.
...
//Puts the text at the top of the camera image.
text("Click circled areas of camera to learn..", xPos, yPos);


//For ever camera button in the array
...
//If the mouse is clicked go to the challenge me page.
...
//If not on the teach or challenge page, then display the menu.
...
//If the challenge page is selected go to that method.
if (startChallenge)
{
ChallengeMe();
...
xPos = xPTmp;
yPos = yPTmp; //^coordinates of position of camera button
xSize = xSTmp;
ySize = ySTmp; //^size of circle
name = nameTmp; //name of camera button 
xAns = xATmp;
yAns =yATmp; 
}
...
//Function to detect the mouse click & what camera button is being clicked.
