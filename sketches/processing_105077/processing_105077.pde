...
boolean falling, Shoot, backboard, windOn, unlock1, unlock2, reset, clear, lock1, lock2, lock3, cheats;
PShader blur;
void setup() {
  size (1000, 800 );
  xpos = width/5;
...
void draw() {
  ...
  if (xvel > 25&&cheats==false){
    xvel = 25;
  }
  if (yvel >25&&cheats==false){
    yvel = 25;
  }
  rect(0, 0, yvel*20, 5);
  rect(0, 10, xvel*20, 5);
