...
/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/60992*@* */
...
PFont font;
String letters = "The reader is introduced to the narrator who, as a young boy, drew a boa constrictor digesting an elephant. However, he is discouraged from drawing when all adults who look at his picture see a hat, instead. The narrator attempts to explain what his first picture depicts by drawing another one clearly showing the elephant, disturbing the adults as a result. As such, he decides to become a pilot, which eventually leads to a crash in the Sahara desert.";
int fontSizeMin = 3;
...
void setup() {
  ...
  font = createFont("mustache.ttf",10);
