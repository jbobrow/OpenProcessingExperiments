...
class Mover {
  ...
  Mover() {
    ...
    location2 = new PVector((width/2)-50,(height/2)-50);
  ...
  void update() {
   ...
   //object 2 to 1
    ...
    if(key == 'g' || key == 'G'){
      ...
      location1.x = width/2;
      location2.x = (width/2) - 50;
      location3.x = (width/2) - 100;
      location1.y = height/2;
      location2.y = (height/2) - 50;
  ...
  void checkEdges() {  
    ...
    //This lets you move the star and the two bodies. 
