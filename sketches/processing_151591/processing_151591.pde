 ...
 * over which it grows and changes colour and opacity. At the end of each lifetime the circle begins again.
 * Clicking the mouse changes the lifetime of all the circles globally.
 * 
 */
...
void movingCircle(float x, float y, float size, int offset) {
  ...
  strokeWeight(2);
  stroke(0, lerp(255, 0, circleAge));
  fill((x-size)/2,255-circleSize*2,(y-size)/3, lerp(120, 0, circleAge));
