...
/**void actualitzar(){ 
 ...
 float distanceX = mt.getRightXBoxRelative()-xPos; 
 float distanceY = mt.getUpperYBoxRelative()-yPos; 
...
void dibuixar(){ 
  ...
  PImage imatge;
  imatge= loadImage("caballos.jpg");
  scale(0.45);
  image (imatge, mt.getLeftXBoxRelative(), mt.getUpperYBoxRelative());
