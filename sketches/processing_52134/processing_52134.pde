...
//  Title: Moire Pattern - Ellipsoid
//  Description: Two symmetric ellipsoids rotating in opposite directions to create moire-like interference patterns.
...
void setup()
{
  ...
  size(400,400);
  //load the images
  img=loadImage("ellipsoid.png");
  img2=loadImage("ellipsoid.png");
