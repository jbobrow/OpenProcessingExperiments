...
void draw(){
  ...
  line(220, 400, 300, 600); //line for right leg
  line(220, 400, 150, 600); //line for left leg
  line(350, 600, 300, 600); //line for right foot
  line(100, 600, 150, 600); //line for left foot
  ellipse(205, 145, 10, 10); //circle for right eye
  ellipse(235, 145, 10, 10); //circle for left eye
  line(210, 170, 230, 170); //line for mouth
  }
