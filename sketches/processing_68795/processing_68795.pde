...
void draw() {
  drawOwl();
  float centerXLeft = constrain(mouseX,91,148); 
  float centerXRight = constrain (mouseX,351,413); 
  drawLeftEye(centerXLeft);
  drawRightEye(centerXRight);
  println(centerXRight);
}

void drawRightEye(float centerX){
  strokeWeight(5);
  fill(0, 0, 0);
  ellipse(centerX, 180, 85, 85);
  noStroke();
  fill(206, 204, 200);
  ellipse(centerX, 180, 40, 40);
  fill(0, 0, 0);
  ellipse(centerX, 180, 25, 25);
  fill(255, 255, 255);
  ellipse(centerX, 180, 20, 20);
}

void drawLeftEye(float centerX){
strokeWeight(5);
fill(0, 0, 0);
ellipse(centerX, 180, 85, 85);
noStroke();
...
//Blue triangles
noStroke();
fill(map(mouseY, 0, height,0, 71), map(mouseY, 0, height, 0, 163), map(mouseY, 0, height, 0, 180));
