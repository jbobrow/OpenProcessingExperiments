...
final int SWITCH_CENTER_X = 500;
final int SWITCH_CENTER_Y = 500;

// seconds until light shuts off automatically when there is no motion
final float SECONDS_UNTIL_AUTO_SHUTOFF = 10.0; 
...
void drawLamp() {
  drawLight();
  fill(0, 255, 0, 50);
  triangle(350, 250, 150, 250, 250,0);
  fill(175, 127, 67);
  rect(240, 250, 20, 250);
}
