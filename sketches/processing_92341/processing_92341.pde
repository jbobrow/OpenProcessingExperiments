...
float oscOffset = 0.1; // radians
        float oscCounter = 0.05 * frameCount;
...
noStroke(); 
fill(#84ADAC);
        ellipse(value,height*0.365,30,30);
        fill(0);
        ellipse(value,height*0.365,20,20);
        fill(255);
        ...
        float calue = cos( 0.05 * frameCount + 0.1 ) * 20 +100;
noStroke(); 
fill(#84ADAC);
        ellipse(calue,height*0.365,25,25);
        fill(0);
        ellipse(calue,height*0.365,15,15);
        fill(255);
