...
//Gentry Demchak, Aiming Device, Code, Assignment 2, Anthony Marefat

//Ease function barrowed from processing.js
//Ease function can be found here: http://processingjs.org/learning/basic/easing/
float x;
float y;
float a = 0.1;
...
void draw() {
  ...
  //ease function barrowed from http://processingjs.org/learning/basic/easing/ 
...
//Crosshairs
  ...
  //changes the crosshair color when it is within the area of the asteroid.
