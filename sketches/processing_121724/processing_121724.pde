...
boolean souris_bouge_balle = false;  // true si la souris est sur la balle et le bouton est press̩
...
void balle_move() {
  ...
  // v̩rifions si la souris est sur la  balle
