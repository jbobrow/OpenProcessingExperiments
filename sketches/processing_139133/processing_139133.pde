...
void keyPressed()
{
    ...
    if (keyCode == UP)
    {
      ...
      myTank.sprite.setAnimation(10, 12, true);
    }
    if (keyCode == DOWN)
    {
      ...
      // start tank animation from fram 0->7
      myTank.sprite.setAnimation(0, 3, true);
    }
    ...
    if (keyCode == LEFT)
    {
      ...
      myTank.sprite.setAnimation(4,6,true);
    }
    ...
    if (keyCode == RIGHT)
    {
      ...
      myTank.sprite.setAnimation(7,9,true);
}
}
...
class Tank
{
  ...
  Tank()
  {
    ...
    this.sprite = new AnimatedSprite("dragonx.png", 96, 96);
  }
