...
void setup() {
  ...
  buttons[7] = loadImage("08.png");
   buttons[10] = loadImage("09.png");
   buttons[11] = loadImage("10.png");
   buttons[12] = loadImage("11.png");
   buttons[13] = loadImage("12.png");  
...
void draw() {
  ...
  fill(180);
  rect(0, 0, 200, height);
  image(buttons[0], 15, 50, 72, 72);
  image(buttons[1], 10, 150, 72, 50);
  image(buttons[2], 10, 230, 72, 60); 
  image(buttons[3], 15, 330, 72, 50); 

  image(buttons[10], 15, 450,72,100);
  image(buttons[12], 30, 560,45,85); 
  image(buttons[4], 115, 50, 72, 60); 
  image(buttons[5], 115, 145, 72, 65); 
  image(buttons[6], 110, 235, 72, 50); 
  image(buttons[7], 120, 320, 72, 72); 

  image(buttons[11], 105, 480,80,60);   
  image(buttons[13], 110, 560,50,90);


  image(buttons[8], 25, 680, 72, 72);


  textSize(20) ;
  textFont(font, 18);
  fill(50);
  text("Food Brush", 15, 25);
  text("Drink brush", 15, 430);        
  text("Eraser", 15, 670);   
  fill(20);
  text("201012826 Lee Kwangho", 15, 780);

  //Draw outline around selected button:
  noFill();
  stroke(120);
  if (selButton == 0) rect(15, 50, 72, 72);
  else if (selButton == 1) rect(10, 150, 72, 50);
  else if (selButton == 2) rect(10, 230, 72, 60);
   else if (selButton == 3) rect(15, 330, 72, 50);
    else if (selButton == 4) rect(115, 50, 72, 60);
     else if (selButton == 5) rect(115, 145, 72, 65);
      else if (selButton == 6) rect(110, 235, 72, 50);
       else if (selButton == 7) rect(120, 320, 72, 72);
        else if (selButton == 8) rect(25, 680, 72, 72);
             else if (selButton == 10) rect(15, 450,72,100);
         else if (selButton == 11) rect(105, 480,80,60);
         else if (selButton == 12) rect(30, 560,45,85);
         else if (selButton == 13) rect(110, 560,50,90);
