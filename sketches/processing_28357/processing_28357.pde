...
void draw()
{
  ...
  switch(bcMode){
    ...
    break;
    case 5:
    background(127,215,0);
    break;
    case 6:
    background(0,127,215);
    break;
    case 7:
    background(0);
    stroke(215);
  ...
  switch(fcMode){
    case 0:
    fill(255,255,255,aValue);
    break;
    case 1:
    fill(127,127,127,aValue);
    break;
    case 2:
    fill(255,0,0,aValue);
    break;
    case 3:
    fill(255,127,0,aValue);
    break;
    case 4:
    fill(255,215,0,aValue);
    break;
    case 5:
    fill(127,215,0,aValue);
    break;
    case 6:
    fill(0,127,215,aValue);
    break;
    case 7:
    fill(0,0,0,aValue);
    stroke(215);
...
//  rect(0,0,wWidth,wHight);
  ...
  switch(sceanMode){
    case 0:
    drawStudyBody(int(frame_num*10),wWidth/2,0,wHight/2);
    drawMoveBody(frame_num,bodySize*80,0,wHight/2-3*bodySize);
    break;
    case 1:
    drawMoveBody(frame_num,wWidth/2,0,wHight/2-3*bodySize);
    drawWalkBody(int(frame_num*15),bodySize*80,0,wHight/2-3*bodySize);
    break;
    case 2:
    drawWalkBody(int(frame_num*15),wWidth/2,0,wHight/2-3*bodySize);
    drawStudyBody(int(frame_num*10),bodySize*80,0,wHight/2);
    break;
  }
  ...
  switch(sceanMode){
    case 0:
    drawWalkBody(int(frame_num*15),wWidth/2-20*bodySize,0,wHight/2-3*bodySize);
    break;
    case 1:
    drawStudyBody(int(frame_num*10),wWidth/2-20*bodySize,0,wHight/2);
    break;
    case 2:
    drawMoveBody(frame_num,wWidth/2-20*bodySize,0,wHight/2-3*bodySize);
    break;
  }
...
float cabinetX(float x,float y,float z)
{
  ...
  switch(viewMode){
    case 0://Cabinet
      ...
      break;
      case 1://Isometric
      newX = 1.7320508*(x-y)/2+ width/15;
      break;
      case 2://Perspective
      newX = (x-wWidth/2) * pow(1.002,y-20) + wWidth/2;
      break;
  }
  if(secretMode == 1){
    newX = (newX-width/2)*2+width/2;
  }
  return newX;
}
...
float cabinetY(float x,float y,float z)
{
  ...
  switch(viewMode){
    ...
    break;
    case 1://Isometric
    newY = (x+y)/2 + z - height/2;
    break;
    case 2://Perspective
    newY = (z-wHight/2) * pow(1.002,y-20) + wHight/2;
    break;
  }
  return newY;
}
