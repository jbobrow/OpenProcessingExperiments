...
final int TRIGGER_DISTANCE = 100;

// The location of the sensor:
final int SWITCH_CENTER_X = 400;
...
void drawLightSwitch() {
  fill(255, 255, 0);
  rect(SWITCH_CENTER_X - 350, SWITCH_CENTER_Y - 15, 30, 60);
  fill(255);
  ellipse(SWITCH_CENTER_X - 335, SWITCH_CENTER_Y, 5, 5);
}
...
textSize(12);
fill(255);
text("Modified by Lizzy Steiger", 10, 50);
}
