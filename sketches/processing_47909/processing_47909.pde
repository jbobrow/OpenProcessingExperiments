  ...
  **/
  ...
  if(key != CODED)
    switch(key) {
      ...
      case('c'):direction |=DOWNWARD; last_direction = DOWNWARD; break;
          case 'j':
           g1.allPaths ^= 1;
           g1.pointToPointOn = 0;
           break;
...
public void update_heading() {
  ...
  **/
  int boxnum = g1.nodes.size();
  for(int i = boxnum-1; i > -1;i--) {
    Node box = (Node)g1.nodes.get(i);
    update_v(box.position);
  }  
...
public void mouseClicked() {
  ...
  **/
  ...
  public void rotate_to_top(Node nd) {
      peasy.org.apache.commons.math.geometry.PVector snd = new peasy.org.apache.commons.math.geometry.PVector(nd.position.x,nd.position.y,nd.position.z);
      peasy.org.apache.commons.math.geometry.PVector on_v = new peasy.org.apache.commons.math.geometry.PVector(0,-1,0);
      snd = snd.normalize();
