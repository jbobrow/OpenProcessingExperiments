...
void setup () {
  ...
  smooth ();
  frameRate (60);
  c = color (random (150, 255), random (0,150), random (180, 255));
}
  
void draw () {
  background (84, 92, 155);
  hedgehog (mouseX, mouseY, mouseX-10, mouseX-10);
}
...
void hedgehog (float x, float y, float wd, float ht) {
  noStroke ();
  fill (c);
  beginShape ();
