...
switch(myState) {
  ...
  rect(0, 520, 300, 80, 3);
  fill(0);
  text("TV Shows Watched", 20, 570);
  
  fill(0, 0, 255);
  rect(300, 520, 300, 80, 3);
  fill(255);
  text("Energy Drinks", 340, 570);
  
  fill(0, 255, 61);
  rect(600, 520, 300, 80, 3);
  fill(0);
  text("Writing/Typing", 650, 570);
...
textSize(13);
fill(0, 0, 255);
text("Angel Beats!", 220, 360);

textSize(74);
fill(255, 0, 0);
text("Monster", 400, 420);


textSize(51);
fill(0, 0, 255);
text("Full Metal Alchemist", 200, 250);
...
textSize(25);
fill(0, 0, 255);
text("Attack on Titan", 15, 550);

textSize(25);
fill(255, 0, 0);
text("Blue Exorcist", 30, 30);
