...
PImage inici, credits, opcions, historia ,seleccio, n1,n2,n3,n4,n5,
...
void setup(){
 ...
 // player = minim.loadFile("cancionpirata.mp3");
  ...
  n1= loadImage("Nivell1.png");
  n2= loadImage("Nivell2.png");
  n3= loadImage("Nivell3.png");
  n4= loadImage("Nivell4.png");
  n5= loadImage("Nivell5.png");
...
void draw(){   
  ...
  if (nombrePantalla == 1) iniciJS(); 
  if (nombrePantalla == 4) historiaJS(); 
  if (nombrePantalla == 5) seleccioJS();
  if (nombrePantalla == 40) creditsJS();
  ...
  if (nombrePantalla == 200) ajudaJS();
  if (nombrePantalla == 202) guanyatJS(); 
  if (nombrePantalla == 310) perdutJS();
  if (nombrePantalla == 500) formulaJS();
 
  //condició booleana que activa la funció de la pantalla de "has perdut" quan s'acaben els intents.
  if (findejuego==true){
    perdutJS();
  }
...
void comprovarnivel1(){
  ...
  if (numX * numY == parseInt(resultat)){
    aciertopulpo = true;
    //sonidoAcierto();

  }else if (numX * numY > parseInt(resultat)&& k>0){
     k--;
     falloarriba=true;
...
void comprovarnivel2(){
 int resultattriangle2 = numX*numY/2;
  ...
  if (resultattriangle2 == parseInt(resultat)){
    aciertopulpo = true;
    //sonidoAcierto();
    
   }else if (resultattriangle2 > parseInt(resultat) && k>0){
     k--;
     falloarriba=true;
     muestravidamenos=true; 
     //sonidoFallo();
...
void comprovarnivel3(){
  ...
  if (resultattriangle3 == parseInt(resultat)){
    aciertopulpo = true;
   // sonidoAcierto();

  }else if (resultattriangle3 > parseInt(resultat)&&k>0){
     k--;
     falloarriba=true;
     muestravidamenos=true; 
     //sonidoFallo();
...
void comprovarnivel4(){
  ...
  if (resultatpentagon == parseInt(resultat)){
    aciertopulpo = true;
   // sonidoAcierto();

  }else if (resultatpentagon > parseInt(resultat)&&k>0){
     k--;
     falloarriba=true;
     muestravidamenos=true;
    // sonidoFallo();
...
void comprovarnivel5 (){
  ...
  if (resultatgen==parseInt(resultat)){
     aciertopulpo=true;
    // sonidoAcierto();
    }else if (resultatgen < parseInt(resultat)&&k>0){
      k--;
      falloabajo=true;
      muestravidamenos=true;
     // sonidoFallo();
