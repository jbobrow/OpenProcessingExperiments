...
final int TRIGGER_DISTANCE = 200;
...
void drawLamp() {
  drawLight();
  fill(0, 255, 0, 50);
  quad(200, 50, 300, 50, 450, 250, 50, 250);
  fill(175, 127, 67);
  rect(240, 250, 20, 250);
}
...
void drawLightSwitch() {
  fill(0, 0, 255);
  rect(50, SWITCH_CENTER_Y - 25, 30, 60);
  fill(255);
  ellipse(65, SWITCH_CENTER_Y, 5, 5);
}
...
void drawTriggerRegion() {
  if (revealTriggerRegion) {
   ...
   textSize(20);
 text("Modified by James Buzzell", 20, 20);
