...
//click mouse,and let the cat laugh...
//i have a cat.when i key in processing,he want do that,too.
//sssso,i play with hime until he laughing enough.
//and then i could continue my homework...

//green curve...my hand or Funny cat stick.
//press mouse...cat's mouth laughing...
...
void draw() {
  ...
  if (mousePressed) {
    ...
    stroke(197, 62, 6);
    ellipse(mouseX, mouseY, 80+0.1*mouseX, 80+0.1*mouseY);
    //object curve 34
    fill(30, 63, 10);
    stroke(30, 63, 10);
    curveTightness(-0.5); 
    ...
    curveTightness(-0.5); 
    beginShape();
    curveVertex(270+random(0, 10), 308+random(0, 10));
    curveVertex(270+random(0, 10), 308+random(0, 10));
    curveVertex(211+random(0, 10), 298+random(0, 10));
    curveVertex(161+random(0, 10), 265+random(0, 10));
    curveVertex(145+random(0, 10), 231+random(0, 10));
    curveVertex(137+random(0, 10), 195+random(0, 10));
    curveVertex(135+random(0, 10), 169+random(0, 10));
    curveVertex(141+random(0, 10), 143+random(0, 10));
    curveVertex(154+random(0, 10), 121+random(0, 10));
    curveVertex(173+random(0, 10), 102+random(0, 10));
    curveVertex(208+random(0, 10), 76+random(0, 10));
    curveVertex(245+random(0, 10), 53+random(0, 10));
    curveVertex(299+random(0, 10), 26+random(0, 10));
    curveVertex(356+random(0, 10), 9+random(0, 10));
    curveVertex(356+random(0, 10), 9+random(0, 10));
    endShape();
    //object curve 35
    fill(236, 235, 230);
