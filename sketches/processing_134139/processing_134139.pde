...
void draw() {
  ...
  triangle1((int)random(0, width-50), (int)random(0, height - 50));
  triangle2((int)random(0, width-50), (int)random(0, height - 50));
  triangle3((int)random(0, width-50), (int)random(0, height - 50));
  triangle4((int)random(0, width-50), (int)random(0, height - 50));
}
