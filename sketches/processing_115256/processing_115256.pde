...
void setup() {
  ...
  AA = new Slider("1ºvariable'A'", 0, -4, 4, x, y+30, 300, 20, HORIZONTAL);
  AB = new Slider("1ºvariable'B'", 4, -4, 4, x, y+50, 300, 20, HORIZONTAL);

    sndFuntion= new RadioButtons(5,  x, y+90, 50, 20, HORIZONTAL);
    
  BA = new Slider("2ºvariable'A'", 1, -4, 4, x, y+120, 300, 20, HORIZONTAL);
  BB = new Slider("2ºvariable'B'", 1, -4, 4, x, y+140, 300, 20, HORIZONTAL);
...
class Grafic {
 ...
 color B = color(#0017FF,128);
  ...
  void coordPolar(float A1, float B1, float A2, float B2,boolean trigA,boolean trigB) {
    ...
    fill(0,255,255);
    text("90º",center.x, center.y-(WW)*0.9);
    text("180º",center.x-WW*0.9, center.y);
    text("270º", center.x, center.y+WW*0.9);
    text("0º", center.x+WW*0.9, center.y);
  ...
  void planoCarte(float A1, float B1, float A2, float B2,boolean trigA,boolean trigB) {
    ...
    text("90º",(center2.x-(WW2))+margen, center2.y);
    text("180º",(center2.x-(WW2))+margen*2, center2.y);
    text("270º",(center2.x-(WW2))+margen*3, center2.y);
