...
void setup() {
  ...
  gobivbody = loadShape ("GobiVectorBody.svg");
  gobivsoilcover = loadShape ("GobiVectorSoilCover.svg");
  gobivmouth = loadShape ("GobiVectorMouth.svg");
  gobivleftleaf = loadShape ("GobiVectorLeftLeaf.svg");
  gobivrightleaf = loadShape ("GobiVectorRightLeaf.svg");
  gobiveye = loadShape ("GobiVectorEye.svg");
  gobivleftarm = loadShape("GobiVectorLeftArm.svg");
  gobivrightarm = loadShape("GobiVectorRightArm.svg");
  ...
  gobipbackground = loadImage ("BackgroundImage.png");
...
if (SKINS == 1) {
  ...
  pushMatrix();
    ...
    shape (gobivrightleaf,-250,-120);
  popMatrix();
  shape (gobivsoilcover,0,-15);
  shape (gobivmouth,0,-15);
  //buttons
  stroke(0);
  ...
  shape (gobivleftarm,0,0);
  shape (gobivrightarm,0,0);
...
//IMAGE GOBI
  ...
  pushMatrix();
    ...
    image (gobipleftleaf,-145,-100,310,230);
  popMatrix();
  pushMatrix();
    translate(251,99);
    tx2 += PI/(20+(abs(12-h)*8));
    ...
    image (gobiprightleaf,-160,-100,310,230);
  popMatrix();
