...
class Walker {
  ...
  int ranpointx1 = random(0,width-10);
  int ranpointy1 = random(0,height-10);
  
  int ranpointx2 = random(0,width-10);
  int ranpointy2 = random(0,height-10);
