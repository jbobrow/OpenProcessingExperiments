...
//colour names
  ...
  //character
  fill(face);
  ellipse(300,350,130,135);   
  fill(feet);
  ellipse(275,415,38,25);//left foot
  ellipse(325,415,38,25);//right foot
  fill(hands);
  if (keyPressed == true) {
    ellipse(230,340,33,25);
  } else {
  ellipse(238,353,22,33);//left hand
  }
  ellipse(365,353,22,33);//right hand
  if (keyPressed == true) {
  ...
  fill(0);
  arc(300,375,25,35,0,PI);//mouth
  strokeWeight(2);
  if (keyPressed == true) {
    ellipse(283,335,9,13);//left eye
    ellipse(315,335,9,13);//right eye
  } else {
  line(275,340,290,335);//left-bottomw
  line(290,335,275,330);//left-top
  line(308,335,323,340);//right-bottom
  line(308,335,323,330);//right-top
  }
