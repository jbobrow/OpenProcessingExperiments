...
float delay2 = 10/1f;
float circle = 200; //sets circle variable which is used as the width and height to form a circle 
...
if (score == 20) { //checks if the score is 20
  noLoop();
  textSize(100);
  text("End Of Game",200, 200); //when score is 20, end of game will print
