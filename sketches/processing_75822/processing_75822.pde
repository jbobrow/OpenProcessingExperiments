...
void mouseClicked() { 
  ...
  if ((262 < mouseX)&&(mouseX<366)&&(75<mouseY)&&(mouseY<353) && (showerMessage==false)&&(laundryMessage==false)&&(peeMessage==false)&&(pizzaMessage==false)&&(outsideMessage==false)&&(eatMessage==false)) {
    optionScreen = true;
  }
