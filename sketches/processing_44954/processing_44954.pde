...
class CollageItem {
  ...
  void update() {
    ...
    aniRotation = Ani.to(this, random(5,20), "rotation", newRotation, Ani.QUAD_IN_OUT, "onEnd:update");
    aniScaling = Ani.to(this, random(1,4), "scaling", newScaling, Ani.SINE_IN_OUT);
  } 
