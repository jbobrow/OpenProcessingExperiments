...
Slash[] slash;
int nb=20;
color[] colors = {color(0), color(255, 169, 77), color(115, 115, 115)};
...
class Slash {
    float x1, x2, y1, y2, tarX1, tarX2, tarY1, tarY2, easing = random(0.01,0.09);
    int timer, tMax, taille= random(20,60) delta=random (40,111);
    boolean vertical;
    color c;
