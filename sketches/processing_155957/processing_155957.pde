...
void setup(){
  ...
  sizeSlider = new GSlider("Circle Size",30,800,150,10,0,500,100,col1,false,false,"");
  distSlider = new GSlider("Eccentricity",30,850,150,10,0,500,150,col1,false,false,"");
  
  color col2 = color(189,179,115);
  periodSlider = new GSlider("Frequency",210,800,150,10,0,10,2,col2,true,false,"Hertz");
  nCircSlider = new GSlider("Number of Circles",210,850,150,10,0,20,6,col2,true,true,"");
    
  color col3 = color(115,189,181);
  graySlider = new GSlider("Circle Value 1",390,800,150,10,0,255,128,col3,true,true,"");
  gray2Slider = new GSlider("Circle Value 2",390,850,150,10,0,255,128,col3,true,true,"");
