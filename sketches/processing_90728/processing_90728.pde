...
void setup() 
{
  size(800, 800);      //Set the windowsize
...
class Ball {
  ...
  float vx = random(-3, 3);              //Starting speed in x direction is randomly chosen
  float vy = random(-3, 3);              //Starting speed in y direction is randomly chosen
