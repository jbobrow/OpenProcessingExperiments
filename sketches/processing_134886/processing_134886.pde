...
//bottom right orange lines
boolean orangeBottomMove=false;
//bottom left yellow lines
boolean yellowLeftBottomMove=false;
//bottom right yellow lines
...
line(435, 540, 800, 540);
line(450, 551, 800, 550);
line(447, 560, 800, 560);
line(443, 570, 800, 568);
line(453, 583, 800, 582);
line(448, 590, 800, 590);
line(451, 599, 800, 600);
line(438, 610, 800, 610);
line(453, 620, 800, 622);
...
//If mouse is on top left yellow rect, yellowTopLeftMove is true
  if (mouseX>160 && mouseX<255 && mouseY>150 && mouseY<230) {
