...
void setup()
{
  ...
  // Load the table 
  String lines[]=loadStrings("https://spreadsheets.google.com/pub?key=0AovDPxTmQGH7dEs1Y1VtTFpSZjk4ZEFrR1ozSHRRc3c&hl=en&output=txt");
...
void image_display(){
  ...
  String url = "https://dl.dropbox.com/u/2614917/CCA13/CCA_"+ scene_no_str +".jpg";
