...
//  Color Variables
int colorL=100,strokeL, strokeValue = 20, strokeBackground = 5;
...
void draw()  {
  ...
  if (mousePressed == true)  { 
    ...
    line0.render(200,50,0, lineAlpha);
    line1.calcPoints(mouseX, mouseY);
    line1.render(255,100,0, lineAlpha);
    line2.calcPoints(mouseX, mouseY);
    line2.render(120,80,138, lineAlpha);
  } else {
      line0.calcPoints(mouseX, mouseY);
    line0.render(30,0,0, 0);
    line1.calcPoints(mouseX, mouseY);
    line1.render(200,140,0, 0);
    line2.calcPoints(mouseX, mouseY);
    line2.render(200,200,200, 0);
