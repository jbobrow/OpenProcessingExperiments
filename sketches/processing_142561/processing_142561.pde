...
{  
    ...
    depthgen = new MidpointDisplacementMapGenerator(513, 1.5);
    humigen = new MidpointDisplacementMapGenerator(513, 1.9);
    ...
    for(int x = 0; x < 513; x++)
    {
        for(int y = 0; y < 513; y++)
        {
            ...
            stroke(Math.floor(y/2));
            line(sideOffset + x, 513, sideOffset + x, 190-height);
    ...
    stroke(0,0,255);
    fill(0,0,255, 100);
    rect(513, waterlevel, 513, waterlevel);
