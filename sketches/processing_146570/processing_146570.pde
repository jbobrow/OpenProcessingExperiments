...
int x_x = 450, x_y = 450, y_x = 50, y_y = 450,
    z_x = 250, z_y = 50, u_x = 250, u_y = 250, x_x2 = 450, x_y2 = 450, y_x2 = 50, y_y2 = 450,
    z_x2 = 250, z_y2 = 50, u_x2 = 250, u_y2 = 250;
...
void draw() {
  ...
  if(!(x_x2 == x_x &&  x_y2 == x_y &&  y_x2 == y_x &&  y_y2 == y_y && 
  z_x2 == z_x &&  z_y2 == z_y &&  u_x2 == u_x &&  u_y2 == u_y && prvi == 1)){       
  for (int i = 0; i <= 500; i++){
  for (int j = 0; j <= 500; j++){
  x_x2 = x_x; x_y2 = x_y; y_x2 = y_x; y_y2 = y_y;
  z_x2 = z_x; z_y2 = z_y; u_x2 = u_x; u_y2 = u_y;
  u_x = i;
  u_y = j;
