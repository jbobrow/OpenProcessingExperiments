...
void setup() {
  ...
  buttons[0] = loadImage("Icon_Button1.png");
  buttons[1] = loadImage("Icon_Button5.png");
  buttons[2] = loadImage("Icon_Button7.png"); 
  buttons[3] = loadImage("Icon_Button3.png");
  buttons[4] = loadImage("Icon_Button2.png");
  buttons[5] = loadImage("Icon_Button4.png");
  buttons[6] = loadImage("Icon_Button6.png"); 
  buttons[7] = loadImage("Icon_Button8.png"); 
...
// fill(180);
 // rect(200, 0, 600, height);
  ...
  else if (selButton == 3) rect(20, 380, 88, 80);
