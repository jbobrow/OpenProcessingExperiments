...
kafli = loadStrings("LaurStrengir1.txt");
...
//int ill12 = Integer.parseInt(gildi12[0]);
 ...
 fill(255);
textFont(font1);
text("Violin I", dia, 82, 140);
text("Violin II", dia, 265, 140);
text("Viola", dia, 458, 140);
...
//vinstri
 ...
 pushMatrix(); 
   translate(0, 4);
   kc1.draw(2, 0, 40, 38, 39, 0, 41, 42, 43, 44, 0, 0, 47, 410, 440, gerdur1, notur1, almennur1, langur1);
   translate(kb1.l, 0);
   kc2.draw(180, 0, 40, 38, 39, 0, 41, 42, 43, 44, 0, 0, 47, 410, 440, gerdur2,  notur2, almennur2, langur2);
   translate(kb2.l, 0);
   kc3.draw(150, 0, 40, 38, 39, 0, 41, 42, 43, 44, 0, 0, 47, 410, 440, gerdur3,  notur3, almennur3, langur3);
   translate(kb3.l, 0);
   kc4.draw(120, 0, 40, 38, 39, 0, 41, 42, 43, 44, 0, 0, 47, 410, 440, gerdur4,   notur4, almennur4, langur4);
   translate(kb4.l, 0);
   kc5.draw(90, 0, 40, 38, 39, 0, 41, 42, 43, 44, 0, 0, 47, 410, 440, gerdur5, notur5, almennur5, langur5);
   translate(kb5.l, 0);
   kc6.draw(50, 0, 40, 38, 39, 0, 41, 42, 43, 44, 0, 0, 47, 410, 440, gerdur6,  notur6, almennur6, langur6);
    translate(kb6.l, 0);
   kc7.draw(50, 0, 40, 38, 39, 0, 41, 42, 43, 44, 0, 0, 47, 410, 440, gerdur7,  notur7, almennur7, langur7);
    translate(kb7.l, 0);
   kc8.draw(50, 0, 40, 38, 39, 0, 41, 42, 43, 44, 0, 0, 47, 410, 440, gerdur8,  notur8, almennur8, langur8);
   popMatrix();
...
// Fiðla 2
   ...
   pushMatrix(); 
   translate(0, 188);
   kb1.draw(2, 0, 37, 0, 0, 36, 0, 32, 0, 34, 0, 0, 0, 360, 340, gerdur1, notur1, almennur1, langur1);
   translate(kb1.l, 0);
   kb2.draw(180,  0, 37, 0, 0, 36, 0, 32, 0, 34, 0, 0, 0, 360, 340, gerdur2,  notur2, almennur2, langur2);
   translate(kb2.l, 0);
   kb3.draw(150,  0, 37, 0, 0, 36, 0, 32, 0, 34, 0, 0, 0, 360, 340, gerdur3,   notur3, almennur3, langur3);
   translate(kb3.l, 0);
   kb4.draw(120,  0, 37, 0, 0, 36, 0, 32, 0, 34, 0, 0, 0, 360, 340, gerdur4,   notur4, almennur4, langur4);
   translate(kb4.l, 0);
   kb5.draw(90,  0, 37, 0, 0, 36, 0, 32, 0, 34, 0, 0, 0, 360, 340, gerdur5,   notur5, almennur5, langur5);
   translate(kb5.l, 0);
   kb6.draw(50,  0, 37, 0, 0, 36, 0, 32, 0, 34, 0, 0, 0, 360, 340, gerdur6,   notur6, almennur6, langur6);
   translate(kb6.l, 0);
   kb7.draw(50,  0, 37, 0, 0, 36, 0, 32, 0, 34, 0, 0, 0, 360, 340, gerdur7,  notur7, almennur7, langur7);
    translate(kb7.l, 0);
   kb8.draw(50,  0, 37, 0, 0, 36, 0, 32, 0, 34, 0, 0, 0, 360, 340, gerdur8,  notur8, almennur8, langur8);
   popMatrix();
...
// Víóla
   ...
   pushMatrix(); 
   translate(0, 381);
   kd1.draw(2, 24, 26, 25, 0, 0, 0, 30, 0, 0, 31, 29, 0, 290, 300, gerdur1, notur1, almennur1, langur1);
   translate(kd1.l, 0);
   kd2.draw(180, 24, 26, 25, 0, 0, 0, 30, 0, 0, 31, 29, 0, 290, 300, gerdur2,  notur2, almennur2, langur2);
   translate(kd2.l, 0);
   kd3.draw(150, 24, 26, 25, 0, 0, 0, 30, 0, 0, 31, 29, 0, 290, 300, gerdur3,  notur3, almennur3, langur3);
   translate(kd3.l, 0);
   kd4.draw(120, 24, 26, 25, 0, 0, 0, 30, 0, 0, 31, 29, 0, 290, 300, gerdur4,  notur4, almennur4, langur4);
   translate(kd4.l, 0);
   kd5.draw(90, 24, 26, 25, 0, 0, 0, 30, 0, 0, 31, 29, 0, 290, 300, gerdur5,  notur5, almennur5, langur5);
   translate(kd5.l, 0);
   kd6.draw(50, 24, 26, 25, 0, 0, 0, 30, 0, 0, 31, 29, 0, 290, 300, gerdur6,  notur6, almennur6, langur6);
   translate(kd6.l, 0);
   kd7.draw(50, 24, 26, 25, 0, 0, 0, 30, 0, 0, 31, 29, 0, 290, 300, gerdur7,  notur7, almennur7, langur7);
   translate(kd7.l, 0);
   kd8.draw(50, 24, 26, 25, 0, 0, 0, 30, 0, 0, 31, 29, 0, 290, 300, gerdur8,  notur8, almennur8, langur8);
   popMatrix(); 
