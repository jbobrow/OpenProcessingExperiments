...
float bgR = random(0, 255); //sets background colour to a random red
float bgG = random(0, 255); //sets background colour to a random green
float bgB = random(0, 255); //sets background colour to a random blue
...
void draw() { //set up what will be drawn
  background(bgR,bgG,bgB); //set background colour to random colour
