...
backgroundSpotOneicon = loadImage("bacgroundSpotOne_icon.png");
backgroundSpotTwoicon = loadImage("backgroundSpotTwo_icon.png");
backgroundSpotThreeicon = loadImage("backgroundSpotThree_icon.png");
...
Y = loadImage("Y.png");
 ...
 // layer = loadImage("Layer.png");
  ...
  mapScreen1 = loadImage("mapScreen2_spotOne.png");
  mapScreen2 = loadImage("mapScreen2_spotTwo.png");
  mapScreen3 = loadImage("mapScreen2_spotThree.png");
