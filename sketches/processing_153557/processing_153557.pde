...
sound1 = new Audio("http://thetoastisburning.site50.net/sounds/notes/note-1.wav");

sound2 = new Audio("http://thetoastisburning.site50.net/sounds/notes/note-2.wav");

sound3 = new Audio("http://thetoastisburning.site50.net/sounds/notes/note-3.wav");

sound4 = new Audio("http://thetoastisburning.site50.net/sounds/notes/note-4.wav");

sound5 = new Audio("http://thetoastisburning.site50.net/sounds/notes/note-5.wav");

sound6 = new Audio("http://thetoastisburning.site50.net/sounds/notes/note-6.wav");

sound7 = new Audio("http://thetoastisburning.site50.net/sounds/notes/note-7.wav");
...
class Cord {     
    ...
    void doIndex(int doIndexI){
            ...
            if ((indexPos < sizeVectors)) {ellipse(Vectors.get(indexPos).x, Vectors.get(indexPos).y,5,5);indexPos = indexPos +1;} else {indexPos = 0;}
            if((indexPos == sizeVectors) ){indexPos = 0;}
...
color areaColor = color (100,100,100);
color cordColor = color (256,256,222);
...
color cordMenuColor = color (255,255,0);
color cloudMenuColor = color (256,256,256);
color hairColor = color (0,0,0,10);
color cloudColor = color (200,200,0,25);

color aColor = color (256,0,0,33);
color bColor = color (256,150,0,33);
color cColor = color (256,256,0,33);
color dColor = color (0,256,0,33);
color eColor = color (160,90,255,33);
color fColor = color (0,0,256,33);
color gColor = color (222,100,92,33);
...
void mousePressed(){
       ...
       if (mouseObject.isOverMenuItem){
           mouseObject.action = menu.get(mouseObject.overItem).mouseJobCode;
             ...
             if (isInArea(mouseX, mouseY)){
                  Cloud newCloud = new Cloud(mouseX, mouseY, 20, 2, bColor);
                  newCloud.position.set(mouseX,mouseY);
                  clouds.add(newCloud);
             }
             ...
             if (isInArea(mouseX, mouseY)){
                  Cloud newCloud = new Cloud(mouseX, mouseY, 20, 3, cColor);
                  newCloud.position.set(mouseX,mouseY);
                  clouds.add(newCloud);
             }
             ...
             if (isInArea(mouseX, mouseY)){
                  Cloud newCloud = new Cloud(mouseX, mouseY, 20, 4, dColor);
                  newCloud.position.set(mouseX,mouseY);
                  clouds.add(newCloud);
             }
             ...
             if (isInArea(mouseX, mouseY)){
                  Cloud newCloud = new Cloud(mouseX, mouseY, 20, 5, eColor);
                  newCloud.position.set(mouseX,mouseY);
                  clouds.add(newCloud);
             }
       } else if (mouseObject.action == 6) {
            if (isInArea(mouseX, mouseY)){
                  Cloud newCloud = new Cloud(mouseX, mouseY, 20, 6, fColor);
                  newCloud.position.set(mouseX,mouseY);
                  clouds.add(newCloud);
             }
       } else if (mouseObject.action == 7) {
            if (isInArea(mouseX, mouseY)){
                  Cloud newCloud = new Cloud(mouseX, mouseY, 20, 7, gColor);
                  newCloud.position.set(mouseX,mouseY);
                  clouds.add(newCloud);
             }
       } 
...
void menuSetup(){
      ...
      MenuItem cordMenuItem2 = new MenuItem("b", 925, 150, 2, bColor);
      menu.add(cordMenuItem2);
      MenuItem cordMenuItem3 = new MenuItem("c", 925, 200, 3, cColor);
      menu.add(cordMenuItem3);
      MenuItem cordMenuItem4 = new MenuItem("d", 925, 250, 4, dColor);
      menu.add(cordMenuItem4);
      MenuItem cordMenuItem5 = new MenuItem("e", 925, 300, 5, eColor);
      menu.add(cordMenuItem5);
      MenuItem cordMenuItem6 = new MenuItem("f", 925, 350, 6, fColor);
      menu.add(cordMenuItem6);
      MenuItem cordMenuItem7 = new MenuItem("g", 925, 400, 7, gColor);
      menu.add(cordMenuItem7);
