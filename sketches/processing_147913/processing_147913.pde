...
void draw() { 
  ...
  //////////////////////////////////////////////////////////////////////
    ...
    if (millis() - timer >= 30000) {
      timer = millis();
      leafArray[int(random(leafArray.length))].rustling = true;
    }
}
  ...
  // timer = millis();
  // if(timer%2000 == 0) {
  //    littleRustle = int(random(leafArray.length));
  //    leafArray[littleRustle].rustling = true;
  //  }
  // else {
  //   leafArray[littleRustle].rustling = false;
  // }
  //}
