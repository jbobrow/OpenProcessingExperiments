...
void draw () {
  ...
  if (mousePressed == true && mouseX>350 && mouseX<450 && mouseY>700 && mouseY<750)
  {
    MyMode7();
  }
  ...
  //text for buttons
  fill(255);
  text("Collision Theory", 55, 75);
  text("Space", 283, 75);
  text("Trig", 485, 75);
  text("BULLSHIT", 675, 75);
  text("Conditionals", 563, 157);
  text("xPos", 385, 157);
  text("Golden Ratio", 160, 157);
  text("RESET", 380, 730);
  ...
  //instruction text
  fill(0);
  text("Hold down an option to personalize your kicks", 250, 650);
}
...
void MyMode5() {
  ...
  fill(xPos2/2, yPos2/3, 255);
  strokeWeight(5);
  stroke(xPos2/3, yPos2, 255);
