...
sound1 = new Audio("http://thetoastisburning.site50.net/sounds/beep.wav");

sound2 = new Audio("http://thetoastisburning.site50.net/sounds/bass.wav");

sound3 = new Audio("http://thetoastisburning.site50.net/sounds/tink.wav");

sound4 = new Audio("http://thetoastisburning.site50.net/sounds/kick.wav");

sound5 = new Audio("http://thetoastisburning.site50.net/sounds/bump.wav");

sound6 = new Audio("http://thetoastisburning.site50.net/sounds/pluck.wav");
...
void mousePressed(){
       ...
       if (mouseObject.isOverMenuItem){
           mouseObject.action = menu.get(mouseObject.overItem).mouseJobCode;
               ...
               if (isInArea(mouseX, mouseY)){
                    Cloud newCloud = new Cloud(mouseX, mouseY, 20, 1);
             ...
             if (isInArea(mouseX, mouseY)){
                  Cloud newCloud = new Cloud(mouseX, mouseY, 20, 2);
                  newCloud.position.set(mouseX,mouseY);
                  clouds.add(newCloud);
             }
             ...
             if (isInArea(mouseX, mouseY)){
                  Cloud newCloud = new Cloud(mouseX, mouseY, 20, 3);
                  newCloud.position.set(mouseX,mouseY);
                  clouds.add(newCloud);
             }
             ...
             if (isInArea(mouseX, mouseY)){
                  Cloud newCloud = new Cloud(mouseX, mouseY, 20, 4);
                  newCloud.position.set(mouseX,mouseY);
                  clouds.add(newCloud);
             }
             ...
             if (isInArea(mouseX, mouseY)){
                  Cloud newCloud = new Cloud(mouseX, mouseY, 20, 5);
                  newCloud.position.set(mouseX,mouseY);
                  clouds.add(newCloud);
             }
             ...
             if (isInArea(mouseX, mouseY)){
                  Cloud newCloud = new Cloud(mouseX, mouseY, 20, 6);
                  newCloud.position.set(mouseX,mouseY);
                  clouds.add(newCloud);
             }
       }
...
void menuSetup(){
      ...
      MenuItem cordMenuItem1 = new MenuItem("beep", 925, 100, 1, cloudMenuColor);
      menu.add(cordMenuItem1);
      MenuItem cordMenuItem2 = new MenuItem("bass", 925, 150, 2, cloudMenuColor);
      menu.add(cordMenuItem2);
      MenuItem cordMenuItem3 = new MenuItem("tink", 925, 200, 3, cloudMenuColor);
      menu.add(cordMenuItem3);
      MenuItem cordMenuItem4 = new MenuItem("kick", 925, 250, 4, cloudMenuColor);
      menu.add(cordMenuItem4);
      MenuItem cordMenuItem5 = new MenuItem("bump", 925, 300, 5, cloudMenuColor);
      menu.add(cordMenuItem5);
      MenuItem cordMenuItem6 = new MenuItem("pluck", 925, 350, 6, cloudMenuColor);
