...
void setup()
{
  ...
  RiText translator = new RiText(this, "‘Deer Park’ by Wang Wei • translation Arthur Cooper", 120, 680);
  ...
  RiText[] transLines = RiText.createLines(this, trans, 120, 360, -1, 0); // respect line endings
