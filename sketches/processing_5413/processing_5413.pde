...
//float eyex = map(mouseX, 0, width, 153.5, 236.5);
//float eyey = map(mouseY, 0, height, 114.5, 197.5);
...
//pressing any key changes tongue color to blue
