...
void draw()
{
fill(255, 80);//rellenar de blanco (255) con transparencia (10) el rectangulo
...
// declaras las variables dentro de otra variable para mantenerlas dentro
DibuixaUlls();
}

// variable de los ojos que va dentro e DibuixaSmiley
void DibuixaUlls()
{
noFill();
ellipse(x-5,y-5, 2,2);
