...
// mm = new MovieMaker(this, width, height, "sintitulo2010.mov",
//                       24, MovieMaker.ANIMATION, MovieMaker.HIGH);
//    recorder = minim.createRecorder(out, "sintitulo2010.wav", true);
...
void intro(){
/* Gracias a Laurence Bender, Marcelo Terreni y Frederik Vanhoutte
*/
