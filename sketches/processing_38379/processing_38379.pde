...
noStroke();
 ...
 arc(300, 475, 111, 25, -PI, 0); //top lip shape
 
 arc(300, 475, 115, 35, .3, 2.75); //bottom lip shape
 ...
 stroke(2);
 arc(365, 300, 65, 25, -PI, 0); //eyebrow 1 shape
 
 stroke(2);
 arc(227, 300, 65, 25, -PI, 0); //eyebrow 1 shape
