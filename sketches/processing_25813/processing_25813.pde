...
class Dot {
 ...
 PVector gridpos; //??
  ...
  Dot( PVector _gridpos ) { // constructor - makes a new object
    ...
    vel = new PVector(random(-2,2),random(-2,2)); // vel and pos inducing the controlled "swarming"
  ...
  void render() { // something our object can do -- draw itself
    ...
    //ellipse( gridpos.x,gridpos.y, pos.x*0.01,pos.x*0.01 ); // original coding from early stages
