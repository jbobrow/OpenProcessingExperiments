...
void setup()
{
  img = loadImage ("chortle.jpg");
  currentTop = loadImage("chuckle.png");
  currentBottom = loadImage("snort-le.png");
  
  outer[0] = "chuckle.png";      //Assign
  outer[1] = "glousser.png";
  outer[2] = "rir.png";
  outer[3] = "zichao.png";
  
  inner[0] = "snort-le.png";
  inner[1] = "qifen.png";
  inner[2] = "grogner.png";
  inner[3] = "bufar.png";
