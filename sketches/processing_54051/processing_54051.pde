...
void setup() {
  ...
  outletPlug = loadShape("outletplug.svg");
}
...
void draw()
{
  ...
  noStroke();
  fill(#E3E8C7);
  quad(-1, 150,  500, 300,  500, 500,  -1, 500);
  stroke(0);
  strokeWeight(1);
  fill(230);
  rect(-1, 400, 501, 201);
  ...
  // Outlet and Plug
  shape(outletPlug, 200, 120, 400, 500);
  ...
  tv = constrain(tv, 50, 300);
  shape(toast, 160, tv, 175, 175);
  ...
  lv = constrain(lv, 317, 410);
  shape(lever, 321, lv, 70, 70);
