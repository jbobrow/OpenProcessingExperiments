...
/* @pjs font="Quantico-BoldItalic.ttf"; */ 

PFont myFont ; //nickname
...
void setup() {
  ...
  myFont = createFont("Quantico-BoldItalic.ttf", 200);
  
  prog = loadImage("program11.png");
...
image(matrix2, 0, 0, width, height);
noStroke();
smooth();
...
fill (#000000);
textFont(myFont, 70); // this is where you set the current font
