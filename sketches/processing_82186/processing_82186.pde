...
textAlign(LEFT, BASELINE);
  ...
  if (dist(mouseX, mouseY, x, margin+plotHeight)<50) {
    text(dogs[idx].attacks, x, barWidth/2+margin );
  }
  ...
  textSize(20);
  if (dist(mouseX, mouseY, x, margin+plotHeight)<50) {
    text(dogs[idx].children, x, barWidth/2+margin );
  } 
  ...
  textSize(20);
  if (dist(mouseX, mouseY, x, margin+plotHeight)<50) {
    text(dogs[idx].adults, x, barWidth/2+margin );
  }
  ...
  if (dist(mouseX, mouseY, x, margin+plotHeight)<50) {
    text(dogs[idx].deaths, x, barWidth/2+margin );
  }
  ...
  if (dist(mouseX, mouseY, x, margin+plotHeight+margin/5)<25) {
    text(dogs[idx].maining, x, barWidth/2+margin );
  }
