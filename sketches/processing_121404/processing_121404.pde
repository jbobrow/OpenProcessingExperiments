...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 int i= 0;///try to make into a loop---really repetitive and inefficient
  ...
  if (timer > i){ i =0;}
    ...
    else if(timer <= i +125) {text(message3 = message4, width/2, height/1.5);
  }
    else if(timer <= i+250) {text (message3 = message5,width/2, height/1.5);
  }
    else if (timer <=i +375) {text (message3 = message6, width/2 ,height/1.5);
  }
   else if(timer <= i +500) {text (message3= message7, width/2, height/1.5);
  }
  else if (timer <= i +625) {text (message3= message8, width/2, height/1.5);
  }
  else if (timer >= i+625) {text (message3= message9, width/2, height/1.5);
}
}
