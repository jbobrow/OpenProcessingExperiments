...
{
  size (600, 500);
  /*Color of background when it starts drawing*/
  background(255);
  smooth();
  PImage img = pic == 0 ? loadImage ("kidspainting.jpg") : loadImage ("selbst.jpg");
  PImage bg = loadImage ("kidsart.jpg");
  PImage img1 = loadImage("kidsart.jpg");
