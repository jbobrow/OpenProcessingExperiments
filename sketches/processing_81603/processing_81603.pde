...
/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/25797*@* */
...
void setup()
{
  ...
  // load flake objects
  flakes = new Flake[4];
  flakes[0] = new Flake(fontManager, "guitar.mp3", "Guitar");
  flakes[1] = new Flake(fontManager, "drums.mp3", "Drums");
  flakes[2] = new Flake(fontManager, "bass.mp3", "Bass");
  flakes[3] = new Flake(fontManager, "piano.mp3", "Piano");
