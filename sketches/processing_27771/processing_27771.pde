 ...
 // if (mouseX < width-100 > width-400, mouseY < height-100 > height-400){
  ...
  for (int x = -42; x < 42; x++) {
    ...
    for (int z = -42; z < 42; z++) {
      ...
      fill(.001 + y * .38, y/.1, +y/2); /*Original line of code : From "Wave Optimized" Advanced features added by Nate "ZombieProof" Created November 28, 2010.
                                           Edited by Alastair Gray.*/
