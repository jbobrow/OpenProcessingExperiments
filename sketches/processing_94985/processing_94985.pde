...
fill(161,202,245);
  ...
  fill(255,3,3);
  rect((0*(ladox+ex)), (0*(ladox+ex)), ladox, ladox);
  rect((1*(ladox+ex)), (0*(ladox+ex)), ladox, ladox);
  rect((2*(ladox+ex)), (0*(ladox+ex)), ladox, ladox);
  rect((5*(ladox+ex)), (0*(ladox+ex)), ladox, ladox);
  rect((6*(ladox+ex)), (0*(ladox+ex)), ladox, ladox);
  rect((7*(ladox+ex)), (0*(ladox+ex)), ladox, ladox);
  rect((0*(ladox+ex)), (1*(ladox+ex)), ladox, ladox);
  rect((1*(ladox+ex)), (1*(ladox+ex)), ladox, ladox);
  rect((6*(ladox+ex)), (1*(ladox+ex)), ladox, ladox);
  rect((7*(ladox+ex)), (1*(ladox+ex)), ladox, ladox);
  rect((0*(ladox+ex)), (2*(ladox+ex)), ladox, ladox);
  rect((4*(ladox+ex)), (2*(ladox+ex)), ladox, ladox);
  rect((5*(ladox+ex)), (2*(ladox+ex)), ladox, ladox);
  rect((6*(ladox+ex)), (2*(ladox+ex)), ladox, ladox);
  ...
  rect((5*(ladox+ex)), (3*(ladox+ex)), ladox, ladox);
  ...
  rect((5*(ladox+ex)), (4*(ladox+ex)), ladox, ladox);
  rect((6*(ladox+ex)), (4*(ladox+ex)), ladox, ladox);
  rect((0*(ladox+ex)), (5*(ladox+ex)), ladox, ladox);
  rect((1*(ladox+ex)), (5*(ladox+ex)), ladox, ladox);
  rect((5*(ladox+ex)), (5*(ladox+ex)), ladox, ladox);
  rect((0*(ladox+ex)), (6*(ladox+ex)), ladox, ladox);
  rect((1*(ladox+ex)), (6*(ladox+ex)), ladox, ladox);
  rect((2*(ladox+ex)), (6*(ladox+ex)), ladox, ladox);
  rect((7*(ladox+ex)), (6*(ladox+ex)), ladox, ladox);
  rect((0*(ladox+ex)), (7*(ladox+ex)), ladox, ladox);
  rect((1*(ladox+ex)), (7*(ladox+ex)), ladox, ladox);
  rect((2*(ladox+ex)), (7*(ladox+ex)), ladox, ladox);
  rect((3*(ladox+ex)), (7*(ladox+ex)), ladox, ladox);
  rect((5*(ladox+ex)), (7*(ladox+ex)), ladox, ladox);
  rect((6*(ladox+ex)), (7*(ladox+ex)), ladox, ladox);
  rect((7*(ladox+ex)), (7*(ladox+ex)), ladox, ladox);
    noLoop();
}
