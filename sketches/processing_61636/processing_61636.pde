...
void keyPressed() {
  ...
  switch (keyCode) {
  case UP:
    ini = false;up = true;down = false;left = false;right = false;
    break;
  case DOWN:
    ini = false;up = false;down = true;left = false;right = false;
    break;
  case LEFT:
    ini = false;up = false;down = false;left = true;right = false;
    break;
  case RIGHT:
    ini = false;up = false;down = false;left = false;right = true;
    break;
 }
}
