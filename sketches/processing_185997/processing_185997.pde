...
void setup()
{
  img = loadImage ("craptacular.jpg");
  currentTop = loadImage("beschissen.png");
  currentBottom = loadImage("ayooshchy.png");
  
  outer[0] = "beschissen.png";      //Assign
  outer[1] = "malo.png";
  outer[2] = "parshivui.png";
  outer[3] = "YaSuMoNo.png";
  
  inner[0] = "ayooshchy.png";
  inner[1] = "dramatico.png";
  inner[2] = "HaNaYaKa.png";
  inner[3] = "spektakel.png";
