...
/*Practica 10: gamificacio

Modificacio del meu joc ja existent corresponent a la Practica 7
El temps. Inclou:

-Medalles
-Temporitzador i Barra de progres
-Interaccio
-Puntuacio
...
/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/126023*@* */
  ...
  text("CERVESES BEGUDES=" + (int)cerv, 10, 550);
    ...
    if (consciencia<=0){
      ...
      if((int)cerv>10){
        ...
        fill(#000000);
        text("Has begut mes de 10 cerveses!!", 20, 250);
      }
      if ((int)cerv>20){
        fill(#0000FF);
        ellipse(50,300,40,40);
        fill(#000000);
        text("Has begut mes de 20 cerveses!!", 20, 350);
      }
    }
    if (30-2*m/1000 < 0){
      background(0);
      textSize(40);
      text("Has begut:" + (int) cerv + " cerveses", 220, 400);
     
      bonus=-99999;
      poder=0;
      ellipse(50,100, 40, 40);
      text("No has mort!!", 20, 150);
      if((int)cerv>10){
        fill(#0000FF);
        ellipse(50,200,40,40);
        text("Has begut mes de 10 cerveses!!", 20, 250);
