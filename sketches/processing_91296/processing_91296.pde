...
/* @pjs preload="backyard.jpg, jerry.png, tom.png, tomHappy.png, tomHungry.png, spike.png, spikeSepia.png";*/
PImage backgroundImage;
PImage spikeSepiaImg;
PImage tomHungryImg;
PImage tomHappyImg;
PImage jerryGoneImg;
Sprite tomSprite;
...
void setup() {
  ...
  spikeSepiaImg = loadImage("spikeSepia.png");
  tomHungryImg = loadImage("tomHungry.png");          
  tomHappyImg = loadImage("tomHappy.png");   
  jerryGoneImg = loadImage("jerryGone.png");
  size(1000, 600);
  tomSprite = new Sprite(random(600), random(100, 400), 70, 70, 20, "tom.png");
  jerrySprite = new Sprite(random(600), 200, 60, 60, 20, "jerry.png");
  spikeSprite = new Sprite(random(600), random(100, 400), 100, 100, 10, "spike.png");
...
void draw() { 
  ...
  if (spikeSprite.age > 1)
  {
    spikeSprite.dead = true;
    spikeSprite.img = spikeSepiaImg;
    
    if(jerrySprite.w == 0 ) {
      tomSprite.img = tomHungryImg;
    }
    
      else {
    tomSprite.img = tomHappyImg;
...
class Sprite
{
  ...
  void move()
  {
    ...
    if (age > 100) {
    dead = true;
    //spikeSprite.dead = true; // always sets spikeSprite to stop moving
    }
