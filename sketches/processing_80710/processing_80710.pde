...
/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/61011*@* */
...
void draw() {
  ...
  for (int gridY=0; gridY<tileCount; gridY++) {
    for (int gridX=0; gridX<tileCount; gridX++) {
      ...
      vertex(posX+circleSize+shiftX2, posY+shiftY2);
      vertex(posX+circleSize+shiftX3, posY+circleSize+shiftY3);
      vertex(posX+shiftX4, posY+circleSize+shiftY4);
      endShape(CLOSE);
    }
  } 
