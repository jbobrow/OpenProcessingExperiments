...
void draw() {
  ...
  RotateY(radians(a));
  fill(255, 0, 0, 200);
  DrawRect(-RECT_SZ, -RECT_SZ, RECT_SZ, RECT_SZ);
  fill(255, 255, 0, 200);
  DrawRect(-RECT_SZ+100, -RECT_SZ+100, RECT_SZ, RECT_SZ);
  fill(102, 197, 67, 200);
  DrawRect(-RECT_SZ+100, -RECT_SZ, RECT_SZ, RECT_SZ);
  fill(0, 0, 255, 200);
  DrawRect(-RECT_SZ, -RECT_SZ+100, RECT_SZ, RECT_SZ);
}
