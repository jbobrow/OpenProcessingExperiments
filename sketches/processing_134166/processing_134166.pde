...
void draw() 
{  
  //the count and while loop speed up the drawing. After 50 points are created, then they are drawn.
  int count = 0;
...
{
  multiplier = multiplier + ((random(6)-3)/55.0);
