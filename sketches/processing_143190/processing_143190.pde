...
fill(255);
ellipse(243, 503, X+50,Y+ 50);
ellipse(264, 516, X+50, Y+50);
ellipse(317, 530, X+50, Y+50);
ellipse(372, 530, X+50, Y+50);
ellipse(450, 495, X+50,Y+ 50);
ellipse(425, 519, X+50,Y+ 50);
