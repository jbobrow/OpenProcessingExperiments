...
Floater[] floaters = new Floater[210];
...
void setup() {
  ...
  for( int i = 0; i < floaters.length; i++ ) {
    floaters[i] = new Floater( new PVector( random( 100, width ), random( 100, height )), random( 1, 2 ), random( 3, 5 ), color( random( 100, 255 ), random( 100, 255 ), random( 100, 255 ) ), GRAV );
  }
}
void draw() {
  //background( 0 );
