...
/*Inspirado na canÃ§Ã£o "Pela Internet" do cantor e compositor Gilberto Gil, o trabalho tenta mostrar atravÃ©s de figuras geomÃ©tricas simples a composiÃ§Ã£o de uma web page do cantor tal qual ele se refere no trecho da mÃºsica que diz "Criar meu web site,
Fazer minha home-page". Nessa web page sÃ£o encontrados elementos como: agenda de shows, fotos e play list para que as tietes (fÃ£s) do Gilberto possam acompanhar seu trabalho. A agenda do show contÃ©m datas e locais para o mÃªs de maio do ano de 2014 retirados do site oficial (http://www.gilbertogil.com.br) do mÃºsico. O cÃ³digo foi desenvolvido ao som de GG. */

// 2ª VERSÃO DO CÓDIGO DO PRIMEIRO TRABALHO

PImage oexorcista;
void setup () {
oexorcista = loadImage("http://www.itouchbr.com.br/wp-content/uploads/2010/02/img-0058.png");
  //DefiniÃ§Ãµes da pÃ¡gina
  size(600,500);
  ...
  stroke(0);
  fill(254,254,254);
  rect(128,78,250,15,1);//endereÃ§o
  ...
  fill(75,75,77);
  textSize(12);
  text("Agenda: Maio", 141,154); // TÃ­Â­tulo do Header
  textSize(10);
  ...
  //PLAY LIST
  textSize(12);
  text("OuÃ§a minha playlist:", 315,145);
  textSize(10);
  ...
  text("8 - Fogo LÃ­quido", 310,244);
  text("9 - Planeta Dos Macacos", 310,256);
  text("10 - Feiticeira", 310,268);
  text("11 - Andar Com FÃ©", 310,280);
  //Logo do monitor

  
                          //Tietes
 // Ellipses das cabeÃ§as
 ellipseMode (CORNER);    
 noStroke(); 
 fill(75,75,77);                        
...
void draw() {
  ...
  if (mousePressed== true && mouseX >243 && mouseX<297 && mouseY>140 && mouseY<194) {
    image(oexorcista, 0, 0, width, height);
  println("oi");
}
}
