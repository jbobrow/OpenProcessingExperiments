...
class Car {
  ...
  Car(float nx, float ny, float nspeed) {
    ...
    img = loadImage("Screen Shot 2014-11-03 at 5.58.49 PM.png");
  }
...
class Quad {
  ...
  Quad(float nx, float ny, float nspeed) {
    ...
    img = loadImage("Screen Shot 2014-11-07 at 3.09.52 PM.png");
  }
...
class Truck extends Car {
  ...
  Truck(float nx, float ny, float nspeed) {
    super(nx, ny, nspeed);
    speed=nspeed;
    imgTruck = loadImage("Screen Shot 2014-11-05 at 7.59.59 PM.png");
  }
