...
void draw() {
  ...
  noStroke(); // ondas 
  beginShape();
  curveVertex(45, 100-mouseX/40);
  curveVertex(85, 110+mouseX/40);
  curveVertex(125, 100);
  curveVertex(145, 110-mouseX/40);
  curveVertex(165, 110);
  curveVertex(205, 110-mouseX/40);
  curveVertex(245, 110);
  curveVertex(285, 110);
  curveVertex(305, 100+mouseX/40);
  curveVertex(325, 110-mouseX/40);
  curveVertex(365, 110);
  curveVertex(385, 110+mouseX/40);
  curveVertex(405, 100);
  endShape();

  fill (255); // pilares predio novo
  noStroke();  
  int x;
  for (x=40; x<300; x=x+20)
    rect (x, 115, 2, 172);

  stroke(255); // pilares de tras
  strokeWeight(1);
  int t;
  for (x=85; x<266; x=x+20)
    line(x, 152, x, 135);
  ...
  stroke (170); // rect do meio - predio velho
  strokeWeight(1);
