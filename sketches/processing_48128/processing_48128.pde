...
//Chinese Pacman (Sic San By: Raymond Fang and Daniel Wong\\
...
void displayInstructions()
{
  ...
  //fill(#FEFF00);
  //textFont(font, 50);  
  //text("Chinese Pacman!", 40, 180);


  fill(#4DF507);
  textFont(font, 13);  
  text("Collect the SF's, avoid the ghosts, and use the arrow keys to move player.", 60, 500);
