...
void lifeBar(){  //player's health
  if(zombieX1-5 < playerX && zombieX1+5 > playerX && zombieY1-5 < playerY && zombieY1+5 > playerY){
    playerDamage = true;
  }else{
    playerDamage = false;
  }
  if(zombieX2-5 < playerX && zombieX2+5 > playerX && zombieY2-5 < playerY && zombieY2+5 > playerY){
    playerDamage = true;
  }else{
    playerDamage = false;
  }
