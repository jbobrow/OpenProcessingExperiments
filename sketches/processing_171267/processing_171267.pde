...
void gui() {
  ...
  PFont p = createFont("BrandonGrotesque-Bold", 9);
  cp5.setControlFont(p);

  cp5.setColorForeground(#A1A1A1);
  cp5.setColorBackground(#E1E1E1);
  cp5.setColorLabel(#A1A1A1);
  cp5.setColorValue(#FFFFFF);
  cp5.setColorActive(#A1A1A1);
  ...
  cp5.addToggle("duplicate")
    .setPosition(950, 495)
      .setSize(15, 15)
        .setValue(false)
          ;

  cp5.addToggle("triplicate")
    .setPosition(1030, 495)
      .setSize(15, 15)
        .setValue(false)
          ;

  cp5.addToggle("stripes")
    .setPosition(950, 530)
      .setSize(15, 15)
        .setValue(false)
          ;
  ...
  cp5.getController("styles").getValueLabel().setVisible(false);
  cp5.getController("add-ons").getValueLabel().setVisible(false);
  cp5.getController("textoptions").getValueLabel().setVisible(false);
  cp5.getController("textoptions").getCaptionLabel().setVisible(false);
}
...
void lettera() { 
  ...
  float d = cp5.getController("destruct").getValue();
  float s1 = cp5.getController("width").getValue();
  float s2 = cp5.getController("height").getValue();
  float add = cp5.getController("add-ons").getValue();
  float fs = cp5.getController("SerifThickness").getValue();
  fill(c);
  strokeWeight(f);
  noStroke();
  strokeCap(SQUARE);
...
void alphabeta() {
  float styles = cp5.getController("styles").getValue();
...
void draw() {
  ...
  float texop = cp5.getController("textoptions").getValue();
  float leading = cp5.getController("leading").getValue();
  float s1 = cp5.getController("width").getValue();
  float s2 = cp5.getController("height").getValue();
