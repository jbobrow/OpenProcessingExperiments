...
//måler afstand fra bombe til skib
...
void draw()
{
  ...
  imageMode(CENTER);
  image(rumskib, ruksbX, ruksbY, 100, 100);
  ...
  //funktionen for rumskibets bevægelse
  rumskibsfunct();
}


//Bombernes udseende og funktion, samt kosekvens af hvis bomberne rammer rumskibet
void bomber()
{
  ...
  //If konsekvens af hvis en bombe rammer rumskib, så skal den lukke spillet ned
