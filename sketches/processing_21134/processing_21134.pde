...
// because "Circle" is just another kind of 
// variable, we can create as many as we'd like
...
void setup() {
  ...
  oneCircle = new Circle(width/2, height/2, 50);
  // create another one with a different size and color 
  anotherCircle = new Circle(width/2, height/2, 80);
}
