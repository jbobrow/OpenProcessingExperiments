...
// Sets the limits of the circle 
    ...
    // int(width/5*sin(r)defines extends of circle in the hirizontal
    // int(height/5*cos(r) defines extends of circle in the vertical
    int x = width/2 + int(width/5*sin(r)); 
