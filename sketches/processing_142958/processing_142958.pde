...
//Eunbi Oh ART3001-SP14 March 27, 2014 Thursday
//Homework 9(Dumb Agents. objects from 2 classes colliding within class and between different classes.)
...
void draw() {
  background(0);
  //object of background color and locate
  for (int y = 500; y>0; y=y-30) {// space between rectangle
    noStroke();
    fill(150, 250, y);
    rect(0, y, 500, 10);
  }
...
class Circle {
  ...
  void move() {
     y=y+yspeed;
    if (y>height+150) {
     y=-50;//speed rate of falling bubbles
    }
  }
}
