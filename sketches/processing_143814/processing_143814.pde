...
if (mouseX>20 && mouseX<780 && mouseY>20 && mouseY<740){
 ...
 /*  
  ...
  stroke(230);
  line(22, 740, 22, 800);
  line(140, 740, 140, 800);
  line(260, 740, 260, 800);
  line(480, 740, 480, 800);
  line(590, 740, 590, 800);
  line(690, 740, 690, 800);
  line(778, 740, 778, 800);
}
 
//For buttons:
void mouseClicked() {
  if (mouseX>20 && mouseX<135 && mouseY>740 && mouseY<800) {
    growEllipses();
    growLines();
  }
  
  if (mouseX>145 && mouseX<255 && mouseY>740 && mouseY<800) {
    shrinkEllipses();
    shrinkLines();
  }
  
  //if the user clicks the "RESET BRUSH SIZE" button the ellipses and lines will return to original sizes:
  if (mouseX>275 && mouseX<480 && mouseY>740 && mouseY<800) {
    resetEllipses();
    resetLines();
  }  
  
  //if the user clicks the "CLEAR" button the drawing will be cleared:
  if (mouseX>590 && mouseX<685 && mouseY>740 && mouseY<800) {
    fill(230);
    rect(0, 0, 800, 800);
    drawBorder();
    drawButtons();
