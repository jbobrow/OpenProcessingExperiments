...
/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/130010*@* */
...
for (int i = 0; i< multiMonst; i++) { tekenmonster(118+(i*230),128);}
// monsterbeweeg();
// tekenmonster();
verrander();
...
//loop van de achtergrond
void achtergrondloop(){
y1 = 0;
y2 = 300;
x = 0;
spatie = 14;
