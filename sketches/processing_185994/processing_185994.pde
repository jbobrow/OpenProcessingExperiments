...
void setup()
{
  img = loadImage ("chillax.jpg");
  currentTop = loadImage("danding.png");
  currentBottom = loadImage("rasslabitsya.png");
  
  outer[0] = "danding.png";      //Assign
  outer[1] = "lzrvm.png";
  outer[2] = "rel.png";
  outer[3] = "uspokoitsya.png";
  
  inner[0] = "rasslabitsya.png";
  inner[1] = "lnfvsh.png";
  inner[2] = "fangsong.png";
  inner[3] = "axer.png";
