...
void draw() {
  ...
  //bezier 2 (right)
  float cp3x = random(500.0);
  float cp3y = random(500);
  float cp4x = random(500);
  float cp4y = random(500);
  ...
  //right eye
  //eyebrow bezier 5
  float cp9x = random(500);
  float cp9y = random(500);
  float cp10x = random(500);
  float cp10y = random(500);
  ...
  //eye edges
  ellipse(260,160,random(60),random(30));
  ellipse(260,160,random(20),random(30));
