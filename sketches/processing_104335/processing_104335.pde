...
void setup()
{
  ...
  noFill();
  String [] sliderNames = {"red", "green", "blue", "size"};
  ms = new MultiSlider(sliderNames.length, 0, 255, 10, height-210, 40, 200, VERTICAL);
...
void mouseDragged()
{
  stroke(ms.get(0),ms.get(1),ms.get(2));
  strokeWeight(map(ms.get(3),0,255,0,10));
