 ...
 * feature requests/ideas/help is appreciated. Also, if you get unsatisfactory
 * results, make sure you play around with different voxel resolutions, wall thicknesses
 * and apply laplacian smooth after the voxelization process.</p>
 *
...
void voxelizeMesh() {
  MeshVoxelizer voxelizer=new MeshVoxelizer(32);
