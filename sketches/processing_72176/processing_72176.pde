...
{
  background (0);
  initials (mouseX, mouseY, wd, ht);// move initials around with mouse
}
...
void keyPressed () // if up button is pressed Initials expand symetrically 
{
if (key == CODED) {
    if (keyCode == UP) {
      wd=wd+5;
...
if (key == ' ') //makes initials disappear
{
