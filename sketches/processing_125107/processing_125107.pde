...
//To play a particular track, click the 1 key(Dark Jazz Track),
//2 key(EDM Track), or 3 key(Country Track). To stop a track, click another number to change to 
//that track or click 's' to have any or all of the tracks stop playing.
...
//your favorite song in any media application, and start playing along on your own
//with your favorite son or songs.
//------------------------------------------------------------------------------
//SKETCH CODE
