...
/*Si la librairie minim.ugens, n'est pas trouvé, (vielle version de Processing:
télécharger la librairie sur le site de minim, et remplacer la veille librairie 
minim (dans Processing/mode//java/librairies/ par la nouvelle*/
