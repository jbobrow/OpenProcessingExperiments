...
PImage mjolnir;
PImage mjolnirCharged;
PImage thorBackground;
float x;
float y;
...
void setup()
{
  ...
  mjolnirCharged = loadImage("mjolnirCharged.png");
  thorBackground = loadImage("thorBackground.jpg");
  colorMode(HSB, 100);
  smooth();
  noFill();
  meanDistance = 1000*.5;
...
void draw()
{
  ...
  {
    chargeTimer++;
    image(thorBackground, s+0, 0, 800, 500);
    image(thorBackground, s+800, 0, 800, 500);
    image(thorBackground, s+1600, 0, 800, 500);
    image(thorBackground, s+2400, 0, 800, 500);
    image(thorBackground, s+3200, 0, 800, 500);
    image(thorBackground, s+4000, 0, 800, 500);
    image(thorBackground, s+4800, 0, 800, 500);
    image(thorBackground, s+5600, 0, 800, 500);
    image(thorBackground, s+6400, 0, 800, 500);
    image(thorBackground, s+7200, 0, 800, 500);
    image(thorBackground, s+8000, 0, 800, 500);
    image(thorBackground, s+8800, 0, 800, 500);
    image(thorBackground, s+9600, 0, 800, 500);
    image(thorBackground, s+10400, 0, 800, 500);
    if (chargeTimer < 70)
    {
    ...
    if (chargeTimer >= 70)
    {
    image(mjolnirCharged, 0+x, 220+y, 100, 66.7);
    }
  }
