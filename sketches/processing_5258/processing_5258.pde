...
void draw() { 
  background(15,15,15); 
  speed*=1.009;  //play with this number to make the horizontal speed change - it is  
                //very delicate and large increments make it happen very fast 
   
  for (int j=1; j<2500; j++) {  //this set the number of rectangles 
    w = random(10,40); 
    h = random(10,40); 
    fill(5,54,19); 
