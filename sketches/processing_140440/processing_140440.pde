...
// Izabela Candido Araujo S53 Arquitetura e Urbanismo
//London2 de Izabela Candido está licenciado com uma Licença Creative Commons - Atribuição 4.0 Internacional.
...
void setup() {
 ...
 photo=loadImage("rodagigante.jpg");
...
void rodagigante (int x, int y)
{
  pushMatrix();
  scale(0.2);
  image(photo, x*10, y*10);
  popMatrix();
}
