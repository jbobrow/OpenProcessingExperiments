...
//This is a creative sketch that consist of various components learned in class.  When you move across the screen the colors of the circles and strokes change.  When you click the mouse additional circle pop up to create the head and tail of the spiral figures. When you hold any key on the keyboard bubbles will appear.  When you specifically press the letter'b' music will play.  To stop the music, press any key.  
