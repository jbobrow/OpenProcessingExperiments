...
//linesWithDots();
  ...
  //curves
  //1
  bezier(317, 13, 324, 10, 323, 0, 323, 0);
  //2
  ...
  //
  bezier(516, 563, 549, 566, 574, 565, 590, 548);
  //
  ...
  //
  noFill();
  bezier(182, 371, 162, 368, 143, 354, 134, 347);
  //
...
void curvesDots() {
  /*/CURVE DOT
   fill(1);
   ellipse(135, 347, 15, 14);
   ellipse(131, 813, 15, 14);
   ellipse(309, 15, 15, 14);
   ellipse(516, 563, 12, 12);
   */
...
/*void spiral() {
 ...
 //dot
 fill(1);
 ellipse(106, 78, 15, 14);
 ellipse(431, 384, 18, 18);
 //1
 noFill();
 beginShape();
 vertex(180, 15);
 ...
 bezierVertex(72, 68, 74, 89, 82, 97);
 bezierVertex(88, 104, 104, 104, 110, 98);
 bezierVertex(115, 92, 116, 85, 110, 79);
 endShape();
 //2
 beginShape();
 vertex(422, 274);
 ...
 bezierVertex(398, 394, 406, 420, 435, 416);
 bezierVertex(443, 415, 454, 404, 454, 395);
 bezierVertex(454, 388, 448, 383, 440, 383);
 endShape();
 }*/
void ellipseYB1() {
  //--------yellow/black ellipse------------ 
  fill(1); //black
  beginShape();
  vertex(257, 31);
...
void rotateBG() {
   ...
   */
  float k=PI*(pmouseX+pmouseY)/50;
  int mx=170;
  int my=511;
  int xa=174;
  int ya=449;
  float xb=(xa-mx)*cos(k)+(ya-my)*sin(k)+mx;
  float yb=-(xa-mx)*sin(k)+(ya-my)*cos(k)+my;

  int aa=141;
  int ba=568;
  float ab=(aa-mx)*cos(k)+(ba-my)*sin(k)+mx;
  float bb=-(aa-mx)*sin(k)+(ba-my)*cos(k)+my;
  noFill();
  line(182, 371, xb, yb);
  bezier(ab, bb, 114, 619, 122, 665, 122, 673);
  //
  pushMatrix();
  translate(mx, my);
  ...
  fill(1);
  beginShape();
  vertex(174-mx, 449-my);
  bezierVertex(164-mx, 451-my, 114-mx, 447-my, 103-mx, 510-my);
  bezierVertex(99-mx, 536-my, 116-mx, 560-my, 141-mx, 568-my);
  bezierVertex(170-mx, 518-my, 174-mx, 449-my, 174-mx, 449-my);
  endShape();

  fill(29, 24, 123);//blue
  beginShape();
  vertex(174-mx, 449-my);
  bezierVertex(202-mx, 448-my, 236-mx, 478-my, 235-mx, 514-my);
  bezierVertex(236-mx, 550-my, 189-mx, 584-my, 141-mx, 568-my);
  bezierVertex(170-mx, 518-my, 174-mx, 449-my, 174-mx, 449-my);
  endShape();
  popMatrix();
}
