...
import processing.serial.*;import cc.arduino.*;int port = 0;Arduino myBoard;int firstDial; int mnt;
...
void setup() {
  ...
  myBoard = new Arduino(this, Arduino.list()[port], 57600);
 myBoard.pinMode(2, Arduino.INPUT);
...
void draw() {
  ...
  //firstDial = myBoard.analogRead(0); mnt = myBoard.analogRead(2);
  fill (penFill); stroke (penStroke);ellipse(mnt/1.28, firstDial/1.28, 15, 15);
  
  
//if (myBoard.digitalRead(2) == Arduino.HIGH) {
    //background(255);
  
 // else{
    //fill(255,255,255); stroke(255,255,255);
  //}
  //ellipse(300, 200, 200, 200); ellipse (355,255,30,30);
