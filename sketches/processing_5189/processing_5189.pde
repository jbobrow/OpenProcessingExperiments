...
//BEGIN
// 1st ellipse(395,153,15,15);
//2nd ellipse(382,146,15,15);
//3rd ellipse(367,146,15,15);
//4th ellipse(355,155,15,15);

//MOVED
//1st ellipse(450,157,15,15);
//2nd ellipse(440,145,15,15);
//3rd ellipse(426,140,15,15);
//4th ellipse(412,137,15,15);
...
void draw ( )   {
  ...
  footy += (footendy - footy) * easing; // foot
   ...
   mouthx += (mouthendx - mouthx) * easing; // foot
  mouthy += (mouthendy - mouthy) * easing; // foot
...
//bezier(223,183,223,183,232,133,249,186); happy mouth
...
smooth();
fill(255);
 ellipse(485,150,50,70); //head
 line(476,185,476,260); //torso
 fill(0); //mustache
 bezier(440,176,462,153,451,165,478,160);//mustache
 noFill();//outer eye
 strokeWeight(1);//outer eye
 ellipse(472,140,10,20);//outer eye
 fill(0);//inner eye
 ellipse(475,138,5,10);//inner eye
 noFill();//arm
 strokeWeight(3);//arm
 bezier(440,226,462,193,451,205,485,200);//arm
 line (476,258,468,315);
 line (477,258,479,315);
