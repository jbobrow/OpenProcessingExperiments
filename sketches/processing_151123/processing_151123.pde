 ...
 * as arguments.
 *  AMENDED BY P Bailey as part of monash exercise w204
 */
...
boolean isEven=false;
  ...
  for (int i=0; i<num; i++) {
    ...
    for (int j=0; j<num; j++) {
      ...
      //get remainder to check if even or odd
      if ( (circleNumber % 2) == 0) { 
        ...
        { 
          //make circlenumber negative *-1 to change direction of hand
             movingCircle2(tx, ty, cellsize, (circleNumber*-1) * TWO_PI * millis() / 60000.0);
