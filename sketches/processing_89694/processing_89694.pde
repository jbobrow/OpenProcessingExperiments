...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//  Monstre interactif fait par Etienne Déniger
//  dans le cadre du cours d'Algorithme de base et interactivité (EDM4600)
//  UQÀM, Mars 2013
//
//
//  EMPLACEMENT DES FONCTIONNALITÉS:
//  
//  - Zone interactive circulaire: fonction draw (permet de déclancher une fonction dans la classe Particules)
...
//tableau utilisé pour créer les tableau du contour et de l'intérieur
...
void setup() {
  ...
  // Création du ArrayList des tentacules
...
//
//  Classe: Contour
//  Permet de créer et d'afficher le contour de la méduse
//
/////////////////////////////////////////////////////////////////////////////////////////////////////
class Contour {
  // PROPRIÉTÉS
   ...
   *
   *  Fonction display()
   *  Anime la couleur du contour à l'aide d'un timer
   *  Appel la fonction updateArray(), pour récupérer les positions du contour
   *  Crée le contour
   *
   */
  void display() {
...
//
//  Classe: Interieur
//  Permet de créer et d'afficher l'intérieur de la méduse
//
/////////////////////////////////////////////////////////////////////////////////////////////////////
class Interieur {
  // PROPRIÉTÉS
   ...
   *  Fonction display()
   *  Anime la couleur du contour à l'aide d'un timer
   *  Appel la fonction updateArray(), pour récupérer les positions de l'intérieur
   *  Appel de la fonction etoile()
   *  Crée l'intérieur et le cercle au centre 
   *
   */
  void display() {
  ...
  /**
   *  Fonction etoile()
   *  La majorité du code de cette fonction a été pris sur www.processing.com
   *  
   */
...
//
//  Classe: Particules
//  Permet de d'afficher, d'animer et interaqir avec les particules situées au centre de la meduse
//
/////////////////////////////////////////////////////////////////////////////////////////////////////
class Particules {
  // PROPRIÉTÉS
   ...
   *  Les particules sont animées selon l'emplacement, qui est aléatoire
   *  Lorsque une particule a une opacité de 0, son état (vieParticule) devient à false 
   *  elle est supprimé de l'ArrayList (arrayParticule)
   */
  void display() {
   ...
   *  cette zone a été paramétré dans le draw 
   */
  void mouseEvent() {
 ...
 *  Permet de créer un tableau de coordonées pour le contour et l'intérieur de la méduse
 *  Permet de diminer ou d'augmenter la valeur de chaque coordonées dans le tableau
 *  Cette fonction permet de ne pas répéter 2 fois le code ci-dessous
 */
