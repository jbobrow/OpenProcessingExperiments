...
Fallen Flowers
 ...
 -fireflies along with mouse move
...
firefly(pmouseX,pmouseY);
firefly(random(pmouseX),random(pmouseY));
firefly(random(width),random(height));
firefly(random(width),random(height));
...
void mouseReleased() {
 ...
 void firefly(float x1,float y1){
  float dia=random(2,8);
  //float x1=random(width);
  //float y1=random(height);
  float opa2=random(10,50);
  noStroke();
  fill(255,246,142,opa2-15);
  ellipse(x1,y1,dia*6,dia*6);
   fill(255,246,142,opa2-10);
  ellipse(x1,y1,dia*4,dia*4);
 fill(255,246,142,opa2-5);
  ellipse(x1,y1,dia*2,dia*2);
   fill(255,246,142,opa2);
