...
//   sagmeister  musée des arts decoratifs 2011 / 2012

//   arnaud.mathilde@gmail.com
...
void draw () {
  ...
  /*color cq1 = color (135,210,255,50);
  color cq2 = color (135,210,255,50);
  color cq3 = color (135,210,255,50);
  color cq4 = color (135,210,255,50);
  color cq5 = color (135,210,255,50);
  color cq6 = color (135,210,255,50);
  color cq7 = color (135,210,255,50);
  color cq8 = color (135,210,255,50);*/
  ...
  for (int mltha = dbtrmg; mltha<fntrmd; mltha=mltha+nbmtfh/espcmtf){
    for (int mltva = dbtrmh; mltva<fntrmb; mltva=mltva+nbmtfv/espcmtf){
  triangle (mltha+e,mltva+f,mltha+g,mltva+h,mltha+nbmtfh/espcmtf+a,mltva+b);
  }}
  
  fill (cq2);
  for (int mltha = dbtrmg; mltha<fntrmd; mltha=mltha+nbmtfh/espcmtf){
    for (int mltva = dbtrmh; mltva<fntrmb; mltva=mltva+nbmtfv/espcmtf){
  triangle (mltha+a,mltva+b,mltha+c,mltva+d,mltha-nbmtfh/espcmtf+g,mltva+h);
  }}
  
  fill (cq3);
  for (int mltha = dbtrmg; mltha<fntrmd; mltha=mltha+nbmtfh/espcmtf){
    for (int mltva = dbtrmh; mltva<fntrmb; mltva=mltva+nbmtfv/espcmtf){
  triangle (mltha+a,mltva+b,mltha+c,mltva+d,mltha+nbmtfh/espcmtf+e,mltva+f);
  }}
  
  fill (cq4);
  for (int mltha = dbtrmg; mltha<fntrmd; mltha=mltha+nbmtfh/espcmtf){
    for (int mltva = dbtrmh; mltva<fntrmb; mltva=mltva+nbmtfv/espcmtf){
  triangle (mltha+a,mltva+b,mltha+nbmtfh/espcmtf+c,mltva+d,mltha+nbmtfh/espcmtf+g,mltva+h);
  }}
  
  fill (cq5);
  for (int mltha = dbtrmg; mltha<fntrmd; mltha=mltha+nbmtfh/espcmtf){
    for (int mltva = dbtrmh; mltva<fntrmb; mltva=mltva+nbmtfv/espcmtf){
  triangle (mltha+nbmtfh/espcmtf+a,mltva+b,mltha+c,mltva+d,mltha+g,mltva+h);
  }}
  
  fill (cq6);
  for (int mltha = dbtrmg; mltha<fntrmd; mltha=mltha+nbmtfh/espcmtf){
    for (int mltva = dbtrmh; mltva<fntrmb; mltva=mltva+nbmtfv/espcmtf){
  triangle (mltha+nbmtfh/espcmtf+c,mltva+d,mltha+i,mltva+j,mltha+g,mltva+h);
  }}
  
  fill (cq7);
  for (int mltha = dbtrmg; mltha<fntrmd; mltha=mltha+nbmtfh/espcmtf){
    for (int mltva = dbtrmh; mltva<fntrmb; mltva=mltva+nbmtfv/espcmtf){
  triangle (mltha+nbmtfh/espcmtf+g,mltva+h,mltha+nbmtfh/espcmtf+i,mltva+j,mltha+e,mltva+f);
  }}
