...
void controlEvent(ControlEvent theEvent) {
  if (theEvent.getName().equals("coil")) {
    ...
    if (theEvent.getGroup().getName().equals("wire")) {
      ...
      else if (idxPreset== 2) Troques();
      else if (idxPreset== 3) Cone();
      else if (idxPreset== 4) PreciousWentleTrap();
      else if (idxPreset== 5) NeptuneCarved();
      else if (idxPreset== 6) Ancilla();
      //else if (idxPreset== 8) Oliva();
      else if (idxPreset== 7) Conch();
      else if (idxPreset== 8) Barrell();
      else if (idxPreset== 9) OstrichFoot();
      else if (idxPreset==10) SerpentineConch();
      else if (idxPreset==11) Lapa();
      else if (idxPreset==12) SnailShell();
      else if (idxPreset==13) ShellHelmetHungarian();
    }
  }
}
