...
color backgroundColor = color (4,31,5);
...
public class Ball {
  ...
  color strokeColor = color(56,32,156);
  boolean hasFill = true;
  color fillColor = color (random(0,255), random(0,255),random(25,0),random(50,250));
  // velocity
  int velX = 2;
  int velY = 2;
  //
...
public class Paddle {
  ...
  color strokeColor = #FFFFFF;
  boolean hasFill = true;
  color fillColor = color (4,31,5,0);
  //
  int x = gameFrameWidth/2;
  int y = 270;
  //
