...
// Assignment 2: Miro in Processing II (2013/10/9)
// TePangChiang  N76014087
// note: press left button and pull mouse to change shape and color
...
noFill();
  stroke(255); // 9
  pushMatrix();
  translate(mouseX+(mouseX-240),mouseY+(mouseY-300));
  float R1=PI*((mouseX-240)+(mouseY-300))*0.02;
  rotate(R1);
  line(347-407,407-402,457-407,400-402);
  line(407-407,355-402,410-407,460-402);
  line(365-407,347-402,465-407,475-402);
  line(455-407,355-402,347-407,460-402);
  popMatrix();
...
noFill();
  ...
  pushMatrix();
  translate(275,582);
  float R2=-PI*((mouseX+275)+(mouseY+582))*0.003;
  rotate(R2);
  beginShape(); // 17
...
noFill();
  ...
  pushMatrix();
  translate(275,582);
  float R2=-PI*((mouseX+275)+(mouseY+582))*0.00005;
  rotate(R2);
  beginShape(); // 17
  curveVertex(236-275,568-582); // the first control point
  curveVertex(236-275,568-582); // is also the start point of curve
