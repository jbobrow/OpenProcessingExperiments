...
void setup() {
  ...
  /*Size HAS to be same size as image*/
  size(600, 500);
  lines = loadStrings("faust_kurz.txt");  //text file
...
/*How big the paragraph's indent is*/
  posX = 20;
  /*Position from the top of the sketch*/
  posY = 50;
  float oldX = 0;
  float oldY = 0;
  ...
  for (int i = 0; i < joinedText.length(); i++) {
    ...
    /*Colour of the text here*/
    fill(255, 255, 255);
    /*Size of the text goes here*/
    textSize(18);
