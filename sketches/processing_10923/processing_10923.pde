...
void draw() {
  ...
  for(int e = 0; e < growth; e++){
    //    stroke((128./(float)growth*e+20),colorMin+20, colorMax-100);
    stroke(0);
    strokeWeight(1);
    //  beginShape();
    ...
    //  beginShape(QUAD_STRIP);      //different ways to connect the dots
    noFill();
    for(int i = 0; i < growth; i++){
  ...
  for(int i = 0; i < growth; i++){
    ...
    noStroke();
    //    tint(0, 153, 204, 126);
    //    fill(colorMin+20, colorMax-100,(128./(float)growth*i+20));//colorMin+20,colorMax-100
    //    fill(colorMin+20,colorMax-100);
    //    fill(151,(151./(float)growth*i+20)); //translucent gray
    //    noFill();
    //    ellipse(150,150,150,150);
    //    sphere(150);
    //    box(20);
    //    rect(10,10,10,10);      //different shapes
    popMatrix();
  }
