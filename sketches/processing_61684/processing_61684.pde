...
void linkWeb(int parameter) {
  switch(parameter) {
  case 1:
    link("http://youtu.be/-0G_UDqQgk0","_top");
    break;
  case 2:
    link("http://youtu.be/GwPwr0vsd7Y","_top");
    break;
  case 3:
    link("http://youtu.be/ebRBiiYNDkE", "_top");
    break;
  case 4:
    link("http://youtu.be/oCPZ6O6uwTE", "_top");
    break;
  case 5:
    link("http://youtu.be/1Q4l8hSMDDQ", "_top");
    break;
  case 6:
    link("http://youtu.be/57e7rPCOb3Y", "_top");
    break;
  case 7:  
    link("http://youtu.be/OzsCA-IU1Ls", "_top");
    break;
  case 100:
    link("https://docs.google.com/document/d/1FVxvsKRVCYR_Is-woaiddSG-utjnPY-2yhlLXZkFtsI/edit#", "_top");
    break;
  }
}
