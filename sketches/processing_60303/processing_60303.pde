...
//picture from my very good friend Ceci: http://3.bp.blogspot.com/-A9Bq0IKzusg/T5cln_k1jeI/AAAAAAAAASg/f2xGZSO_KUg/s1600/IMG_0763.JPG
//visit her blog: http://sweetnsourphoto.blogspot.co.uk/
//by 50ftWoman
...
void draw(){
  ...
  //background
  back(); //I created an object just to make code more tidy
