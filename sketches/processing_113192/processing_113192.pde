...
int numFrames = 14;  // The number of frames in the animation, there are total 14 frames
int frame = 0;
...
void setup() {
 ...
 //import photos which I took for the stop motion
  ...
  images[9]  = loadImage("http://i172.photobucket.com/albums/w12/leungmo/moon10_zps692c0891.jpg"); 
  images[10] = loadImage("http://i172.photobucket.com/albums/w12/leungmo/moon11_zps8d89cb1c.jpg"); 
  images[11] = loadImage("http://i172.photobucket.com/albums/w12/leungmo/moon12_zps441ed4e0.jpg"); 
  images[12] = loadImage("http://i172.photobucket.com/albums/w12/leungmo/moon13_zpsc0a6eaa7.jpg"); 
  images[13] = loadImage("http://i172.photobucket.com/albums/w12/leungmo/moon14_zps743c7aeb.jpg"); 
