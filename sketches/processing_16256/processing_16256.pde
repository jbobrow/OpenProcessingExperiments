...
/*
"Wavy" Originally Made by Jared "BlueThen" C.
 Created on November 4, 2009. Refined and commented on November 5, 2009.
 www.bluethen.com
 
 "Wave Optimized" Advanced features added by Nate "ZombieProof"
...
void draw()
{
  ...
  for (int x = 0; x < gridSize; x++) {
    ...
    These are 2 coordinate variations for each quadrilateral.
      ...
      int halfh = (int)3*height/5-gridSize*10+(int)(boxSizeSc.getRatio()*80);
