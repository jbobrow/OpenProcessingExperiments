...
int y;
int spatie;
int stop; // variabelen achtergrond strepen (loop)
...
//  drawMonster();
  //drawMovement();
  //drawColorchangemonster();
                          //functies  
 
 for (int i = 0; i < multiMonster; i++) {
   drawMonster(60 + ( i * 80), 300);}
...
void drawMonster(int monstertjeX, int monstertjeY){
  ...
  line(monstertjeX-20, monstertjeY+40, /*p*/monstertjeX-30, /*p*/monstertjeY+80); //left leg
  line(monstertjeX+20, monstertjeY+40, /*p*/monstertjeX+30, /*p*/monstertjeY+80); //right leg

  stroke(255);
  line(monstertjeX-40, monstertjeY-95, /*p*/monstertjeX-5, /*p*/monstertjeY-50); // left antenna
  line(monstertjeX+40, monstertjeY-95, /*p*/monstertjeX+5, /*p*/monstertjeY-50); // right antenna
