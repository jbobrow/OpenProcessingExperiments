...
ellipse(260,180,40,60);
fill(0,205,0);
ellipse(245,180,10,20);
ellipse(265,180,10,20);
fill(250,230,0);
triangle(240,200,260,200,260,230);
ellipse(230,375,60,25);
ellipse(270,375,60,25);
fill(0,0,0);
triangle(340,200,370,230,340,250);
triangle(160,200,120,230,160,250);
}
}
