...
for(int k=0;k<20;k++){
 ix[k]=sin(iy[k]/50)*225+225;
   iy[k]++;
    
   
   if(k!=19&&id[k]==false&&gameover==false){
   strokeWeight(50);
   stroke(random(255),random(255),random(255));
  line(ix[k],iy[k],ix[k+1],iy[k+1]);
   }
}
noStroke();
 fill(150);
 ...
 quad(width-150,0,width,0,width,height,width-150,height);
  ...
  text("GAME",width-120,50);
  text("OVER",width-120,90);
  }
println(truer);
if(truer==20){
  textSize(40);
  ...
  text("YOU",width-110,50);
  text("WIN",width-110,90);
}
}
