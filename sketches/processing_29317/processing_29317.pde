...
Tower Defense Game made by Bryant Ng
 - Two classes and a few methods taken from Tower Defense by Tim Suglian:  http://openprocessing.org/visuals/?visualID=6459
 - Idea of making each square on the grid into an object for highlights and color.
