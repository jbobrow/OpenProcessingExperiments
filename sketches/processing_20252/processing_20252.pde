...
String activityfile = 
"http://4.bp.blogspot.com/_YN3-mOToAD0/TVDCG2HuJNI/AAAAAAAAAO4/A4liEJ9EV9c/s400/activity.png";
String deductionsfile= 
"http://1.bp.blogspot.com/_YN3-mOToAD0/TVDCA3yrawI/AAAAAAAAAOw/QLAQ3TkNLB0/s1600/deductions.png";
String earningfile =
"http://3.bp.blogspot.com/_YN3-mOToAD0/TVDBqKRM-zI/AAAAAAAAAOo/4reiuMnCfdY/s400/earnings.png";
String basicfile = 
"http://3.bp.blogspot.com/_YN3-mOToAD0/TVDA9S5_WnI/AAAAAAAAAOY/JkoGD2sF9aI/s400/basic.png";

String more_basic_file=
"http://3.bp.blogspot.com/_YN3-mOToAD0/TVDBQtQS2dI/AAAAAAAAAOg/JkPqGdYTx6w/s400/more_basic.png";
//horizontal
...
void setup(){
  ...
  activity = loadImage(activityfile);
  deductions = loadImage(deductionsfile);
  earnings = loadImage(earningfile);
  basic=loadImage(basicfile);
  more_basic = loadImage(more_basic_file);
 size(255,255,P3D);
 w=width;
 h=height;
 activity.resize(w-100,h-100);
 nowimage=createImage(activity.width,activity.height,ARGB);
basic.resize(w-100,h-100);
more_basic.resize(w-100,h-100);
earnings.resize(w-100,h-100);
 deductions.resize(w-100,h-100);
background(128); 
  int _w=0;
 int _h;
