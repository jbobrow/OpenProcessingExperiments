...
void draw(){
 ...
 if(value == true){
  ...
  beginShape();
  fill(0);
  ellipse(129, 592, 70, 70);
  fill(139, 69, 19);
  ellipse(129, 592, 40, 40);
  fill(255);
  ellipse(36, 545, 20, 20);
  ellipse(57, 545, 20, 20);
  ellipse(78, 545, 20, 20);
  ellipse(99, 545, 20, 20);
  ellipse(120, 545, 20, 20);
  fill(238, 201, 000);
  vertex(25,544);
  vertex(130,544);
  vertex(128,646);
  ...
  vertex(334, 533);
  endShape(CLOSE);
  line(235, 532, 235, 475);
  line(248, 533, 248, 475);
  line(261, 533, 261, 475);
  line(274, 533, 274, 475);
  line(287, 533, 287, 475);
  line(300, 533, 300, 475);
  line(313, 533, 313, 475);
  //line(335, 516, 248, 520);
  line(324, 533, 325, 475);
  //line(287, 499, 335, 497); 
  }
