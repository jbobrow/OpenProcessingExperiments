...
void setup(){
   ...
   d = loadImage("yourownway.png");
   e = loadImage("exploreotherpaths.png");
   f = loadImage("yourownway.png");
...
void draw(){
 ...
 image(i, 480, 37, i.width/3, i.height/3); 
  ...
  if (opacitya == 255){
     bg = loadImage("backgroundempty.jpg");
   } else if(opacityb == 255){
     bg = loadImage("backgroundempty.jpg");
   } else if(opacityc == 255){
     bg = loadImage("backgroundempty.jpg");
   } else if(opacityd == 255){
     bg = loadImage("backgroundempty.jpg");
   } else if(opacitye == 255){
     bg = loadImage("backgroundempty.jpg");
   } else if(opacityf == 255){
     bg = loadImage("backgroundempty.jpg");
   } else if(opacityg == 255){
     bg = loadImage("backgroundempty.jpg");
   } else if(opacityh == 255){
     bg = loadImage("backgroundempty.jpg");
   } else if(opacityi == 255){
     bg = loadImage("backgroundempty.jpg");
     } else { bg = loadImage("background.jpg");
}
