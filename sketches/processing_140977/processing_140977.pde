...
void keyPressed()
{
  ...
  {
    isUpDown = true;
    myplayer.sprite.setAnimation(0, 2, true);
  }

  if (key == 's' || key == 'S')
  {
    isDownDown = true;
    myplayer.sprite.setAnimation(3, 5, true);
  }
  ...
  {
    isRightDown = true;
    myplayer.sprite.setAnimation(9, 10, true);
  }
}
...
void keyReleased()
{
  ...
  {
    isUpDown = false;
    myplayer.sprite.setAnimation(2, 2, true);
  }

  if (key == 's' || key == 'S')
  {
    isDownDown = false;
    myplayer.sprite.setAnimation(5, 5, true);
  }

  if (key == 'a' || key == 'A')
  {
    isLeftDown = false;
    myplayer.sprite.setAnimation (16,16, true);
  }
  
  if (key == 'd' || key == 'D')
  {
    isRightDown = false;
    myplayer.sprite.setAnimation(15, 15, true);
  }
...
class ScratchEnemy
{
  ...
  boolean efaceLeft = false;
  boolean efaceRight = false;
  boolean efaceUp = false;
  boolean efaceDown = false;
