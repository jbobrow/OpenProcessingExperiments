...
void draw () {
  ...
  if (sPosition <= cPosition && sPosition >= cPosition + 10) {
  ...
  if (((xFireBall <= (cPosition + 150)) && (xFireBall >= (cPosition - 150)) && (yFireBall >= 580)) && (yFireBall <= 590) && ghastHealth > 0) {
    gameOver = gameOver + 1;
    cPosition = 700000;
  }
  ...
  if (ghastHealth < 1)
  {
    gxPos = -1000000;
    pmPos = 100000;
    if ((cPosition <= 650) && (sPosition > 10000)) {
