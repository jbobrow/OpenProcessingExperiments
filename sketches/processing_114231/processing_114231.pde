...
//fill color_curve
  ...
  noStroke(0);
  beginShape();
  vertex(mouseX+32,mouseY-9);
  bezierVertex(mouseX-2,mouseY-24,mouseX-63,mouseY-1,mouseX-55,mouseY+39);
  bezierVertex(mouseX-44,mouseY+55,mouseX-19,mouseY+53,mouseX-4,mouseY+41);
  bezierVertex(mouseX+11,mouseY+31,mouseX+18,mouseY+18,mouseX+8,mouseY);
  endShape();
...
//Line only
 ...
 float p=random(180);
  ...
  bezierVertex(sin(p)+39,sin(p)+676,sin(p)+141,sin(p)+662,sin(p)+221,sin(p)+593);//point
  bezierVertex(mouseX+97,mouseY+27,mouseX+99,mouseY-31,mouseX+61,mouseY-36);//point
