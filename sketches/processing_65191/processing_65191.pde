...
//authors: Doro Schwartzmann & Julia Längert
//Dozent: Steffen Klaue
// HTW Berlin - SoSe 2012

//Diese Visualisierung stellt grafisch dar, welche Länder welchen Anteil ihrer Nahrungsmittelproduktion ungenutzt wegwerfen.
//
...
void setup() {
  ...
  drawData("6_karte.png", "Südasien.txt", "Europa1.txt", 1, farbwahlbild);
