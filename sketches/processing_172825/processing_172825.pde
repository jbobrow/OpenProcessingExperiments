...
int ballSpeedX = 7;     // speed of the ball horizontally
int ballSpeedY = 7;     // speed of the ball vertically
int paddleHeight = 20;  // height of the paddle
...
void draw() {
  background(17,191,240); // resets the background
...
void drawPaddle() {
  ...
  fill(255,0,0);
  rect(mouseX, height-paddleHeight-4, 125, paddleHeight);
}
