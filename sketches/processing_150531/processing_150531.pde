...
void draw(){
 ...
 update(); 
  ...
  text("Leyenda teclado: ", -250, 350);
  text("c - Cambiar de caso ", -150, 400);
  text("i - Inicializar escena ", -150, 430);
  text("'+' / '-' Modificar velocidad lineal ", -150, 460);
  text("espacio - Detener la bola (v.lineal = 0)", -150, 490);
  popMatrix(); 
