...
PImage caledonia;
PImage carlingview;
PImage dufferinNorth;
PImage forestHill;
PImage highway27;
PImage islingtonNorth;
PImage keeleNorth;
PImage kiplingNorth;
PImage leaside;
PImage mountDennis;
PImage mtPleasant;
PImage oakwood;
PImage ontarioScienceC;
PImage pearson;
PImage royalYorkNorth;
PImage scarlettRoad;
PImage sunnybrook;
PImage victoriaParkNorth;

//downtown releif line
PImage carlaw;
PImage dufferinSouth;
PImage exhibition;
PImage fortYork;
PImage gerrard;
PImage jameson;
...
//eglinton line
  avenue = loadImage("Avenue.jpg");
  caledonia = loadImage("Caledonia.jpg");
  carlingview = loadImage("Carlingview.jpg");
  dufferinNorth = loadImage("Dufferin North.jpg");
  forestHill = loadImage("Forest Hill.jpg");
  highway27 = loadImage("Highway 27.jpg");
  islingtonNorth = loadImage("Islington North.jpg");
  keeleNorth = loadImage("Keele North.jpg");
  kiplingNorth = loadImage("Kipling North.jpg");
  leaside = loadImage("Leaside.jpg");
  mountDennis = loadImage("Mount Dennis.jpg");
  mtPleasant = loadImage("Mt Pleasant.jpg");
  oakwood = loadImage("Oakwood.jpg");
  ontarioScienceC = loadImage("Ontario Science Centre.jpg");
  pearson = loadImage("Pearson.jpg");
  royalYorkNorth = loadImage("Royal York North.jpg");
  scarlettRoad = loadImage("Scarlett Road.jpg");
  sunnybrook = loadImage("Sunnybrook.jpg");
  victoriaParkNorth = loadImage("Victoria Park North.jpg");
  
  //downtown releif line
  carlaw = loadImage("Carlaw.jpg");
  dufferinSouth = loadImage("Dufferin South.jpg");
  exhibition = loadImage("Exhibition.jpg");
  fortYork = loadImage("Fort York.jpg");
  gerrard = loadImage("Gerrard.jpg");
  jameson = loadImage("Jameson.jpg");
  parliament = loadImage("Parliament.jpg");
  queenEast = loadImage("Queen East.jpg");
  roncesvalles = loadImage("Roncesvalles.jpg");
  sherbourneSouth = loadImage("Sherbourne South.jpg");
  spadinaSouth = loadImage("Spadina South.jpg");
...
//    rect(0, height/2, width, height/2);
    ...
    image(roncesvalles, 214, 508, 1585, 400);
...
//    rect(0, height/2, width, height/2);
    ...
    image(jameson, 214, 508, 1585, 400);
...
//    rect(0, height/2, width, height/2);
    ...
    image(dufferinSouth, 214, 508, 1585, 400);;
...
//    rect(0, height/2, width, height/2);
    ...
    image(exhibition, 214, 508, 1585, 400);
...
//    rect(0, height/2, width, height/2);
    ...
    image(fortYork, 214, 508, 1585, 400);
...
//    image(bathurstSouth, 214, 508, 1585, 400);
...
//    rect(0, height/2, width, height/2);
    ...
    image(spadinaSouth, 214, 508, 1585, 400);
...
//    rect(0, height/2, width, height/2);
    ...
    image(parliament, 214, 508, 1585, 400);
    println("Parliament Station"); 
  }  
  else{
//    fill(255, 0, 13);
//    strokeWeight(0);
//    rect(0, height/2, width, height/2);
    ...
    image(sherbourneSouth, 214, 508, 1585, 400);
...
//    rect(0, height/2, width, height/2);
    ...
    image(queenEast, 214, 508, 1585, 400);
...
//    rect(0, height/2, width, height/2);
    ...
    image(gerrard, 214, 508, 1585, 400);
