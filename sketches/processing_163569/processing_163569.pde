...
float PI, Peso;  //Declaración de variables: Peso y PI son números reales
...
if (Peso > PI) {println ("Por tu salud es necesario que pierdas peso");}
else           {println ("Es importante que ganes peso");}
