...
void cutscene0(){
  image(fons1, 0, 0);
  textFont("Comic Sans MS",18);
  fill(#000000);
  textAlign(LEFT);  
  text("La humanidad siempre ha querido saber si hay vida mas allá de nuestro planeta, hace", 60,140);
  text("poco se avistaron OVNIS en los cielos terrícolas y la gente comenzó a ser abducida para",60,155);
  text("los propósitos científicos y curiosos de los aliens. Tú eres uno de esos abducidos y eres",60,170); 
  text("el único que ha conseguido escapar de la nave con vida. Debido a los experimentos que",60,185);
  text("los alienigenas hicieron con tu cuerpo, ahora tienes poderes para combatirlos. Al caer de",60,200);
  text("la nave, pierdes el conocimiento y, al despertarte, te encuentras en un desierto.",60,215);
}
...
void cutscene1(){
  ...
  fill(#000000);
  textAlign(LEFT);  
  text("Cuando llegas a la ciudad, te la encuentras destruida por los ataques alienígenas.", 90,320);
}
...
void cutscene3(){
  ...
  textFont("Comic Sans MS",18);
  fill(#000000);
  text("Cuando llegas a la parte más alta del volcán, te encuentras con la nave de los alienigenas.", 40,20);
}
