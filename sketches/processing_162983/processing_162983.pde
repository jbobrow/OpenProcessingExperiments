...
//each line has several "dots" being created by the for loop.
...
//so that every dot has in fact an unique "x" value and a "y" value.
//however, the "if" statement contained within the dot function doesn't seem to work as intended.
