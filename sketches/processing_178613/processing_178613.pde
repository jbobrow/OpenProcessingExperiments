...
String allwords ="WorkIt Harder MakeIt Better DoIt Faster MakesUs Stronger MoreThan Ever Hour After Our WorkIs Never Over";
...
void runP(){
  for (particle P : Points) {
    stroke(random(255), random(255), random(255) ,128/sqrt(P.velocity.mag()+1));
