...
void draw()
{
  ...
  fill(255, 255, 0);
  rect(ObjectiveX, ObjectiveY, 10, 10);
  rect(ObjectiveX2, ObjectiveY2, 10, 10);
  rect(ObjectiveX3, ObjectiveY3, 10, 10);
  rect(ObjectiveX4, ObjectiveY4, 10, 10);
  rect(ObjectiveX5, ObjectiveY5, 10, 10);
  rect(ObjectiveX6, ObjectiveY6, 10, 10);
  rect(ObjectiveX7, ObjectiveY7, 10, 10);
  rect(ObjectiveX8, ObjectiveY8, 10, 10);
  rect(ObjectiveX9, ObjectiveY9, 10, 10);
  rect(ObjectiveX10, ObjectiveY10, 10, 10);
  rect(ObjectiveX11, ObjectiveY11, 10, 10);
  rect(ObjectiveX12, ObjectiveY12, 10, 10);
  rect(ObjectiveX13, ObjectiveY13, 10, 10);
  rect(ObjectiveX14, ObjectiveY14, 10, 10);
  ...
  rect(ObjectiveX20, ObjectiveY20, 10, 10);
  fill(255,0,0);
  ...
  ellipse(enemyx6, enemyY6, 20, 20);
  ellipse(enemyx7, enemyY7, 20, 20);
  ellipse(enemyx8, enemyY8, 20, 20);
  ellipse(enemyx9, enemyY9, 20, 20);
