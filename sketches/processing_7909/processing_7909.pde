...
int bailout = int(sqrt(random(sq(5),sq(2000))));   // number of iterations before bail ...... 4000, 200, 10 for Nebula
...
float J = pow(random(-0.8,0.8),3);
float K = pow(random(-0.8,0.8),3);
...
float xMin = -0.25-1.75;
float xMax = -0.25+1.75;
float yMin = 0-1.75;
float yMax = 0+1.75;
