...
void setup(){
  size(800,1200);
  background(255);
  ringpop = loadImage("ringpop.jpg");
  ringpop2 = loadImage("ringpop2.jpg");
   ...
   //P112  
    for (int i = 0;i<25;i++){
      pushMatrix();
        translate(i*50,120);
        if(i%2 == 0){
          imageFlip(ringpop2,50,0,"v");
        } else {
          rotate(radians(180));
          imageFlip(ringpop2,0,-50,"v");
        }
      popMatrix();
    }
