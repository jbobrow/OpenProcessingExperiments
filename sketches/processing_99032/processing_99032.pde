...
// Paddle Ball
// Ball bouncing game, with paddle, score count, Background & moving cirlce distractions
// Everytime the paddle hits the ball it becomes smaller

// PImage bg;    // Data type for storing images made comment because i can't upload the background image
...
void setup ()
{
  ...
  // bg = loadImage("background.jpeg");  // Background image loacated in folder, commented because i can't upload the image
} 
...
void draw ()
{  
  // background(bg);  // Call background, commented because i can't upload the background image
  background(0); 
