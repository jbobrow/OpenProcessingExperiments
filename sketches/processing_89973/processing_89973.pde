...
void setup() {
  ...
  // fontSize(x); 
  //  textFont (createFont("CenturyGothic", 50));
...
if (mouseX >= 100 && mouseX <= 300 && mouseY >= 100 && mouseY <= 410) {
  ...
  fill (napRed); // now i've assigned these colour values i can change these.
