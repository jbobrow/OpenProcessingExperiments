...
void draw(){
  imageFlip(slug,100,100,"v2");
    imageFlip(slug,200,100,"v2");  
    imageFlip(slug,mouseX,mouseY,"v2");  
    imageFlip(slug,400,100,"v2");
    imageFlip(slug,500,100,"v2"); 
    imageFlip(slug,600,100,"v2");  
    imageFlip(slug,700,100,"v2"); 
    imageFlip(slug,800,100,"v2");
    imageFlip(slug,mouseX,mouseY,"h2");
    imageFlip(slug,0,500,"v2");
    imageFlip(slug,600,500,"v2");
