...
void setup() {
  ...
  smooth();
  frameRate(10);
  img1=loadImage("clfqjs.png");
  img2=loadImage("vkfqjs.png");
  img3=loadImage("ckdqjs.png");
  img4=loadImage("rnqjs.png");
}
...
void draw() {
  ...
  if (card == 0) {   
    ...
    pushMatrix();
      PShape alone;
    alone = loadShape("alone.svg");
    shape(alone,-70,80);
      PShape dlf;
    dlf = loadShape("dlf.svg");
    shape(dlf,495,170);
     PShape dlfy;
    dlfy = loadShape("dlfy.svg");
    shape(dlfy,300,50);
      PShape dlfn;
    dlfn = loadShape("dlfn.svg");
    shape(dlfn,280,100); 
    noFill();
    noStroke();  
    rect (m,n,b,v);
    ...
    pushMatrix();
    //her(130,220,0.75);
    her(130,220,0.75,int(random(130,220)), int(random(130,220)));
    popMatrix();
    pushMatrix();
    boy(380,130,0.85);
    popMatrix();
 ...
 PShape mmm;
    ...
    text(time,130,180);
    PShape nono;
    nono = loadShape("nono.svg");
    shape(nono,480,-80);
    pushMatrix();
    PShape n;
    n = loadShape("bgg.svg");
    translate(mouseX, mouseY);
    shape(n,-250,-250,250,250);
    noCursor();
    popMatrix();
  }
  else if (card  == 3) { 
  ...
  if (card == 7) {  
    image(img1,-3,-3,803,603);
    noFill();
    noStroke();
    rect (x,y,w,h);
  }
    if (card == 8) {  
    image(img2,-3,-3,803,603);
    noFill();
    noStroke();
    rect (x,y,w,h);
    }
    if (card == 9) {  
    image(img3,-3,-3,803,603);
    noFill();
    noStroke();
    rect (x,y,w,h);
      }
      if (card == 10) {  
    image(img4,-3,-3,803,603);
    noFill();
    noStroke();
    rect (x,y,w,h);
    rect (m,n,b,v);
...
void mousePressed() {  
  ...
  if (card == 0) {  
    ...
    else if((mouseX > m) && (mouseX < m + b) && (mouseY > n) && (mouseY < n+ v)){
      card = 7;
    } 
     else if((mouseX > l) && (mouseX < l+j) && (mouseY > k) && (mouseY < k+u)){
      card = 10;
    } 
    else card = 0;
  }
    ...
    if((mouseX > x) && (mouseX < x + w) && (mouseY > y) && (mouseY < y+ h)) {
     ...
     if((mouseX > m) && (mouseX < m + b) && (mouseY > n) && (mouseY < n+ v)){
      card = 9;
    } 
     else if((mouseX > l) && (mouseX < l+j) && (mouseY > k) && (mouseY < k+u)){
      card = 1;
