...
float raggio1 = 192;  // lunghezza del 1° segmento 
float raggio2 = 96;   // lunghezza del 2° segmento
float raggio3 = 48;   // lunghezza del 3° segmento
float raggio4 = 24;   // lunghezza del 4° segmento



float passoAngolo1 = PI/550;  // velocita' di rotazione del 1° segmento
float passoAngolo2 = PI/150;  // velocita' di rotazione del 2° segmento
float passoAngolo3 = PI/80;   // velocita' di rotazione del 3° segmento
float passoAngolo4 = PI/5;    // velocita' di rotazione del 4° segmento
