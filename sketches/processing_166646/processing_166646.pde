...
void draw()
{
  ...
  case 3:
    ...
    textFont(font, 40);
    text("You bastard! You killed Kenny!", (width/2), (height/2) - 40);
    fill(255);
    textFont(font, 20);
    text("LMB to restart", width/2, height/2);
    textFont(font, 10);
    text("PROTIP: If your taking damage, hide in cover to not die", width/2, height/2 + 100);
  ...
  case 1:
    ...
    text("Kenny The Worm", width/2, height/2 - 80);

    textFont(font, 16);
    fill(255);
    text("Move mouse to move worm!", 
    width/2, height/2);
    text("Pick up the green squares for bonus points.", 
    width/2, height/2 + 20);

    textFont(font, 10);
    text("LMB To start", width/2, height/2 + 80);
