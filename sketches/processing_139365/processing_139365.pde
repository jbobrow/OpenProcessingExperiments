...
void draw(){
  ...
  time= (millis()-m)/1000;
  rect(200, 20, (max(0,vida)/1)*100, 20);
  text(vida+"/3", 510, 35);
  text("Tiempo Restante: " + (60-time), 50, 30);
  strokeWeight(5);
  fill(255,0,0);
...
void redo(){
  ...
  for (int i = 0; i < calle1.length;i++){
    calle1[i] = new Enemigos(random(-100, 0), height*0.75, random(1,pantalla/3), color (random(255),random(255),random(255)));
  }
  for (int i = 0; i < calle1.length;i++){
    calle2[i] = new Enemigos(random(-100, 0), height*0.85, random(1,pantalla/3), color (random(255),random(255),random(255)));
  }
  for (int i = 0; i < calle1.length;i++){
    calle3[i] = new Enemigos(random(-100, 0), height*0.95, random(1,pantalla/3), color (random(255),random(255),random(255)));
  }
}
class Equacio{
  String pregunta;
