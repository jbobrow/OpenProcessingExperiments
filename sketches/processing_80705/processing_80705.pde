...
/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/60994*@* */
...
color col = color(203,76,66);
float lineModuleSize =20;
float angle = 5;
...
void keyReleased() {
  ...
  if (key == '1') col = color(203,108,66);
  if (key == '2') col = color(203,66,66);
  if (key == '3') col = color(203,156,66);
  if (key == '4') col = color(230,206,71);
