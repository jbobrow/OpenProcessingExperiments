...
String input = "rattle";  // der eingegebene text
float spacing = 60;
...
void rLine ( float x1, float y1, float x2, float y2 )
{
    ...
    line(random(5)+x1, random(5)+y1, random(5)+x2, random(5)+y2);
    line(random(5)+x1, random(5)+y1, random(5)+x2, random(5)+y2);
    line(random(10)+x1, random(10)+y1, random(10)+x2, random(10)+y2);
    line(random(-10)+x1, random(-10)+y1, random(-10)+x2, random(-10)+y2);
    line(random(20)+x1, random(20)+y1, random(20)+x2, random(20)+y2);
    line(random(-20)+x1, random(-20)+y1, random(-20)+x2, random(-20)+y2);
    line(random(30)+x1, random(30)+y1, random(30)+x2, random(30)+y2);
}
