...
void draw () { 
  ...
  if (i < 25) {
    ...
    rmin = (rmin + random (0, 120)) / 2;
    gmin = (gmin + random (0, 120)) / 2;
    bmin = (bmin + random (0, 120)) / 2;
    rmax = (rmax + random (150, 295)) / 2;
    gmax = (gmax + random (150, 295)) / 2;
    bmax = (bmax + random (150, 295)) / 2;
  }
  ...
  rect(820, 0, 20 , 840);
  fill(255, 255, 255);
  text ("move cursor to explore pattern :    x = " + subX + " / " + submaxX +"    -    y = " + subY + " / "+ submaxY +"             rgb   "+(int)rmax+"   "+(int)gmax+"   "+(int)bmax, 15 , 16);
