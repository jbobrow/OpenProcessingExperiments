...
void setup()
{
     ...
     circleOne = new PoppingCircle(random(440),random(800));
     circleTwo = new PoppingCircle(random(440),random(800));
     circleThree = new PoppingCircle(random(440),random(800));
     circleFour = new PoppingCircle(random(440),random(800));
     circleFive = new PoppingCircle(random(440),random(800));
}
