...
void draw() {
  ...
  textSize(16);
  text(dogs[idx].breed, x+margin, plotHeight+(margin*1.5));
  ...
  pushMatrix();
   fill(#434343);
   textSize(14);
  translate( x-margin, plotHeight/2);
  rotate(-PI/2);
  text("Number of incidents in 2011",0,0);
  ...
  if (dist(mouseX, mouseY, x, margin+plotHeight)<50) {
    fill(#FF0000);
    text(dogs[idx].attacks, x,margin+plotHeight-dataPoint );
  }
  ...
  if (dist(mouseX, mouseY, x, margin+plotHeight)<50) {
    fill(#FF0000);
    text(dogs[idx].children, x, margin+plotHeight-dataPoint );
  } 
  ...
  if (dist(mouseX, mouseY, x, margin+plotHeight)<50) {
    fill(#FF0000);
    text(dogs[idx].adults, x, margin+plotHeight-dataPoint );
  }
  ...
  if (dist(mouseX, mouseY, x, margin+plotHeight)<50) {
    fill(#FF0000);
    text(dogs[idx].deaths, x, margin+plotHeight-dataPoint);
  }
  ...
  if (dist(mouseX, mouseY, x, margin+plotHeight+margin/5)<25) {
    fill(#FF0000);
    text(dogs[idx].maining, x,margin+plotHeight-dataPoint );
  }
