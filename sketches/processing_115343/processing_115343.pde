...
stroke(0,0,0);
fill(63,196,77);
ellipse(900,mouseY,350,350);
fill(255,3,3);
ellipse(900,mouseY,275,275);
fill(255,247,0);
ellipse(900,mouseY,200,200);
fill(0,0,0);
ellipse(900,mouseY,150,150);
fill(37,0,255);
ellipse(900,mouseY,100,100);
fill(15,108,69);
ellipse(900,mouseY,50,50);
...
fill(0);
ellipse(900,mouseY,10,400);
ellipse(900,mouseY,400,10);
