...
/* @pjs preload="prueba.png","logo.png","imagenes.png","Texto.png","TexDer.png","TexIzq.png","TextCent.png","Almohada.png","Cama.png","Cocina.png","Comida.png","Computador.png","Ducha.png","Fiesta.png","llave.png","Puerta.png","Ropa.png","Sofa.png"; font="Hashtag.ttf"; */
...
void setup() {
  ...
  saves =  new Butons ("Texto.png", 64, 600);
...
void keyPressed() {
  for (int i = 0; i <imagenes.size(); i++) { 
    Images imagenn = (Images) imagenes.get(i);
    if ((imagenn.isActive())&&(keyCode== BACKSPACE))
      imagenes.remove(i);
  }
