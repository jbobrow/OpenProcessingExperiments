 ...
 * zwei Gitter die sich überlagern
 * an- und ausschalten mit Mausklick
 *
 */
  
int numZelles1 = int(random(11,21));
int numZelles2 = numZelles1 + int(random(0,6));
...
void setup() 
{
  ...
  colorMode(HSB, 255);
  col01 = random(255);
  col02 = random(200,255);
  col03 = random(200,255);
  ...
  for (int i = 0; i < numZelles1; i++) {
    ...
    Zelle1[numZelles1*i+j] = new Zelle(i*rad1,j*rad1, hrad1, numZelles1*i+j, 0,0.1, Zelle1);
    }
  }
  for (int i = 0; i < numZelles2; i++) {
    ...
    // Zelle2[numZelles2*i+j] = new Zelleb(i*rad2,j*rad2, hrad2, numZelles1*i+j, random(6.28),random(0.1), Zelle2);
    Zelle2[numZelles2*i+j] = new Zelleb(i*rad2,j*rad2, hrad2, numZelles1*i+j, 0 ,0 , Zelle2);
    }
  }
}
...
class Zelle {
  ...
  void change_st() {
    ...
    // set colors
    col01 = (2*id-0.05*winkel+mouseY)%255;
    // col02 = random(255);
    // col03 = random(255);
...
class Zelleb {
  ...
  void change_st() {
    ...
    // set colors
    col01 = (2*id+0.1*winkel+mouseX)%255;
    // col02 = 125;
    // col03 = 125;
