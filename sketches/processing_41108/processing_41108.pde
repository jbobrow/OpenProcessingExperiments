...
void draw() {
  ...
  fill(0, 255, 255, 255);
  noStroke();
  // ellipse (mouseX-15, mouseY, 10, 20); 
  // ellipse (mouseX+15, mouseY, 10, 20);
  ...
  ellipse (mouseX+13, mouseY, 5, 10); // To put the mouse cursor in between the two eyes. (Window size = 300 pix width / 2 = 150 pix. ellipseMode(CENTER). The center of the eye-ellipse = 163, 163 - 150 = +13)
