...
float posicioX = 300;
float posicioY = 100;
//el signe de la velocitat el farà anar a la dreta o a l'esquerra
float velocitatX = random(5,10); //-20 faria que anés a l'esquerra
...
//POSICIONS
  ...
  if(posicioX + sz/2 >= width||posicioX - sz/2 <= 0){   //condició                                                                                                                                                                                            
  velocitatX = -velocitatX; //canviar la direcció
  }
