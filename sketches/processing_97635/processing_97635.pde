  ...
  public void initSort(){
    ...
    for(int i = 0; i < list_size; i++){
      list[i] = stock.remove((int)random(0, stock.size()));
    }
    
    switch(sort_cursor){
    case 0: sort = new BubbleSort();
      break;
    case 1: if(!(sort instanceof BogoSort)) sort = new BogoSort();
      break;
    case 2: sort = new SelectionSort();
      break;
    case 3: sort = new HeapSort();
      break;
    }
  }
