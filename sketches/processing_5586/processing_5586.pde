...
PImage img, i,man, b, m, sans, stache, a, ah, c, f, hearts, ac,h, sexy, NO, NOsmall, sunrise; //background, head, man, boots, mad face, sans mustache, mans stache, accusations
...
//IMAGES (head and man)
 // sunrise = loadImage ("alley_sunrise.png"); //sunrise background
  ...
  s = loadShape ("robotfinal.svg");// regular head
