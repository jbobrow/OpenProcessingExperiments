...
void setup() {
  size(800,500);
  img = loadImage("http://www.wall321.com/thumbnails/detail/20120313/mario%201680x1050%20wallpaper_www.wall321.com_88.jpg"); //bg
  ...
  img6 = loadImage("http://sio.midco.net/kvwesten/tutorials/sprite%20tut/index_files/image004.gif"); //boo
