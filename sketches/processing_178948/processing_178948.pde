...
float raggio1 = 150;  // lunghezza del 1° segmento 
float raggio2 = 100;   // lunghezza del 2° segmento
float raggio3 = 30;   // lunghezza del 3° segmento
float raggio4 = 10;   // lunghezza del 4° segmento

float passoAngolo1 = PI/600;  // velocita' di rotazione del 1° segmento
...
float passoAngolo4 = PI/10;    // velocita' di rotazione del 4° segmento
 
 color arancione = color(30, 100, 100);
color azzurro = color(200,100,100);
...
void draw () 
{
  ...
  //   eventualmente con colori diversi
    ...
    color middlecolor = lerpColor (arancione, azzurro,  sin(angolo3)*0.5+0.5);
  stroke (middlecolor, 50);
