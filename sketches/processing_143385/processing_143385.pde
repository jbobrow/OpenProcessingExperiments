...
//PFont font = loadFont("/Users/Kyosuke/Dropbox/Processing/kraftwerk/fontmaking/data/Serif-50.vlw");
...
void setup() {
  ...
  //textFont(font, 80);
  textSize(80);
  text("Hello, I am", 20, height/2-65);
  text("sosososoooon", 20, height/2+40);
