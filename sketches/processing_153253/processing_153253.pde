...
void draw() {
  ...
  endShape(CLOSE);
  line((xsum/x.length)-10, (ysum/y.length), (xsum/x.length)+10, 
  (ysum/y.length));  
  line((xsum/x.length), (ysum/y.length)-10, (xsum/x.length), 
  (ysum/y.length)+10);       
  fill(0);
  stroke(0);
  ellipse(135, 60, 5, 5);
  ...
  beginShape();
  vertex(140, 80);
  bezierVertex(140, 90, 155, 90, 155, 80);
  bezierVertex(155, 90, 170, 90, 170, 80);
  endShape();
  noLoop();
}
