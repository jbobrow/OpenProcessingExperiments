...
void shield() {
  ...
  text("The gods have blessed you with "+heal+ " health!",20,370,450,450);
}
...
void light() {
  ...
  int dmg=charge*5;
   fill(0, 102, 153);
  text("You absorbed some sunlight and sent a beam of light at the enemy. Your charge has increased by one and you did "+dmg+" damage!",20,370,450,450);
}
...
void pillar() {
  ...
  if (random(4)<1) {
    eHP= eHP-30;
    dmg=dmg+30;
    text("CRIT",20,350,450,450);
    }
    eHP=eHP-10;
  dmg=dmg+10;
  text("A pillar comes out of the ground to pierce your enemy! You inflicted "+ dmg + " damage!",20,370,450,450);
}
...
void lance() {
  ...
  eHP=eHP-dmg;
  charge=0;
  text("You used all your charges for an attack and did "+dmg+" damage!",20,370,450,450);
}
...
void attack1() {
  ...
  text("You got whacked really hard and took 20 damage",20,420,450,450);
}
void attack2() {
  int rage = 100-eHP;
  int dmg=(rage/2);
  ...
  line(160, 320, 40, 320);
  line(40, 320, 40, 70);
  text("The enemy raged at you for doing damage and did "+dmg +" damage!",20,420,450,450);
}
void attack3() {
  ...
  text("The enemy sent a bomb with size "+size+" and inflicted "+dmg+" damage!",20,420,450,450);
}
void attack4() {
  int heal=0;
  ...
  text("The enemy used GRAND HEALING and healed "+heal+" HP!",20,420,450,450);
}
