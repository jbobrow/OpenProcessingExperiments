...
void setup()
{
  ...
  displayImage = requestImage("final game back.png"); //All other graphics are from RPG Maker VX Ace
  collisionMap = requestImage("detail final game2.png");
  back = requestImage("final game iback.png"); //Galaxy Background made by me.
