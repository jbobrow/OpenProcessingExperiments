...
/*
I have developed it from your example, but I have changed a few things including colour and sizes. 
*/
class firework
{
  int count  = 50;
  ...
  firework()
  {
    ...
    float angle = random(PI/2, PI*2/3);
