...
void setup()
{
  ...
  = level[20][8] = level[21][8] = level[0][9] = level[1][9] = level[7][9] ='w';
  ...
  if (state == 2)  //play state
  {
   ...
   //draw noclips
    ...
    if (collected_rays == 51)
    {
      ...
      level[10][8] = level[12][8] = level[16][8] = level[0][9] = level[1][9] = level[2][9] = level[3][9] = level[4][9] = level[5][9] = level[16][9] = 'w';
    ...
    if (collected_rays == 33)
    {
     ...
     level[15][6] = level[16][6] = level[17][6] = level[18][6] = level[19][6] = level[20][6] = level[21][6] = level[0][7] = level[7][7] = level[9][7] = level[14][7] = 
      level[0][8] = level[9][8] = level[14][8] = level[0][9] = level[9][9] = 'w';
...
void keyPressed()
{
  ...
  if (key == 'm' && alive == false && collected_rays > 52 && collected_rays <= 33)
  {
    loop();
    collected_rays = 52;
    alive = true;
