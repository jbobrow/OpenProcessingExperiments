...
PFont fuente01,fuente02,fuente03;
...
void setup(){
  ...
  wlogo = logo.width;
  hlogo = logo.height;
  fuente01 = createFont("HelveticaNeueLTPro-Bd.otf",19);
  fuente02 = createFont("HelveticaNeueLTPro-ThEx.otf",14);
  fuente03 = createFont("HelveticaNeueLTPro-MdEx.otf",14);
}
