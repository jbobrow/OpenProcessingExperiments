...
void draw() {
  ...
  float xAverage = xSum/x.length;
  float yAverage = ySum/y.length;

  strokeWeight(2);
  stroke(255);
  line (xAverage-10, yAverage, xAverage+10, yAverage);
  line (xAverage, yAverage+10, xAverage, yAverage-10);
}
