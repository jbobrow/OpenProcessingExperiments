...
void draw()
{
 ...
 //the arcs that join the line...
 fill(#FFFFFF);
 arc(185,185,80,80,0,HALF_PI,CHORD);
 arc(175,175,80,80,0,HALF_PI,CHORD);
 arc(165,165,80,80,0,HALF_PI,CHORD);
 arc(155,155,80,80,0,HALF_PI,CHORD);
 
 arc(485,485,80,80,0,HALF_PI,CHORD);
 arc(495,495,80,80,0,HALF_PI,CHORD);
 arc(555,555,80,80,HALF_PI,TWO_PI,CHORD);
 fill(#000000);
