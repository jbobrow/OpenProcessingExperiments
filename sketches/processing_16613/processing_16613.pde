...
//back wave  
  ...
  quad(0, 340,   (x), 340,     (mouseX-200), 120,   0, 120);
    fill(255);  
  quad(  x-(x/3), 340,   (x), 340,     (mouseX-190), 120,    (mouseX-200), 120);  
  endShape();
 ...
 //   quad(x, 340,   (x-175), 340,     (w-105), 480,    w, 480);
  ellipse((y), 290, 40, 40);
    ellipse((y), 250, 30, 30);
     ...
     //topvvv
    ellipse(((mouseX-210)+x/30), 120, 5, 5);
      ellipse(((mouseX-210)+y/30), 123, 6, 6);
          ellipse(((mouseX-205)+z/30), 130, 7, 7);
     ellipse(((mouseX-210)+z/25), 125, 6, 6);
       ellipse(((mouseX-205)+z/35), 125, 8, 8);
            ellipse(((mouseX-197)+w/20), 132, 10, 10);
       ellipse(((mouseX -193) +w/25), 135, 9, 9);
           ellipse(((mouseX - 205) +(x+10)/20), 138, 10, 10);
     ellipse(((mouseX - 205)+w/20), 139, 12, 12);
      ellipse(((mouseX -203) +y/15), 141, 14, 14);
       
         ellipse(((mouseX - 200) + y/10), 145, 15, 15);
   ellipse(((mouseX - 220)+x/11), 144, 10, 10);
     ellipse(((mouseX-190)+w/15), 149, 10, 10);
    ellipse(((mouseX-200)+y/10), 155, 20, 20);
       ellipse(((mouseX -200)+x/13), 165, 17, 17);
            ellipse(((mouseX-220)+x/13), 155, 20, 20);
     ellipse(((mouseX-190)+z/15), 175, 25, 25);
       ellipse(((mouseX-200)+w/13), 167, 20, 20);
            ellipse(((mouseX-215)+x/15), 177, 25, 25);
      ellipse(((mouseX-170)+y/10), 190, 40, 40);
          ellipse(((mouseX-190)+w/18), 195, 35, 35);
     ellipse(((mouseX-170)+y/7), 190, 20, 20);
       ellipse(((mouseX-250)+y/7), 190, 30, 30);
       
              ellipse(((mouseX-250)+x/7), 205, 50, 50);
    ellipse(((mouseX-265)+w/7), 215, 60, 60);
    ellipse((x-200), 220, 65, 65);
     ellipse((x-100), 250, 40, 40);
       ellipse((y-50), 200, 30, 30);
          ellipse((z-230), 210, 25, 25);
    ellipse((z-308), 220, 20, 20);
       ellipse((z-130), 230, 40, 40);
            ellipse((z-190), 200, 30,30);
       ellipse((z-180), 220, 30, 30);
...
//  fill(150, 90, 110);
 ...
 // quad(120, 320,  240, 320,  240, 240,  120, 240);
  ...
  //hair back
      fill(66, 43, 19);
  beginShape();
  quad(60, 100,   130, 120,  130, (180+(x/5)),    60, (180+(x/5)));
  endShape();
...
fill(139, 69, 19);
beginShape();
quad(44, 140,   63, 140,   63, 140+(x/5),   44, 140+(x/5));
quad(116, 140,   135, 140,   135, 140+(x/5),    116, 140+(x/5));
endShape();
