...
//this bit was adapted from code used by Chelsa Lauderdale

    for(int i = 0; i <900; i++){
      pushMatrix();
      translate(i*128,649);
      if(i%2 == 0){
        imageFlip(haddock,0,-220,"v");
      } else {
        image(haddock,0,-220);
      }
      popMatrix();
