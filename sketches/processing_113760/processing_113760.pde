...
class Creature {
  ...
  final float THRESHOLD = 60; // within this distance, reward is granted
  float vector; // angle to Reward in radians  
  float vectorX, vectorY;
  float affinity; // initial impact of reward on step length
  final float MIN_AFFINITY = 1;
  final float MAX_AFFINITY = 6;
