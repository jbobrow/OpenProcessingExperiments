...

{
  ...
  //vx=vx+0.2;
    ...
    if ((x>width-diametre/2) || (x<diametre/2)) //los símbolos || significa "o"
      {
       vx=vx*(-1);
       if (diametre>20)//si el diametro es mayor que 20, definido en 25, réstale el incremento (+15)
       {
    ...
    if ((y>height-diametre/2) || (y<diametre/2)) //los símbolos || significa "o"
      {
       vy=vy*(-1);
       if (diametre>20)//si el diametro es mayor que 20, definido en 25, restale el incremento (+15)
       {
         diametre=diametre-incremento;
       }
       else
