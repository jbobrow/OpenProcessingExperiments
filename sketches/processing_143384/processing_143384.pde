...
PFont font = loadFont("Serif-50.vlw");
color[] exColor=new color[800*300];
...
void setup() {
  ...
  textFont(font, 80);
  //textSize(80);
  text("Hello, I am", 30, height/2-65);
...
void draw() {
  ...
  stroke(255);
    ...
    }else if(PVector.dist(line.getFirstloc(),line.getLocation()) > 1){
    ...
    if(PVector.dist(line.getFirstloc(),line.getLocation()) <= 1){
  ...
  textSize(12);
  fill(100);
  text("Hello, I am Kyosuke Nakanishi. Please drag in this box.", width/2, height-20);
}
