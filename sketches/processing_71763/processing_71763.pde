...
void draw() {
  ...
  ellipse(circle, 25, 50, 50);
  ellipse(circle+35, 25, 50, 50);
  ellipse(circle, 60, 50, 50);
  ...
  ellipse(circle1-35, 110, 50, 50);
  ellipse(circle1, 145, 50, 50);
