...
int [] x = new int [300]; // this a single dimensional array with the elements of 300
int [] y = new int [300]; // this a single dimensional array with the elements of 300
int [] z = new int [300]; // this a single dimensional array with the elements of 300
...
void setup() {
  ...
  for (int i = 0; i<300; i++) { // while i is less than 300
