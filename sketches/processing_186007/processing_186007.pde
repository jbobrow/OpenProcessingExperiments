...
void setup()
{
  img = loadImage ("snark.jpg");
  currentTop = loadImage ("feo.png");
  currentBottom = loadImage ("decirecasualmente.png");
  
  outer[0] = "feo.png";      //Assign
  outer[1] = "schifiso.png";
  outer[2] = "snide.png";
  outer[3] = "sournoi.png";
  
  inner[0] = "decirecasualmente.png";
  inner[1] = "faireremarquer.png";
  inner[2] = "menzionare.png";
  inner[3] = "remark.png";
