...
void semaforox(PVector pt0) {
  ...
  linea(proietta(new PVector(pt0.x-28, 0, pt0.z)), proietta(new PVector(pt0.x-25, 5, pt0.z)));
...
void semaforoz(PVector pt0) {
  ...
  linea(proietta(new PVector(pt0.x, 4, pt0.z -2)), proietta(new PVector(pt0.x, 4, pt0.z-5)));
