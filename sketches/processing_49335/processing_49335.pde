...
//import processing.video.*;          //WEBCAM: Benötigt für die Webcamfunktion, funktioniert aber nur auf MAC
//Capture myCapture;                  // WEBCAM Aktiviert die myCapture Funktion der Kamera
...
void setup () {
  ...
  standingkonglinks = loadImage("standingkonglinks.gif");
   ...
   // WEBCAM: Kamera-aktivierung und Bestimmung der Grösse auf dem Fenster
   //myCapture = new Capture(this, 400, 400, 30);

} // end for setup


// WEBCAM: Aktiviert die Kamerafunktion und sucht sie im System
...
void draw() {
  ...
  if (counter > 19 || count > 2) {
    ...
    // image(myCapture, 200, 200);  // WEBCAM Aktiviert die Kamera nach 19 Punkte um ein Foto zu machen.
    fill(255);
    rect (0, 0, 400, 400);
    fill(0);
    text("this could be your picture", 100, 200);
