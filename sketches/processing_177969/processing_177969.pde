...
void setup()
{
  ...
  r2=new Rectangle(random(700),random(700),10,6);
  r3=new Rectangle(random(700),random(700),10,6);
  r4=new Rectangle(random(700),random(700),6,6)color(random(255),random(255),random(255));
  r5=new Rectangle(random(700),random(700),6,6,color(random(255),random(255),random(255)));
