...
/* @pjs font = "Lavanderia-Delicate-36.otf, Barkentina-48.otf"; */


size (300,300);
background(142,237,255);

//PFont lavanderia = loadFont("Lavanderia-Delicate-36.vlw");
//PFont barkentina = loadFont("Barkentina-48.vlw");

PFont font1, font2;
font1 = loadFont("Lavanderia-Delicate-36.vlw");
font2 = loadFont("Barkentina-48.vlw");
 textFont(createFont("Barketina",48));
...
fill(2,94,219);
textAlign(LEFT);
 textFont(createFont("Lavanderia-Delicate-36.vlw",48));
