...
//pixel no settei  
 ...
 //yomikonnderu gazou
  images[0] = loadImage("apple_white.png");  //image0 ni kono gazou wo dainyuu
  images[1] = loadImage("apple1.png"); 
  images[2] = loadImage("apple2.png"); 
  images[3] = loadImage("apple3.png"); 
  images[4] = loadImage("apple4.png");
  images[5] = loadImage("apple5.png");
  images[6] = loadImage("apple6.png");
  images[7] = loadImage("apple7.png");
  images[8] = loadImage("apple8.png");
  images[9] = loadImage("apple9.png");
  images[10] = loadImage("apple10.png");
  images[11] = loadImage("apple11.png");
  images[12] = loadImage("apple12.png");
  images[13] = loadImage("apple.png");
}
