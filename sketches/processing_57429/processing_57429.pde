...
//pull values out and sets the variable for the eyes
Flower ( float px, float py) {
  x = px;
  y = py;
  println ("new flower made");
}


//define the functions - things it can do
void display (){
...
fill (255);
triangle (x, y+400, x + 50, y+400, x, y +350); // left base petal
fill (255);
triangle (x +100, y + 400, x+100, y+350, x+50, y+400);//right base petal
