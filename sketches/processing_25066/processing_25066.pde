...
void setup() {
  ...
  fill(0);
  // ellipse(100,100,40,35);//iris, moved to draw 
...
//moving eyes
  fill(0);
  ellipse(100,100,40,35);
  ellipse(200,100,40,35);
  
  float m = map(mouseX,0,width,100-7,100+10);
  float n = map(mouseY,0,width,100-10,100+7);
  fill(255);
  ellipse(m,n,13,13);
  
  float i = map(mouseX,0,width,200-7,200+10);
  float j = map(mouseY,0,width,100-10,100+7);
  ellipse(i,j,13,13);
