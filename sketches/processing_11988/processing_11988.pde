...
// CCA   Cyclic Cellular Automata  with the Greenberg-Hasting model.
// Mario Vincent Turp

//  MOUSE Click  To START or STOP the process  ***********************************
...
int nbSTATE = 5;  //     Nb of Colors  
int RANGE= 2;       //     Range of the neighborhood 
int THR= 4;         //     THRESHOLD
...
//
//  svaleur= "g64_GHmac" + str(tt)+"_ST_" + str(nbSTATE) + "_TH_" + str(THR) + "_R_" + str(RANGE) ;
//  save(svaleur + ".png");
//
//  println(svaleur);
//
