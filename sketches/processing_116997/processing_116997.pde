...
// note: press left button and pull mouse to make some part rotate and change color
// note: "hr" at left , "min" at bottom , background change like daylight
...
void draw() {
  ...
  if (mousePressed) {
    ...
    fill(mouseX/2, mouseY/2, mouseX/4, 150);
    noStroke();
    ...
    bezierVertex(190, 195, 190, 197, 202+abs(mouseX/20), 232+abs(mouseY/20));
    ...
    bezierVertex(375, 288, 373, 292, 353-abs(mouseX/30), 319-abs(mouseY/30));
    ...
    curveVertex(260+(mouseX/20), 90+(mouseY/20));
    curveVertex(187, 160);
    curveVertex(140, 215);
    curveVertex(80+(mouseX/10), 317+(mouseY/10));
    curveVertex(37+(mouseX/20), 455+(mouseY/20));
    curveVertex(89+(mouseX/30), 515+(mouseY/30));
    curveVertex(180, 472);
    curveVertex(202, 425);
    curveVertex(180, 395);
    ...
    rotate(PI/30*m);
    beginShape(); // 17
    curveVertex(236-275, 568-582); // the first control point
    curveVertex(236-275, 568-582); // is also the start point of curve
    curveVertex(275-275, 582-582);
    curveVertex(320-275, 588-582);
    curveVertex(362-275, 580-582); // the last point of curve
    curveVertex(362-275, 580-582); // is also the last control point
    endShape();

    noFill();
    stroke(255);
    beginShape(); // 18
    curveVertex(362-275, 580-582); // the first control point
    curveVertex(362-275, 580-582); // is also the start point of curve
    curveVertex(372-275, 512-582); // the last point of curve
    curveVertex(372-275, 512-582); // is also the last control point
    endShape();

    fill(255);
    stroke(255);
    beginShape(); // 19
    vertex(372-275, 512-582); // first point
    bezierVertex(340-275, 505-582, 360-275, 486-582, 361-275, 486-582);
    bezierVertex(388-275, 470-582, 402-275, 490-582, 402-275, 497-582);
    bezierVertex(400-275, 508-582, 390-275, 515-582, 372-275, 512-582);
    endShape();
    popMatrix();
    ...
    DrawRedLine(10, 90);
    DrawRedLine(10,119.5);
    DrawRedLine(10,149);
    DrawRedLine(10,178.5);
    DrawRedLine(10,208);
    DrawRedLine(10,237.5);
    DrawRedLine(10,267);
    DrawRedLine(10,296.5);
    DrawRedLine(10,326);
    DrawRedLine(10,355.5);
    DrawRedLine(10,385);
    DrawRedLine(10,414.5);
    DrawRedLine(10,444);
    ...
    strokeWeight(1.5);
    background(235);  //debug by chiming lu XD
    int s = second();  
...
void DrawStar(float CenterX, float CenterY) { 
  int s = second();
  stroke(mouseX+(s*20)%255, mouseY+(s*10)%255, s*15%255, (s*100%255) );
...
void DrawSun(float CenterX, float CenterY) {
  ...
  translate(CenterX, CenterY);
  beginShape(); // 3
  vertex(-16, -26); // first point
  bezierVertex(-33, -15, -35, 20, -1, 30);
  bezierVertex(  5,   5,   5,  5, 27,-21);
  bezierVertex(  0, -38, -5, -30, -16, -26);
  endShape();
  
  beginShape(); // 3 - kai
    vertex(-1, 30); // first point
    bezierVertex(  5,  5,   5,   5,  27, -21);
    bezierVertex( 40, -5,  40,  30,  -1,  30);
    endShape();
    
  popMatrix();
}

void DrawRedLine(float X, float Y) {
  stroke(200,0,0,200);
  strokeWeight(3);
  line(X,Y,X+10,Y);
}  
