...
void setup(){
  ...
  currentImage = loadImage("Picture 1.jpg");
  ...
  ellipseMode(CENTER);
  image1=loadImage("060.JPG");//Change image names to those in file
  image2=loadImage("061.JPG");
  image3=loadImage("064.JPG");
  image4=loadImage("065.JPG");
  image5=loadImage("066.JPG");
  image6=loadImage("067.JPG");
  image7=loadImage("069.JPG");
