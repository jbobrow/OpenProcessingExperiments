...
Victor Alejandro Prieto Corona 11061206
*/
...
//Resultados//
fill(250,250,250);
text("i = "+i+ "Amperes",370,380);
text("P = "+p+ "Watts",370,400);
text("Alfa = "+alfa,370,420);
text("Vp = "+vp+ "Volts",370,440);
text("Vc = "+vc+ "Watts",370,460);
text("Pmax = "+pmax+"Watts",370,480);
