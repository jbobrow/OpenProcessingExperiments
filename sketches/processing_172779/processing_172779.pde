...
void setup() {
  ...
  for (int i=0; i<lines.length; i++) {
    lines[0] = new Line(0,300);
    lines[1] = new Line(0,350);
    lines[2] = new Line(0,400);
    lines[3] = new Line(0,450);
    lines[4] = new Line(0,500);
...
class Line {
  float x, y;
  Line(float Rx, float Ry, float Rx, float Ry) {
    x=Rx;
    y=Ry;
