...
void setup() {
  try {
    js_mathvision_init_table_dfa20113f5f73ac5baa4ac3c17e633c95d086ce6(FRAMES);
  }
  catch(err) {}
  ...
  if("" != "") {
    // save thumbnail
    try {
      js_mathvision_done_dfa20113f5f73ac5baa4ac3c17e633c95d086ce6("", 36);
    }
    catch(err) {}
  }
}
...
void makeFrames_dfa20113f5f73ac5baa4ac3c17e633c95d086ce6(adder) {
  var tt = t;
  t = 0;
