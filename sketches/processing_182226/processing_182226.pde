...
void setup() {
  ...
  olaf = loadImage("Olaf.jpg");
  puddle = loadImage("puddle2.jpg");
  happyolaf = loadImage("happyolaf.jpg");
  rectMode(CENTER);
  imageMode(CENTER);
  textAlign(CENTER);
}
...
void drawWinScreen() {
  image(happyolaf, 250, 250, 490, 490);
