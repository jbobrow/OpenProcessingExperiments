...
void draw (){
 rubix (100, 100, random(100,255), random(100,255), random(100,255));
 rubix (300, 300, random(100,255), random(100,255), random(100,255));
 rubix (500, 500, random(100,255), random(100,255), random(100,255));
}
