...
/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/83381*@* */
...
void setup() {
  ...
  bots[28] = new Mac(macImage, 1480, 970, 4.05, "New Zealand");
  ...
  bots[35] = new Mac(macImage, 400, 780, 4.63, "Uruguay");
  bots[36] = new Mac(macImage, 180, 280, 4.63, "Canada");
  bots[37] = new Mac(macImage, 389, 810, 4.64, "Argentina");  
  bots[38] = new Mac(macImage, 1280, 820, 4.94, "Australia");
  bots[39] = new Mac(macImage, 680, 290, 5.37, "Denmark");
  bots[40] = new Mac(macImage, 450, 730, 5.68, "Brazil");
...
class Mac {
  ...
  void display () {
    ...
    text(name, xpos -90, ypos + yoffset-40);
    float w = map(price, 0, 10, 20, 200);
    image(botImage, xpos-100, ypos + yoffset -20, w, w);
  }
}
