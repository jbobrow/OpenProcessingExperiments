...
// simple
// ClarkLi
//practice to make some move with time
//make three thing move with seconds, minutes, and hours.
//One bezierline can move with seconds.
//Three bezierline can become more longer with minutes.
//The star can rotate with hours. 
...
void draw() { 
  ...
  if (mousePressed) {
    ...
    bezierVertex(308, 45, 258, 105, 195, 155);
    bezierVertex(7, 339, 15, 522, 76, 515);
    bezierVertex(165, 530-s, 232, 397-s, 181, 395-s);
    bezierVertex(129, 391-s, 127, 423-s, 127, 423-s);
    endShape();
    ...
    stroke(0);
    beginShape();
    vertex(95, 424-s);//95,424
    bezierVertex(128, 391-s, 150, 441-s, 117, 462-s);
    bezierVertex(91, 480-s, 67, 455-s, 95, 424-s);
    endShape();
  }
