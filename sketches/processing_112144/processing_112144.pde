...
void setup() {
  ...
  myComp = new Composition(0, 4, 390, 4, xTopPentagon, xLeftPentagon, xRightPentagon, xBottomLeftPentagon, 
...
void draw() {
  ...
  myComp.randColors();
  myComp.createTopPentagon(xTopPentagon, yTopPentagon);
  myComp.createRightPentagon(xRightPentagon, yRightPentagon);
  myComp.createLeftPentagon(xLeftPentagon, yLeftPentagon);
  myComp.createBottomLeftPentagon(xBottomLeftPentagon, yBottomLeftPentagon);
  myComp.createBottomRightPentagon(xBottomRightPentagon, yBottomRightPentagon);
  myComp.move();
}
...
class Composition {
  ...
  Composition(int tempX, int tempXSpeed, int tempY, int tempYSpeed, int [] tempXTopPentagon, int [] tempXLeftPentagon,
