...
//this is my text over the orange rectangle

  coolFont = createFont("Bebas",13,true);

  textFont(coolFont);
  text("Orange", 30,50);  
  
//text over yellow circle

  coolFont = createFont("Bebas",12,true);
...
//text over blue
  ...
  coolFont = createFont("Bebas",10,true);
...
//text over green
  ...
  coolFont = createFont("Bebas",11,true);
