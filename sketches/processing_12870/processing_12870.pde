...
// Coloured_Waves_Projected_Display
 
int[][] waves = new int[2000][3]; 
int[] luma = new int[1024]; 
int[][][] pos = new int[3][2][3]; 
float[][][] velocity = new float[3][2][3]; 
int[][][] cWaves = new int[1300][3][2];
