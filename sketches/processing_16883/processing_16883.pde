...
void setup()
{
  ...
  // Load the table 
  String lines[]=loadStrings("https://spreadsheets.google.com/pub?key=0AovDPxTmQGH7dDhLVEZJRldvYU1BcktpTy03eEFtM1E&hl=en&output=txt");
...
void image_display(){
  ...
  String url = "https://dl.dropbox.com/u/2614917/CCA7/CCA_"+ scene_no_str +".jpg";
