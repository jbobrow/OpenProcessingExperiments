...
void draw() {
  ...
  for (int gridY = 0; gridY < 600; gridY = gridY + 25){
    ...
    "dist" that calculates the distance between two vectors*/
      ...
      /*this is the processing function called
    "dist" that calculates the distance between two vectors*/
    ...
    /*you can do them seperately if you want, such as 
    
    diameter = diameter/maxDistance
    diameter = diameter*40
    
    you can change the numbers to test the resluts by yourself*/
    ...
    //(normally ellipses can only be drawn in 2d)
      ...
      what i'm drawing is rectangle, it's just the shapes, it doesn't matter.
      you can do 'ellipse' or 'rect' or other shapes you like, just check the
      website for the right code*/ 
