...
size (450, 600);
background (229, 213, 188); 
smooth();

//blauer Kreis
fill (60, 125, 144);
noStroke();
ellipse (245, 58, 45, 45);
//schwarzer ring
noFill();
stroke(0);
strokeWeight(4.5);
ellipse (245, 58, 60, 60);
...
stroke(0);
strokeWeight(1.5);
line(250, 500, 388, 240);
line(280, 500, 395, 240);
line(266, 430, 320, 450);
line(276, 405, 330, 425);
line(290, 388, 335, 405);
line(300, 368, 343, 385);
line(315, 348, 358, 365);
line(325, 328, 368, 345);
line(335, 313, 370, 327);
line(345, 299, 378, 312);
line(355, 284, 384, 296);
line(360, 268, 389, 280);
...
stroke(0);
strokeWeight(2);
line(159,323,185,294);//schwarz auf dreieckstrick links
line(170,325,186,307);//schwarz auf dreieckstrick rechts

stroke(229, 213, 188);
line(220,325,260,303);//weiß oben
line(160,414,261,309);//weiß mitte
