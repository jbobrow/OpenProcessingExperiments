...
void setup() {
  ...
  images[0] = loadImage("http://disturbmedia.com/max/img/image1.jpg");
  images[1] = loadImage("http://disturbmedia.com/max/img/image2.jpg");
  images[2] = loadImage("http://disturbmedia.com/max/img/image3.jpg");
  images[3] = loadImage("http://disturbmedia.com/max/img/image4.jpg");
