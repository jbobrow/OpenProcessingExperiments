    ...
    /*          voltado a logica de programação procedural.     */
   /* Funcionalidades: Recriação do jogo bomberman(35% pronto) */
  /*                Professor: Marco Antônio                  */
 /*           Data da ultima alteração: 09/04/2014           */
/************************************************************/
void setup(){
...
void draw(){
  ...
  if(keyPressed){
    ...
    if(key=='s' || key=='S'){
      ...
      i=i+25;
           //colisão simples
      if((pos_x>52 && pos_x<102) || (pos_x>152 && pos_x<202) || (pos_x>252 && pos_x<302) || (pos_x>352 && pos_x<402) || (pos_x>452 && pos_x<502) || (pos_x>552 && pos_x<602) || (pos_x>652 && pos_x<702) || (pos_x>752 && pos_x<802)){
        andarY(i);
      }
    }else{
      if(key=='d' || key=='D'){
