...
void draw(){
  ...
  ellipse(mouseX -242,mouseY, 20,20);
  ellipse(mouseX -120,mouseY, 20,20);
  ellipse(mouseX, mouseY, 20,20);
  ellipse(mouseX +120,mouseY, 20,20);
  ellipse(mouseX +242,mouseY, 20,20);
  
  //Create a designs in the background
  ellipse(mouseX -242,mouseY, 20,20);
  ellipse(mouseX -120,mouseY, 20,20);
  ellipse(mouseX, mouseY, 20,20);
  ellipse(mouseX +120,mouseY, 20,20);
  ...
  void mousePressed(){
  //When Pressed these commands will activate
  stroke(0);
  fill(175);
...
void keyPressed(){
  //keyPressed() means do the next commands with a key is pressed
  background (255, 100, 0);
  //Erases by drawing a new box
}
