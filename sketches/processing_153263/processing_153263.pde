...
/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/2808*@* */
...
class Spiral{
  ...
  float angInc;    // incremento en el ángulo por cada punto del espiral
  float ang;       // angulo actual
  float amp, sp;   // amplificación y espaciador por cada vuelta
