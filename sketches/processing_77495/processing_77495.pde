...
float maxSpeed = 4.0;
float LBSpeed = 1.0;
float RBSpeed= 2.5;// variable that sets the maximum speed at which creatures can move
...
PImage LB;
void setup() { 
  field= loadImage("footballzone.png");
