...
void draw() {
  ...
  int i = 0;
  while(i<10){
    ellipse(mouseX,mouseY,i*10,i*20);
    i++;
  }
  stroke(0);
  fill(255);
  rect(100, paddle1Y, 20, 80);
  rect(390, paddle2Y, 20, 80);
  if (keyPressed&&key=='w') {
  ...
  ellipse(x, 100, 32, 32);
  x = x+ball_speed;
  if (((x>390) && ((paddle2Y+100>=100 && 100>=paddle2Y)))|| (x<100)&& ((paddle1Y+100>=100 && 100>=paddle1Y))) {
