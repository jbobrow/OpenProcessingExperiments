...
//  {
//    arc(0, 0, 50, 100, radians (player.left.get(i)*50), radians(player.left.get(i+1)*50));
//    arc(0, 0, 150, 75, radians(player.right.get(i)*50),  radians(player.right.get(i+1)*50));
//  }
  ...
  for (int i =20; i< 300; i +=20) 
  {
    ...
    strokeWeight(5);
    arc(0, 0, player.left.get(i)*150, (mouseX+n), player.right.get(i)*50, radians(n));
    rotate(radians(120));
    }
  }
}
