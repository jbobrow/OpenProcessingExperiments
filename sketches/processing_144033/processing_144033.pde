...
cube1 = new Rubix(100,100,25,25);
cube2 = new Rubix(100,155,125,270);
cube3 = new Rubix(100, 210, 300, 350);
cube4 = new Rubix(155, 100, 10, 290);
cube5 = new Rubix(155, 155, 350, 40);
cube6 = new Rubix(155, 210, 200, 5);
cube7 = new Rubix(210, 100, 200, 320);
cube8 = new Rubix(210, 155, 320, 210);
cube9 = new Rubix(210, 210, 17, 120);
