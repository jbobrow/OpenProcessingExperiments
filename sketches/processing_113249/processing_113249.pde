...
void draw() {/* this does the drawing once per frame */
  ...
  stroke(13*i/cos(i),13*i,13*i/tan(i));//extra;decent blue : stroke(10*i,12*i,13*i); 3 colors : stroke(10*tan(i)*i,12*sin(i)*i,13*sin(i)*i);
  ...
  //also : 13*i/tan(i)
  //stroke(13*i/cos(i),13*i,13*i/tan(i)); voted best
