 ...
 * Tarea#1
 * Crear un cÃ³digo donde mÃºltiples cÃ­rculos (o cualquier otra figura geomÃ©trica), 
 * se muevan a diferentes velocidades. Cuando cualquier cÃ­rculo se acerca a otro, 
 * a un radio menor predefinido, entonces dibujar una lÃ­nea entre ambos cÃ­rculos.

 * Tips: utilizar random() para definir cuanto se mueve un cÃ­rculo en cada paso. 
 * Checkear los bordes para que n se salgan los cÃ­rculos.
 */
