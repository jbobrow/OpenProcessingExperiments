...
void setup() {
  size(533,769); //size should be multiple of img width and height
  smooth();
  ...
  for (int gridX = 0; gridX < img.width; gridX++) {
    for (int gridY = 0; gridY < img.height; gridY++) {
      ...
      case 1:
        ...
        line(posX+5, posY, posX, posY+5); 
        break;
      case 2:
        // greyxcale to ellipse area
        fill(c,70);
        noStroke();
      ...
      case 3:
        ...
        line(posX+l3, posY, posX, posY+l3);
        line(posX+4, posY, posX+l3-4, posY+l3);
        line(posX, posY+4, posX+l3, posY+l3-4);
        break;
      case 4: // CHANGED!!!
        stroke(c);
        fill(0,0);
        float l4 = map(greyscale, 0,255, 35,0);
        l4 = l4 * mouseYFactor*3;
        ellipse(posX, posY, 0+l4, 0+l4);
        break;
      case 5:
      ...
      case 6:
        ...
        noStroke();
        fill(c,50);
        ellipse(posX, posY, mouseX/15,mouseY/20); 
        break;
      case 7:
        stroke(c/2);
