...
noFill();
stroke(3,0,0);
rect(259.5,250,35.5,100);
noFill();
stroke(3,0,0);
rect(304.5,250,35.5,100);

//PANTALONS
fill(0,106,250);
stroke(3,0,0);
ellipse(300,250,151,150);
...
fill(3,0,0);
noStroke();
ellipse(273.5,140,57,57);
fill(3,0,0);
noStroke();
ellipse(323.5,140,57,57);
