...
// 2014-06-26 - Joel Matos
int NumberOfSquares = 10;    // size 80 outer and 40 inner
int CurrentSquare;
int TotalWidthPerSquare;
color[] SquareColorsH;
color[] SquareColorsB;
float ChangeComplimentaryAngle;
...
void setup() {
  ...
  CurrentSquare = 0;
  SquareColorsH = new color[NumberOfSquares];
  SquareColorsB = new color[NumberOfSquares];
  
  TotalWidthPerSquare = width / NumberOfSquares;
}
...
void draw() {
  ...
  SquareColorsH[CurrentSquare] = color(hueValue, 100, brightValue);
  ...
  complementryHue = calculateCompHue(hueValue) + ChangeComplimentaryAngle;
  ...
  SquareColorsB[CurrentSquare] = color(complementryHue, 100, brightValue);
...
void DrawSquares()
{
  ...
  {
    stroke(0);
    fill(SquareColorsH[i]);
    rect(i * TotalWidthPerSquare, height - TotalWidthPerSquare, TotalWidthPerSquare, TotalWidthPerSquare);
   
    noStroke();
    fill(SquareColorsB[i]);
    rect((i * TotalWidthPerSquare) + (TotalWidthPerSquare / 4), (height - TotalWidthPerSquare) + (TotalWidthPerSquare / 4), TotalWidthPerSquare / 2, TotalWidthPerSquare / 2); 
  }
}


/*
 * Change the squares colors in order
 */
void ColorSquares()
{
  if (CurrentSquare < NumberOfSquares)
  {
    stroke(0);
    fill(SquareColorsH[CurrentSquare]);
    rect(CurrentSquare * TotalWidthPerSquare, height - TotalWidthPerSquare, TotalWidthPerSquare, TotalWidthPerSquare);
    
    noStroke();
    fill(SquareColorsB[CurrentSquare]);
    rect((CurrentSquare * TotalWidthPerSquare) + (TotalWidthPerSquare / 4), (height - TotalWidthPerSquare) + (TotalWidthPerSquare / 4), TotalWidthPerSquare / 2, TotalWidthPerSquare / 2);
...
void keyPressed() {
  if (key == CODED)
  {
    if (keyCode == UP && ChangeComplimentaryAngle < 360)
    {
      ChangeComplimentaryAngle += 30;
    }
    else if (keyCode == DOWN && ChangeComplimentaryAngle > 0)
    {
      ChangeComplimentaryAngle -= 30;
    } 
  }
