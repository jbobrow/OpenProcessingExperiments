...
// based on "Pendulum Waves" http://j.mp/lxZfTY
// including all numbers (0.85Hz for slowest pendulum, 1.083Hz for fastest)
// if the above shortened link dies, try: http://sciencedemonstrations.fas.harvard.edu/icb/icb.do?keyword=k16940&pageid=icb.page80863&pageContentId=icb.pagecontent341734&state=maximize&view=view.do&viewParam_name=indepth.html#a_icb_pagecontent341734

// processing sketch by Memo Akten, May 2011. http://www.memo.tv

// built with
//   processing 1.5 - http://www.processing.org/
//   TheMidiBus library - http://smallbutdigital.com/themidibus.php
