...
void draw()
{
  background(random(15),random(15),random(15));
  ...
  if ((ypos >= 200) && (ypos <=height)){
    ...
    fill(100,020,200,100);
      fill(random(255),242,28,random(255));
  }
  if ((y1pos >= 200) && (y1pos <= height)){
    y1speed = 6;
    fill(100,100,050,100);
      fill(random(255),247,89,random(255));
  }
  ...
  if ((y3pos<=200) && (y3pos>=0)) {
    ...
    fill(250,120,100,100);
      fill(random(255),96,240,random(255));
  }
  if ((y3pos>= 200) && (y3pos<=height)){
    y3speed= 2.5;
    fill (050,100,100,100); 
      fill(random(255),249,96,random(255));
  }
  if ((y3pos >= 200) && (y3pos <= height)){
    y3speed = 3.8;
    fill(100,200,150,100);
      fill(random(255),84,206,random(255));
  }
  if (mousePressed) {
