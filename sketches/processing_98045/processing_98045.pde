...
void mousePressed() {
  if ((mouseX >= x1)&&(mouseX <= x1 +20)&&(mouseY >= y1)&&(mouseY <= y1 + 20) 
    ...
    for(int i=0;i < 100;i++)  {
      ...
      d[i]=random(0,400);  
      stroke(random(0,400));
      fill(random(0,400),random(0,400),random(0,400),1*i);
      rect(a[i],random(0,400),c[i],d[i]) ;
    }
  }
  if ((mouseX >= x2)&&(mouseX <= x2 +20)&&(mouseY >= y1)&&(mouseY <= y1 + 20) 
    ...
    for(int e=0;e < 100;e++)  {
     ...
     t[e]=random(0,200); 
      ...
      stroke(random(0,400));
      fill(3*e,0*e,random(0,400),e);
      ellipse(a[e],b[e],r[e],t[e]) ;
    }
  ...
  if ((mouseX >= x3)&&(mouseX <= (x3 +20))&&(mouseY >= y1)&&(mouseY <= (y1 + 20)) 
    ...
    for(int f=0;f < 100;f++)  {
      ...
      d[f]=random(0,400);  
      stroke(random(0,400));
      fill(random(0,400),random(0,400),2*f,1*f);
