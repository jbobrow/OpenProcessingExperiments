...
//Quad and Line
noStroke();
fill(mouseX+50, mouseY+50, 240, 375);
ellipse(180, 161, 140, 150);
stroke(mouseX+30, mouseY+25, 600, 210);
strokeWeight(17);
line(152, 230, 249, 152);
strokeWeight(13);
noStroke();
fill(599.25, 0, 138);
quad(58, 447, 78, 474, 103, 472, 83, 429);
quad(105, 414, 129, 472, 170, 470, 132, 395);
quad(34, 463, 40, 476, 60, 474, 41, 457);
noFill();
stroke(255, 600, 0);
strokeWeight(5);
ellipse(180, 161, 120, 110);
stroke(255, 400, 0);
strokeWeight(4);
ellipse(180, 161, 110, 100);
stroke(600, 600, 0);
strokeWeight(3);
ellipse(180, 161, 100, 90);
stroke(127, 255, 0);
strokeWeight(2);
ellipse(180, 161, 90, 80);
stroke(255, 600, 0);
strokeWeight(1);
ellipse(180, 161, 80, 70);
stroke(600, 600, 600);
strokeWeight(5);
ellipse(180, 161, 220, 50);
stroke(255, 600, 0);
strokeWeight(3);
ellipse(180, 161, 50, 40);
stroke(600, 600, 600);
strokeWeight(3);
ellipse(180, 161, 40, 230);
stroke(255, 600, 0);
strokeWeight(2);
ellipse(180, 161, 30, 20);
stroke(255, 600, 0);
strokeWeight(1);
ellipse(180, 161, 20, 10);
stroke(255, 600, 0);
strokeWeight(3);
ellipse(180, 161, 10, 0);
 
 
//bezier Left Side
stroke(mouseX+20, mouseY+20, 0, 103);
strokeWeight(5);
noFill();
bezier(0, 459, 37, 380, 146, 400, 147, 471);
stroke(mouseX+10, mouseY+40, 201, 100);
bezier(0, 325, 5, 310, 88, 350, 71, 408);
...
//Number.1 Triangle
noStroke();
fill(mouseX+20, mouseY+30, 520.9, 110);
...
strokeWeight(7);
fill(mouseX+30, mouseY+30, 100, 201);//Yellowish Green
...
strokeWeight(4);
stroke(11, mouseY+45, 75, 350);
line(0, 595, 436, 590);
strokeWeight(5);
stroke(mouseX+10, 216, 92, 600);
line(521, 286, 522, 437);
line(551, 283, 554, 437);
line(580, 284, 587, 439);
stroke(mouseY+10, 209, 229, 360);
