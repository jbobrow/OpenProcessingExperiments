...
Isobel Scanlon 3098536
 ...
 misses this is the resulting code. 
 
 I have added some sound to correlate the single drops and then the continuos rain. On my computer at home
 it has 'memory errors' and the sound is only partial, I am hoping that is only my computer! If it doesn't
 work on yours please mark my original submission, Thanks!
 */
