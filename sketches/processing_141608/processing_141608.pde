...
void draw() {   
  ...
  fill(0);
    text("è��æ»�0Lå¼�é��æ¨¡æ��å�¨",10,280);
    text("          --by twincannon, modified by Waynepd from vstab.com",10,300);
    text("å·¦é�®æ��ä½�æ�±å­�å°�è¯�å¼�é��ï¼�æ�±å­�æ��æ��æ�¶æ�¾æ��ä»¥å�ºå®�æ�±å­�ï¼�é��æ�¾æ�©äº�æ��æ��äº�æ�±å­�å°�é��ç½®",10,320);
    text("æ��Ré�®æ��æ��æ�°æ��é�¾åº¦ï¼�Eé�®ä¸­ç­�é�¾åº¦ï¼�Wé�®å¤§å¸�é�¾åº¦ï¼�Qé�®å®�å¸�é�¾åº¦",10,340);
}
